...
export const articles: Article[] = [
  {
    "id": "bc-kb-001",
    "code": "BC-KB-001",
    "title": "Acesso ao BC (Business Central) ?",
    "category": "Acesso / Business Central",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Repetir para todos os atributos necessários."
    ],
  ...
  },
  {
    ...
    "steps": [
      ...
      "Preencher os dados de envio (morada, código postal, localidade, etc.)."
    ],
  ...
  },
  {
    ...
    "procedure": "1. Método 1 – Outlook: selecione o email do contacto pretendido e utilize o suplemento do Business Central no Outlook para adicionar o contacto. Confirme o nome.\n2. Método 2 – Ficha de Cliente: aceder a \"Clientes\", selecionar a ficha do cliente, ir a \"Base\" → \"Contacto\".\n3. Se não existir nenhum contacto associado, responder \"Sim\" quando questionado e preencher a ficha do novo contacto.",
    "steps": [
      "Método 1 – Outlook: selecione o email do contacto pretendido e utilize o suplemento do Business Central no Outlook para adicionar o contacto. Confirme o nome.",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Imprimir ou descarregar o ficheiro conforme necessário."
    ],
  ...
  },
  {
    ...
    "steps": [
      ...
      "libertar novamente a encomenda."
    ],
  ...
  },
  {
    ...
    "steps": [
      ...
      "Exportar o ficheiro em formato:",
      "CSV (Comma delimited) (.csv)",
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário expandir ou explodir um Kit dentro de uma Ordem de Transferência, para visualizar e movimentar os artigos que compõem o kit.",
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador pretende criar um produto novo mas não conhece o processo completo nem quais os campos obrigatórios.",
    "diagnosis": "Não existe ficha para o produto e o utilizador nunca fez este processo.",
    "cause": "Desconhecimento da funcionalidade de criação de produtos, da lista de campos obrigatórios e do envio para aprovação.",
    "solution": "Criar uma nova ficha na lista \"Produtos\", preencher todos os campos obrigatórios, usar um modelo se existir e enviar o pedido de aprovação.",
    "procedure": "1. Aceder à lista de Produtos através da pesquisa ou menu.\n2. Selecionar Novo para abrir uma Ficha de Produto em branco.\n3. Preencher o campo Nº com o código interno e validar a codificação.\n4. Na área eInfo Obrigatória, preencher todos os campos assinalados, incluindo os validados em \"Pedido de Aprovação\".\n5. Se existir um modelo apropriado, clicar em Aplicar Modelo, escolher o modelo e confirmar; rever os dados preenchidos automaticamente.\n6. Verificar que todos os campos obrigatórios estão completos e que a informação é coerente.\n7. Navegar até ao separador Pedido e selecionar Enviar Pedido Aprovação; confirmar o envio.\n8. Acompanhar o estado do pedido na ficha do produto ou em Solicitações para Aprovar.",
    "steps": [
      "Aceder à lista de Produtos através da pesquisa ou menu.",
      "Selecionar Novo para abrir uma Ficha de Produto em branco.",
      "Preencher o campo Nº com o código interno e validar a codificação.",
      "Na área eInfo Obrigatória, preencher todos os campos assinalados, incluindo os validados em \"Pedido de Aprovação\".",
      "Se existir um modelo apropriado, clicar em Aplicar Modelo, escolher o modelo e confirmar; rever os dados preenchidos automaticamente.",
      "Verificar que todos os campos obrigatórios estão completos e que a informação é coerente.",
      "Navegar até ao separador Pedido e selecionar Enviar Pedido Aprovação; confirmar o envio.",
      "Acompanhar o estado do pedido na ficha do produto ou em Solicitações para Aprovar."
    ],
    "validation": "O produto aparece na lista de produtos, a ficha está preenchida e o pedido de aprovação encontra se em curso ou concluído captura de imagem.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Ao abrir uma nova ficha de produto, o utilizador não sabe quais os campos que deve obrigatoriamente preencher.",
    "diagnosis": "Existe uma área lateral intitulada eInfo Obrigatória que indica os campos necessários, mas o utilizador desconhece a sua utilização.",
    "cause": "Falta de formação na leitura dos campos obrigatórios e na distinção entre campos validados na aprovação ou na ficha.",
    "solution": "Consultar a área eInfo Obrigatória da ficha para identificar os campos obrigatórios e preencher todos eles antes de enviar o pedido de aprovação.",
    "procedure": "1. Criar ou abrir a ficha do produto.\n2. Na barra lateral direita, identificar a secção eInfo Obrigatória.\n3. Preencher todos os campos listados; normalmente incluem: Tipo, Descrição, Unidade Medida Base, Categoria, Grupo Regist. Produto, Grupo Regist. VAT Produto e parâmetros de planeamento.\n4. Distinguir os campos marcados com Validado Em: Pedido de Aprovação (estes devem ser preenchidos antes do envio) e os restantes.\n5. Caso utilize um modelo, verificar se algum campo obrigatório ficou em falta e completar manualmente.\n6. Rever a ficha para garantir que não restam campos obrigatórios por preencher.",
    "steps": [
      "Criar ou abrir a ficha do produto.",
      "Na barra lateral direita, identificar a secção eInfo Obrigatória.",
      "Preencher todos os campos listados; normalmente incluem: Tipo, Descrição, Unidade Medida Base, Categoria, Grupo Regist. Produto, Grupo Regist. VAT Produto e parâmetros de planeamento.",
      "Distinguir os campos marcados com Validado Em: Pedido de Aprovação (estes devem ser preenchidos antes do envio) e os restantes.",
      "Caso utilize um modelo, verificar se algum campo obrigatório ficou em falta e completar manualmente.",
      "Rever a ficha para garantir que não restam campos obrigatórios por preencher."
    ],
    "validation": "Todos os campos assinalados na eInfo Obrigatória estão completos, permitindo o envio do pedido de aprovação captura de imagem.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador vê a opção Aplicar Modelo mas não sabe quando a deve utilizar nem o seu efeito.",
    "diagnosis": "A aplicação de modelos permite pré preencher campos com dados padrão para determinados tipos de produtos.",
    "cause": "Desconhecimento das vantagens dos modelos existentes e do impacto no preenchimento da ficha.",
    "solution": "Usar Aplicar Modelo para carregar um conjunto de valores predefinidos quando o produto se enquadra num tipo existente; isto reduz erros e acelera o processo.",
    "procedure": "1. Durante a criação da ficha de produto, clicar em Aplicar Modelo.\n2. Selecionar o modelo que melhor corresponde ao tipo de produto (por exemplo, medicamento, dispositivo médico, consumível, etc.).\n3. Confirmar a aplicação; os campos relacionados com planeamento, contabilidade e logística serão preenchidos com valores padrão.\n4. Rever todos os campos que foram preenchidos automaticamente e corrigir/ajustar valores quando necessário.\n5. Preencher manualmente os campos obrigatórios que não foram abrangidos pelo modelo.",
    "steps": [
      "Durante a criação da ficha de produto, clicar em Aplicar Modelo.",
      "Selecionar o modelo que melhor corresponde ao tipo de produto (por exemplo, medicamento, dispositivo médico, consumível, etc.).",
      "Confirmar a aplicação; os campos relacionados com planeamento, contabilidade e logística serão preenchidos com valores padrão.",
      "Rever todos os campos que foram preenchidos automaticamente e corrigir/ajustar valores quando necessário.",
      "Preencher manualmente os campos obrigatórios que não foram abrangidos pelo modelo."
    ],
    "validation": "Os campos da ficha exibem os valores do modelo e o utilizador ajustou eventuais diferenças antes do pedido de aprovação.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O produto foi criado mas ainda não está ativo porque falta enviar o pedido de aprovação.",
    "diagnosis": "O utilizador não encontra a funcionalidade de pedido de aprovação na ficha do produto.",
    "cause": "Falta de conhecimento sobre workflows de aprovação no Business Central.",
    "solution": "Utilizar o menu Pedido da ficha para submeter o produto para aprovação.",
    "procedure": "1. Abrir a ficha do produto criado.\n2. Verificar que todos os campos obrigatórios estão preenchidos.\n3. Aceder ao separador ou menu Pedido.\n4. Selecionar Enviar Pedido Aprovação.\n5. Confirmar a submissão caso seja apresentada uma mensagem de confirmação.\n6. O sistema altera o estado de workflow para \"Em Progresso\" e envia uma notificação aos aprovadores.",
    "steps": [
      "Abrir a ficha do produto criado.",
      "Verificar que todos os campos obrigatórios estão preenchidos.",
      "Aceder ao separador ou menu Pedido.",
      "Selecionar Enviar Pedido Aprovação.",
      "Confirmar a submissão caso seja apresentada uma mensagem de confirmação.",
      "O sistema altera o estado de workflow para \"Em Progresso\" e envia uma notificação aos aprovadores."
    ],
    "validation": "O pedido surge na lista de solicitações para aprovar e o produto fica bloqueado até à aprovação. captura de imagem",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Depois de enviar o pedido, o utilizador quer acompanhar se o produto já foi aprovado.",
    "diagnosis": "O estado da aprovação não é apresentado de forma clara na lista de produtos.",
    "cause": "Desconhecimento das páginas de consulta de solicitações e aprovações.",
    "solution": "Verificar o estado na ficha do produto ou através da página Solicitações para Aprovar.",
    "procedure": "1. Abrir a ficha do produto em causa.\n2. No topo da ficha, procurar a área de Aprovações que indica se o pedido foi enviado e qual o seu estado.\n3. Em alternativa, usar a pesquisa do Business Central para procurar Solicitações para Aprovar.\n4. Na lista, aplicar um filtro pelo Tipo Documento = Produto ou pelo número do produto.\n5. A coluna Estado indica se o pedido está pendente, aprovado ou rejeitado, e a coluna Aprovador identifica quem é responsável.",
    "steps": [
      "Abrir a ficha do produto em causa.",
      "No topo da ficha, procurar a área de Aprovações que indica se o pedido foi enviado e qual o seu estado.",
      "Em alternativa, usar a pesquisa do Business Central para procurar Solicitações para Aprovar.",
      "Na lista, aplicar um filtro pelo Tipo Documento = Produto ou pelo número do produto.",
      "A coluna Estado indica se o pedido está pendente, aprovado ou rejeitado, e a coluna Aprovador identifica quem é responsável."
    ],
    "validation": "O estado de aprovação e o aprovador são visíveis e atualizados em tempo real.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador precisa de saber a quem deve contactar sobre a aprovação de um produto.",
    "diagnosis": "A informação de aprovadores nem sempre está visível na ficha.",
    "cause": "O utilizador desconhece como consultar a cadeia de aprovação.",
    "solution": "Consultar a página de Solicitações para Aprovar ou a ficha de workflow para identificar o aprovador.",
    "procedure": "1. A partir da ficha do produto, aceder a Pedido → Fluxo de Trabalho (ou workflow) para visualizar a configuração do workflow associado.\n2. Na lista de etapas do workflow, identificar o grupo ou utilizador responsável pela aprovação do produto.\n3. Para ver o pedido específico, abrir a página Solicitações para Aprovar, filtrar pelo produto e verificar a coluna Aprovador.\n4. Se necessário, contactar o aprovador por email ou via Teams com referência ao número do produto e ao pedido.",
    "steps": [
      "A partir da ficha do produto, aceder a Pedido → Fluxo de Trabalho (ou workflow) para visualizar a configuração do workflow associado.",
      "Na lista de etapas do workflow, identificar o grupo ou utilizador responsável pela aprovação do produto.",
      "Para ver o pedido específico, abrir a página Solicitações para Aprovar, filtrar pelo produto e verificar a coluna Aprovador.",
      "Se necessário, contactar o aprovador por email ou via Teams com referência ao número do produto e ao pedido."
    ],
    "validation": "O utilizador conhece o(s) aprovador(es) atribuídos ao pedido de aprovação do produto.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador deseja listar apenas os produtos cujo workflow está em progresso (em criação ou aprovação).",
    "diagnosis": "Sem aplicar o filtro adequado, a lista apresenta todos os produtos ativos e finalizados.",
    "cause": "Desconhecimento do campo Workflowstatus e dos seus valores.",
    "solution": "Aplicar um filtro no campo Workflowstatus da lista de produtos com o valor Em Progresso.",
    ...
    "steps": [
      "Abrir a lista de Produtos.",
      "No cabeçalho, clicar em Filtrar e procurar o campo Workflowstatus.",
      "Definir o valor para Em Progresso; isso irá mostrar apenas os produtos em criação ou aprovação.",
      "Se desejar ver produtos aprovados ou rejeitados, altere o filtro para o valor correspondente."
    ],
    "validation": "A lista exibe exclusivamente produtos cujo estado de workflow é \"Em Progresso\", facilitando o acompanhamento das criações em curso",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Um produto pendente precisa de ser aprovado ou rejeitado por um utilizador com permissões de aprovador.",
    "diagnosis": "O pedido encontra se na lista de solicitações pendentes e aguarda decisão.",
    "cause": "O workflow exige que um aprovador analise a ficha antes de a tornar ativa.",
    "solution": "Abrir o pedido pendente, rever os dados do produto e escolher Aprovar ou Rejeitar.",
    "procedure": "1. Aceder a Solicitações para Aprovar no menu ou via pesquisa.\n2. Filtrar por Tipo Documento = Produto e localizar o pedido pendente.\n3. Selecionar a linha pretendida e clicar em Abrir Registo para consultar a ficha do produto.\n4. Rever os campos obrigatórios, dados técnicos e comerciais.\n5. Se estiver tudo correto, voltar à lista de solicitações e escolher Aprovar; caso existam erros ou lacunas, escolher Rejeitar e adicionar um comentário explicativo.\n6. O sistema notifica o requisitante sobre a decisão.",
    "steps": [
      "Aceder a Solicitações para Aprovar no menu ou via pesquisa.",
      "Filtrar por Tipo Documento = Produto e localizar o pedido pendente.",
      "Selecionar a linha pretendida e clicar em Abrir Registo para consultar a ficha do produto.",
      "Rever os campos obrigatórios, dados técnicos e comerciais.",
      "Se estiver tudo correto, voltar à lista de solicitações e escolher Aprovar; caso existam erros ou lacunas, escolher Rejeitar e adicionar um comentário explicativo.",
      "O sistema notifica o requisitante sobre a decisão."
    ],
    "validation": "O pedido desaparece da lista de pendentes e o produto passa para o estado de aprovado ou rejeitado.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Um utilizador precisa de consultar os detalhes de um produto que ainda não está aprovado.",
    "diagnosis": "O pedido de aprovação está pendente, mas a ficha pode ser aberta para revisão.",
    "cause": "Necessidade de corrigir ou consultar informação antes da aprovação.",
    "solution": "Aceder à lista de solicitações e utilizar a opção Abrir Registo para visualizar a ficha.",
    "procedure": "1. Navegar até Solicitações para Aprovar.\n2. Localizar o pedido de aprovação do produto em questão.\n3. Na linha do pedido, clicar em Abrir Registo; a ficha do produto será aberta em modo de consulta.\n4. Verificar ou editar os campos consoante as permissões (alguns campos podem estar bloqueados se já houver pedido enviado).\n5. Fechar a ficha ou proceder a correções e reenviar o pedido se necessário.",
    "steps": [
      "Navegar até Solicitações para Aprovar.",
      "Localizar o pedido de aprovação do produto em questão.",
      "Na linha do pedido, clicar em Abrir Registo; a ficha do produto será aberta em modo de consulta.",
      "Verificar ou editar os campos consoante as permissões (alguns campos podem estar bloqueados se já houver pedido enviado).",
      "Fechar a ficha ou proceder a correções e reenviar o pedido se necessário."
    ],
    "validation": "O utilizador consegue aceder à ficha para análise e correção antes da decisão final.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário comunicar observações ou correções ao aprovador no âmbito de um pedido de produto.",
    "diagnosis": "A área de aprovações permite adicionar comentários, mas o utilizador não sabe onde fazê lo.",
    "cause": "Desconhecimento da funcionalidade de comentários nas solicitações de aprovação.",
    "solution": "Usar o campo de comentário na solicitação para registar notas e instruções.",
    "procedure": "1. Aceder à página Solicitações para Aprovar e localizar o pedido.\n2. Selecionar a linha e escolher Comentários ou Adicionar Comentário (dependendo da versão).\n3. Escrever o comentário indicando as justificações, observações ou instruções para o aprovador.\n4. O aprovador poderá ler o comentário antes de tomar a decisão.",
    "steps": [
      "Aceder à página Solicitações para Aprovar e localizar o pedido.",
      "Selecionar a linha e escolher Comentários ou Adicionar Comentário (dependendo da versão).",
      "Escrever o comentário indicando as justificações, observações ou instruções para o aprovador.",
      "O aprovador poderá ler o comentário antes de tomar a decisão."
    ],
    "validation": "O comentário é visível na solicitação e pode ser lido pelo aprovador antes de aprovar ou rejeitar o produto.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Pretende-se criar um produto a partir de uma ficha existente no Catálogo de Produtos.",
    "diagnosis": "O utilizador não sabe como converter um item de catálogo num produto ativo.",
    "cause": "Falta de conhecimento das opções de criação a partir do catálogo e de preenchimento de informações de fornecedor.",
    "solution": "Selecionar a ficha de catálogo, preencher os campos necessários (como número de fornecedor) e utilizar a opção Criar Produto.",
    "procedure": "1. Aceder ao Catálogo de Produtos a partir da pesquisa.\n2. Selecionar a ficha do item de catálogo que pretende converter.\n3. Preencher o campo Nº Fornecedor (obrigatório) e outros campos relevantes, como descrição detalhada ou atributos.\n4. Clicar em Criar Produto; o sistema gera uma nova ficha de produto com estado Bloqueado.\n5. Abrir a ficha de produto criada e completar os campos obrigatórios em eInfo Obrigatória.\n6. Enviar o pedido de aprovação como num produto criado de raiz.",
    "steps": [
      "Aceder ao Catálogo de Produtos a partir da pesquisa.",
      "Selecionar a ficha do item de catálogo que pretende converter.",
      "Preencher o campo Nº Fornecedor (obrigatório) e outros campos relevantes, como descrição detalhada ou atributos.",
      "Clicar em Criar Produto; o sistema gera uma nova ficha de produto com estado Bloqueado.",
      "Abrir a ficha de produto criada e completar os campos obrigatórios em eInfo Obrigatória.",
      "Enviar o pedido de aprovação como num produto criado de raiz."
    ],
    "validation": "O produto criado a partir do catálogo aparece na lista de produtos e o pedido de aprovação está em curso.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Ao criar a partir do catálogo, o utilizador não sabe quais os campos mínimos exigidos.",
    "diagnosis": "A ficha de catálogo apresenta menos campos do que a de produto, mas alguns são obrigatórios para criar o registo.",
    "cause": "Desconhecimento dos dados obrigatórios na ficha do catálogo.",
    "solution": "Preencher o campo Nº Fornecedor e quaisquer campos identificados como obrigatórios no catálogo antes de criar o produto.",
    "procedure": "1. Abrir a ficha do produto no Catálogo de Produtos.\n2. Procurar a secção Dados Obrigatórios (semelhante a eInfo Obrigatória).\n3. Preencher o Nº Fornecedor com o código do fornecedor que fornecerá o produto.\n4. Verificar campos como Tipo, Descrição, Categoria e assegurar que estão preenchidos.\n5. Após completar os campos, clicar em Criar Produto.",
    "steps": [
      "Abrir a ficha do produto no Catálogo de Produtos.",
      "Procurar a secção Dados Obrigatórios (semelhante a eInfo Obrigatória).",
      "Preencher o Nº Fornecedor com o código do fornecedor que fornecerá o produto.",
      "Verificar campos como Tipo, Descrição, Categoria e assegurar que estão preenchidos.",
      "Após completar os campos, clicar em Criar Produto."
    ],
    "validation": "O produto é criado sem erros e encontra se pronto para preenchimento dos restantes dados na ficha de produto.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador pretende saber como o sistema trata o produto após a criação a partir do catálogo.",
    "diagnosis": "A ficha de produto é gerada automaticamente com algumas particularidades.",
    "cause": "Necessidade de compreender o estado inicial e os passos seguintes após a criação.",
    "solution": "Entender que o produto é criado em estado Bloqueado, exigindo configuração adicional e aprovação para ficar ativo.",
    "procedure": "1. Após selecionar Criar Produto, o Business Central copia os dados da ficha do catálogo para uma nova ficha de produto.\n2. O campo Status ou Bloqueado é definido como Sim para impedir o uso até que a configuração seja concluída.\n3. Abrir a nova ficha de produto e completar todos os campos obrigatórios (planeamento, contabilidade, logística).\n4. Verificar as relações com fornecedores e preços, pois apenas o Nº Fornecedor foi herdado.\n5. Enviar o pedido de aprovação; após aprovação, o campo Bloqueado é atualizado e o produto passa a ativo.",
    "steps": [
      "Após selecionar Criar Produto, o Business Central copia os dados da ficha do catálogo para uma nova ficha de produto.",
      "O campo Status ou Bloqueado é definido como Sim para impedir o uso até que a configuração seja concluída.",
      "Abrir a nova ficha de produto e completar todos os campos obrigatórios (planeamento, contabilidade, logística).",
      "Verificar as relações com fornecedores e preços, pois apenas o Nº Fornecedor foi herdado.",
      "Enviar o pedido de aprovação; após aprovação, o campo Bloqueado é atualizado e o produto passa a ativo."
    ],
    "validation": "O produto criado a partir do catálogo cumpre os mesmos requisitos de um produto criado de raiz e torna se utilizável após aprovação.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O produto precisa de atributos adicionais (tamanho, cor, marca) para fins de filtragem e relatórios.",
    "diagnosis": "A ficha permite associar atributos definidos a nível global, mas o utilizador não sabe onde fazê lo.",
    "cause": "Desconhecimento da funcionalidade de atributos e da página de associação.",
    "solution": "Utilizar a funcionalidade Atributos na ficha de produto para atribuir valores aos atributos existentes.",
    "procedure": "1. Abrir a ficha do produto pretendido.\n2. Selecionar Produto → Atributos no menu.\n3. Na janela de atributos, clicar em + Novo e selecionar o atributo (por exemplo, Tamanho, Cor, Marca).\n4. Escolher ou introduzir o valor apropriado para esse atributo.\n5. Repetir para todos os atributos necessários.",
    "steps": [
      "Abrir a ficha do produto pretendido.",
      "Selecionar Produto → Atributos no menu.",
      "Na janela de atributos, clicar em + Novo e selecionar o atributo (por exemplo, Tamanho, Cor, Marca).",
      "Escolher ou introduzir o valor apropriado para esse atributo.",
      "Repetir para todos os atributos necessários."
    ],
    "validation": "Os atributos e os seus valores aparecem listados na ficha e podem ser usados em filtros de oportunidades e propostas.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador quer saber a utilidade de associar atributos a produtos.",
    "diagnosis": "A lista de produtos pode ser longa e diversa; os atributos permitem filtragem e análise mais detalhada.",
    "cause": "Desconhecimento das vantagens dos atributos na gestão e pesquisa.",
    "solution": "Explicar que os atributos facilitam a pesquisa, classificação e segmentação de produtos em listas, oportunidades e propostas.",
    "procedure": "1. Definir atributos a nível da empresa (Ex.: Tamanho, Cor, Marca, Grupo terapêutico).\n2. Atribuir valores apropriados a cada produto através da funcionalidade de atributos na ficha.\n3. Utilizar os atributos como filtros nas listas de produtos ou quando procura produtos para uma oportunidade ou proposta.\n4. Incluir atributos nos relatórios e análises para segmentar produtos por características.",
    "steps": [
      "Definir atributos a nível da empresa (Ex.: Tamanho, Cor, Marca, Grupo terapêutico).",
      "Atribuir valores apropriados a cada produto através da funcionalidade de atributos na ficha.",
      "Utilizar os atributos como filtros nas listas de produtos ou quando procura produtos para uma oportunidade ou proposta.",
      "Incluir atributos nos relatórios e análises para segmentar produtos por características."
    ],
    "validation": "Os atributos estão definidos e são visíveis nas listagens, permitindo filtrar rapidamente produtos com características específicas.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador deseja ver os atributos e valores de um produto específico.",
    "diagnosis": "Os atributos não aparecem diretamente na ficha principal e é necessário abrir uma janela específica.",
    "cause": "Desconhecimento de onde visualizar os atributos já atribuídos.",
    "solution": "Consultar a opção Atributos na ficha de produto.",
    ...
    "steps": [
      "Abrir a ficha do produto.",
      "No menu, selecionar Produto → Atributos.",
      "A janela de atributos apresenta a lista de todos os atributos associados e respetivos valores.",
      "Nesta janela, é possível editar ou remover valores se necessário.",
      "Fechar a janela após consulta ou edição."
    ],
    "validation": "A lista de atributos e valores do produto é apresentada corretamente.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Precisa de encontrar produtos com características específicas (por exemplo, cor vermelha, marca X).",
    "diagnosis": "Usar filtros tradicionais (número, descrição) não é suficiente; é necessário filtrar por atributos.",
    "cause": "Não conhecimento da funcionalidade de filtro por atributos na lista de produtos.",
    "solution": "Aplicar filtros de atributos através da janela de pesquisa de atributos.",
    "procedure": "1. Na lista de Produtos, abrir o menu Filtrar e escolher Atributos.\n2. Selecionar o atributo pretendido (por exemplo, Cor) e o valor (Vermelho).\n3. Confirmar; a lista mostrará apenas produtos que têm esse atributo com o valor selecionado.\n4. Se necessário, adicionar mais filtros de atributos para refinar ainda mais a pesquisa.\n5. Para remover o filtro, voltar à janela de atributos e limpar os valores.",
    "steps": [
      "Na lista de Produtos, abrir o menu Filtrar e escolher Atributos.",
      "Selecionar o atributo pretendido (por exemplo, Cor) e o valor (Vermelho).",
      "Confirmar; a lista mostrará apenas produtos que têm esse atributo com o valor selecionado.",
      "Se necessário, adicionar mais filtros de atributos para refinar ainda mais a pesquisa.",
      "Para remover o filtro, voltar à janela de atributos e limpar os valores."
    ],
    "validation": "A lista exibe unicamente os produtos que correspondem aos atributos escolhidos",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Após aplicar um filtro de atributos, o utilizador quer voltar à lista completa de produtos.",
    "diagnosis": "O filtro permanece ativo e limita a visualização de produtos.",
    "cause": "Falta de conhecimento sobre como remover filtros de atributos.",
    "solution": "Reabrir a janela de atributos e limpar os valores aplicados.",
    "procedure": "1. Na lista de Produtos, clicar em Filtrar → Atributos.\n2. Para cada atributo com filtro ativo, selecionar Limpar Valor ou apagar manualmente.\n3. Confirmar; a lista volta a mostrar todos os produtos.\n4. Criar uma vista sem filtros se necessitar de aceder frequentemente à lista completa.",
    "steps": [
      "Na lista de Produtos, clicar em Filtrar → Atributos.",
      "Para cada atributo com filtro ativo, selecionar Limpar Valor ou apagar manualmente.",
      "Confirmar; a lista volta a mostrar todos os produtos.",
      "Criar uma vista sem filtros se necessitar de aceder frequentemente à lista completa."
    ],
    "validation": "A lista de produtos deixa de ter filtros e apresenta todos os registos.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador quer saber se os atributos influenciam oportunidades e propostas de venda.",
    "diagnosis": "Os atributos podem ser usados para filtrar e sugerir produtos durante a criação de propostas.",
    "cause": "Desconhecimento da integração entre atributos e o módulo de oportunidades.",
    "solution": "Explicar que os atributos utilizados nas fichas de produtos podem ser filtrados em oportunidades e propostas, ajudando a selecionar os produtos adequados.",
    "procedure": "1. Quando criar uma proposta de venda a partir de uma oportunidade, utilize a pesquisa de produtos para adicionar linhas.\n2. Na janela de seleção de produtos, aplicar filtros de atributos (como Tamanho ou Marca) para localizar rapidamente os produtos que correspondem aos requisitos do cliente.\n3. Adicionar os produtos filtrados à proposta; os atributos não são impressos por defeito, mas ajudam internamente.\n4. Caso necessário, referencie atributos no texto da proposta através de comentários.",
    "steps": [
      "Quando criar uma proposta de venda a partir de uma oportunidade, utilize a pesquisa de produtos para adicionar linhas.",
      "Na janela de seleção de produtos, aplicar filtros de atributos (como Tamanho ou Marca) para localizar rapidamente os produtos que correspondem aos requisitos do cliente.",
      "Adicionar os produtos filtrados à proposta; os atributos não são impressos por defeito, mas ajudam internamente.",
      "Caso necessário, referencie atributos no texto da proposta através de comentários."
    ],
    "validation": "Os produtos selecionados na proposta correspondem às características solicitadas pelo cliente, graças ao uso de filtros de atributos.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário atualizar a base de dados com o dicionário de substâncias ou medicamentos ANF.",
    "diagnosis": "A importação requer acesso a ficheiros externos e permissões de administrador.",
    "cause": "Mudanças de regulamentação ou atualização de nomenclatura que exigem a importação de novos dados.",
    "solution": "Executar a rotina de importação de ANF através da funcionalidade de importação de dados.",
    "procedure": "1. Obter o ficheiro atualizado do Dicionário ANF no formato suportado (normalmente Excel ou CSV).\n2. Aceder à funcionalidade de Importar Dicionário ANF via pesquisa.\n3. Selecionar Procurar e escolher o ficheiro a importar.\n4. Validar os campos de mapeamento entre o ficheiro e as tabelas internas.\n5. Iniciar a importação e aguardar a conclusão; o sistema atualiza as substâncias, grupos e outras informações nas fichas de produtos.\n6. Rever logs de importação para corrigir eventuais erros.",
    "steps": [
      "Obter o ficheiro atualizado do Dicionário ANF no formato suportado (normalmente Excel ou CSV).",
      "Aceder à funcionalidade de Importar Dicionário ANF via pesquisa.",
      "Selecionar Procurar e escolher o ficheiro a importar.",
      "Validar os campos de mapeamento entre o ficheiro e as tabelas internas.",
      "Iniciar a importação e aguardar a conclusão; o sistema atualiza as substâncias, grupos e outras informações nas fichas de produtos.",
      "Rever logs de importação para corrigir eventuais erros."
    ],
    "validation": "As substâncias e grupos ANF são atualizados e disponíveis para utilização em produtos e relatórios.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Após importar o Dicionário ANF, o utilizador pretende saber onde são refletidas as alterações.",
    "diagnosis": "Os dados importados alimentam tabelas de substâncias, grupos terapêuticos e indicações, que se refletem nas fichas de produto.",
    "cause": "Necessidade de confirmar se as substâncias e classificações foram atualizadas corretamente.",
    "solution": "Verificar as tabelas de substâncias e grupos ANF e confirmar os campos atualizados nas fichas de produto.",
    "procedure": "1. Após a importação, aceder às tabelas de Substâncias e Grupos Terapêuticos através da pesquisa.\n2. Confirmar que as novas entradas e alterações do dicionário estão visíveis.\n3. Abrir uma ficha de produto que utilize uma substância importada e verificar se os campos de classificação ANF estão atualizados.\n4. Nos relatórios ou listas, utilizar filtros de substância ou grupo para garantir que as novas designações são reconhecidas.",
    "steps": [
      "Após a importação, aceder às tabelas de Substâncias e Grupos Terapêuticos através da pesquisa.",
      "Confirmar que as novas entradas e alterações do dicionário estão visíveis.",
      "Abrir uma ficha de produto que utilize uma substância importada e verificar se os campos de classificação ANF estão atualizados.",
      "Nos relatórios ou listas, utilizar filtros de substância ou grupo para garantir que as novas designações são reconhecidas."
    ],
    "validation": "Os campos de substância e grupo terapêutico nas fichas de produto refletem as informações atualizadas do Dicionário ANF.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário atualizar as tabelas de Preço de Venda ao Armazém (PVA), Preço Industriais de Compra (PIC), Preço Máximo de Aprovisionamento (PMA), Preço de Venda Farmácia Descontado (PVFD) e Preço de Venda ao Doente (PVAD).",
    "diagnosis": "Os preços e margens definidos nas tabelas externas mudam com frequência e têm impacto na definição do preço de venda.",
    "cause": "Revisões regulatórias de preços ou alterações contratuais com fornecedores.",
    "solution": "Usar a funcionalidade de importação de preços/margens disponível no módulo de produtos para atualizar as tabelas correspondentes.",
    "procedure": "1. Obter os ficheiros de atualização de PVA, PIC, PMA, PVFD e PVAD nos formatos fornecidos pelo regulador ou fornecedor (normalmente Excel/CSV).\n2. Aceder às páginas específicas de importação através da pesquisa (por exemplo, Importar PVA, Importar PIC).\n3. Selecionar Procurar e escolher o ficheiro de cada tipo de preço.\n4. Validar os campos de mapeamento; o sistema indica quais as colunas do ficheiro que correspondem aos campos internos.\n5. Iniciar a importação; o sistema atualiza os campos de preço e margens nas fichas de produto e nas tabelas de apoio.\n6. Repetir o processo para cada tipo de preço.\n7. Após a importação, rever um conjunto de produtos para confirmar que os preços foram atualizados.",
    "steps": [
      "Obter os ficheiros de atualização de PVA, PIC, PMA, PVFD e PVAD nos formatos fornecidos pelo regulador ou fornecedor (normalmente Excel/CSV).",
      "Aceder às páginas específicas de importação através da pesquisa (por exemplo, Importar PVA, Importar PIC).",
      "Selecionar Procurar e escolher o ficheiro de cada tipo de preço.",
      "Validar os campos de mapeamento; o sistema indica quais as colunas do ficheiro que correspondem aos campos internos.",
      "Iniciar a importação; o sistema atualiza os campos de preço e margens nas fichas de produto e nas tabelas de apoio.",
      "Repetir o processo para cada tipo de preço.",
      "Após a importação, rever um conjunto de produtos para confirmar que os preços foram atualizados."
    ],
    "validation": "As tabelas de PVA, PIC, PMA, PVFD e PVAD estão atualizadas e os preços refletem as últimas alterações.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador precisa de confirmar os preços e margens importados para um produto específico.",
    "diagnosis": "Os valores de PVA, PIC, PMA, PVFD e PVAD são armazenados em campos ou páginas de preços na ficha de produto.",
    "cause": "Desconhecimento da localização destes dados na ficha de produto.",
    "solution": "Abrir a ficha de produto e aceder às páginas de Preços ou Comercial para consultar os valores.",
    "procedure": "1. Abrir a ficha do produto desejado.\n2. Ir ao separador Comercial ou Preços (dependendo da configuração).\n3. Localizar campos como Preço PVA, Preço PIC, Preço PMA, PVFD e PVAD; estes campos mostram o valor mais recente importado.\n4. Se os campos não estiverem visíveis, clicar em Navegar → Preços para abrir a página detalhada de preços onde todas as tabelas estão listadas.\n5. Verificar datas de vigência e quantidades associadas a cada preço.",
    "steps": [
      "Abrir a ficha do produto desejado.",
      "Ir ao separador Comercial ou Preços (dependendo da configuração).",
      "Localizar campos como Preço PVA, Preço PIC, Preço PMA, PVFD e PVAD; estes campos mostram o valor mais recente importado.",
      "Se os campos não estiverem visíveis, clicar em Navegar → Preços para abrir a página detalhada de preços onde todas as tabelas estão listadas.",
      "Verificar datas de vigência e quantidades associadas a cada preço."
    ],
    "validation": "Os valores de PVA, PIC, PMA, PVFD e PVAD apresentados correspondem aos dados importados e são coerentes com a tabela geral.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Um novo cliente tem de ser registado no sistema.",
    "diagnosis": "O utilizador não sabe qual o formulário ou modelo a utilizar.",
    "cause": "Falta de experiência na criação de clientes no Business Central.",
    "solution": "Criar a ficha de cliente através da lista de clientes, preencher os campos obrigatórios e submeter para aprovação.",
    "procedure": "1. A partir da pesquisa ou menu, aceder a Clientes.\n2. Selecionar Novo para abrir a ficha de cliente em branco.\n3. Se existir, escolher um Modelo de Cliente para pré preencher dados.\n4. Preencher os campos obrigatórios indicados na secção eInfo Obrigatória (Nome, Nº Identificação Fiscal, Grupo Registo Cliente, Grupo Registo VAT Cliente, etc.).\n5. Adicionar endereços de faturação e envio, contactos e outras informações relevantes.\n6. Submeter para aprovação através de Pedido → Enviar Pedido Aprovação.",
    "steps": [
      "A partir da pesquisa ou menu, aceder a Clientes.",
      "Selecionar Novo para abrir a ficha de cliente em branco.",
      "Se existir, escolher um Modelo de Cliente para pré preencher dados.",
      "Preencher os campos obrigatórios indicados na secção eInfo Obrigatória (Nome, Nº Identificação Fiscal, Grupo Registo Cliente, Grupo Registo VAT Cliente, etc.).",
      "Adicionar endereços de faturação e envio, contactos e outras informações relevantes.",
      "Submeter para aprovação através de Pedido → Enviar Pedido Aprovação."
    ],
    "validation": "O cliente aparece na lista de clientes com o pedido de aprovação pendente ou aprovado",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador quer garantir que não faltam dados antes de enviar um cliente para aprovação.",
    "diagnosis": "A ficha tem uma área de informação obrigatória que lista os campos necessários.",
    "cause": "Desconhecimento ou esquecimento de campos críticos (nome, morada, NIF, grupos de registo, etc.).",
    "solution": "Consultar a secção eInfo Obrigatória e preencher todos os campos destacados antes de enviar para aprovação.",
    "procedure": "1. Na ficha de cliente, localizar a secção eInfo Obrigatória.\n2. Preencher o Nome, Endereço, Código Postal, Localidade e País.\n3. Preencher o Nº Identificação Fiscal (NIF) e confirmar a validade.\n4. Selecionar o Grupo Registo Cliente e Grupo Registo VAT Cliente adequados.\n5. Se aplicável, preencher limites de crédito, condições de pagamento e moedas.\n6. Verificar se algum campo está marcado como Validado em: Pedido de Aprovação e garantir que está preenchido.",
    "steps": [
      "Na ficha de cliente, localizar a secção eInfo Obrigatória.",
      "Preencher o Nome, Endereço, Código Postal, Localidade e País.",
      "Preencher o Nº Identificação Fiscal (NIF) e confirmar a validade.",
      "Selecionar o Grupo Registo Cliente e Grupo Registo VAT Cliente adequados.",
      "Se aplicável, preencher limites de crédito, condições de pagamento e moedas.",
      "Verificar se algum campo está marcado como Validado em: Pedido de Aprovação e garantir que está preenchido."
    ],
    "validation": "A ficha exibe todos os campos obrigatórios preenchidos, permitindo o envio do pedido de aprovação.",
    "notes": [
      "Alguns campos (como limite de crédito) podem ser exigidos apenas em certos workflows; confirme com a sua organização."
    ],
    "rawMarkdown": "## BC-KB-098 — Que campos obrigatórios devo preencher antes de pedir aprovação de um cliente?\n\n**Categoria:** Clientes  \n**Disponível para Utilizador:** Sim  \n**Disponível para Agente:** Sim  \n\n**Problema**\nO utilizador quer garantir que não faltam dados antes de enviar um cliente para aprovação.\n\n**Diagnóstico**\nA ficha tem uma área de informação obrigatória que lista os campos necessários.\n\n**Causa provável**\nDesconhecimento ou esquecimento de campos críticos (nome, morada, NIF, grupos de registo, etc.).\n\n**Solução**\nConsultar a secção eInfo Obrigatória e preencher todos os campos destacados antes de enviar para aprovação.\n\n**Como proceder**\n1. Na ficha de cliente, localizar a secção eInfo Obrigatória.\n2. Preencher o Nome, Endereço, Código Postal, Localidade e País.\n3. Preencher o Nº Identificação Fiscal (NIF) e confirmar a validade.\n4. Selecionar o Grupo Registo Cliente e Grupo Registo VAT Cliente adequados.\n5. Se aplicável, preencher limites de crédito, condições de pagamento e moedas.\n6. Verificar se algum campo está marcado como Validado em: Pedido de Aprovação e garantir que está preenchido.\n\n**Validação final**\nA ficha exibe todos os campos obrigatórios preenchidos, permitindo o envio do pedido de aprovação.\n\n**Notas**\n- Alguns campos (como limite de crédito) podem ser exigidos apenas em certos workflows; confirme com a sua organização."
  },
  {
    "id": "bc-kb-099",
    "code": "BC-KB-099",
    "title": "Como envio um novo cliente para aprovação?",
    "category": "Clientes",
    "availableForUser": true,
    "availableForAgent": true,
    "tags": [
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O cliente foi criado mas ainda está pendente porque não foi enviado para aprovação.",
    "diagnosis": "O utilizador não encontra a opção de envio de pedido na ficha.",
    "cause": "Falta de familiaridade com a estrutura do menu Pedido.",
    "solution": "Utilizar o menu Pedido na ficha de cliente para enviar o pedido de aprovação.",
    ...
    "steps": [
      ...
      "Aceder ao menu Pedido no topo da ficha.",
      "Selecionar Enviar Pedido Aprovação.",
      "Confirmar a submissão; o sistema criará a solicitação e notificará o aprovador."
    ],
    "validation": "O pedido de aprovação é criado e aparece na lista de solicitações para aprovar.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador precisa de saber se o cliente já foi aprovado ou continua pendente.",
    "diagnosis": "O estado da aprovação não aparece claramente na ficha principal.",
    "cause": "Desconhecimento das páginas de acompanhamento de solicitações.",
    "solution": "Consultar o estado na ficha de cliente ou na página Solicitações para Aprovar.",
    "procedure": "1. Na ficha de cliente, verificar a secção Aprovações ou Estado Workflow; esta secção indica se o pedido foi enviado, aprovado ou rejeitado.\n2. Usar a pesquisa para abrir Solicitações para Aprovar e aplicar um filtro por Tipo Documento = Cliente.\n3. Localizar a linha correspondente ao cliente e verificar o estado e o nome do aprovador.\n4. Se necessário, abrir o registo do cliente através da opção Abrir Registo para ver detalhes.",
    "steps": [
      "Na ficha de cliente, verificar a secção Aprovações ou Estado Workflow; esta secção indica se o pedido foi enviado, aprovado ou rejeitado.",
      "Usar a pesquisa para abrir Solicitações para Aprovar e aplicar um filtro por Tipo Documento = Cliente.",
      "Localizar a linha correspondente ao cliente e verificar o estado e o nome do aprovador.",
      "Se necessário, abrir o registo do cliente através da opção Abrir Registo para ver detalhes."
    ],
    "validation": "O utilizador identifica com clareza o estado da aprovação e o responsável pela aprovação do cliente.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador pretende ver apenas os clientes que ainda estão em fase de aprovação.",
    "diagnosis": "A lista de clientes inclui clientes ativos, aprovados e pendentes, o que dificulta a gestão.",
    "cause": "Desconhecimento do campo Workflowstatus na lista de clientes.",
    "solution": "Aplicar um filtro no campo Workflowstatus com o valor Em Progresso.",
    ...
    "steps": [
      "Abrir a lista de Clientes.",
      "Clicar em Filtrar e escolher o campo Workflowstatus.",
      "Definir o valor para Em Progresso; isto mostrará apenas os clientes cujo pedido de aprovação está pendente.",
      "sta vista para consultas futuras se necessário."
    ],
    "validation": "A lista apresenta unicamente os clientes em processo de aprovação, facilitando o acompanhamento.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Um cliente pendente precisa de ser aprovado ou rejeitado por um utilizador com autoridade.",
    "diagnosis": "O pedido de aprovação está criado e aguarda decisão na lista de solicitações.",
    "cause": "O processo de aprovação exige uma verificação manual das informações do cliente.",
    "solution": "Aprovar ou rejeitar o pedido através da página Solicitações para Aprovar, após revisão da ficha.",
    "procedure": "1. Aceder a Solicitações para Aprovar e aplicar o filtro Tipo Documento = Cliente.\n2. Selecionar a linha relativa ao cliente pendente.\n3. Clicar em Abrir Registo para rever a ficha de cliente e confirmar os dados (NIF, morada, condições de pagamento).\n4. Voltar à lista de solicitações; se tudo estiver correto, clicar em Aprovar.\n5. Se existirem erros ou informação incompleta, escolher Rejeitar e adicionar um comentário com o motivo.\n6. O utilizador que criou o cliente será notificado da decisão.",
    "steps": [
      "Aceder a Solicitações para Aprovar e aplicar o filtro Tipo Documento = Cliente.",
      "Selecionar a linha relativa ao cliente pendente.",
      "Clicar em Abrir Registo para rever a ficha de cliente e confirmar os dados (NIF, morada, condições de pagamento).",
      "Voltar à lista de solicitações; se tudo estiver correto, clicar em Aprovar.",
      "Se existirem erros ou informação incompleta, escolher Rejeitar e adicionar um comentário com o motivo.",
      "O utilizador que criou o cliente será notificado da decisão."
    ],
    "validation": "O pedido desaparece da lista de pendentes e o cliente passa a ativo ou rejeitado, consoante a decisão.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Um cliente utiliza várias moradas de entrega e é necessário registar e gerir estas moradas.",
    "diagnosis": "A ficha de cliente principal apenas contém uma morada de faturação; as moradas adicionais são geridas separadamente.",
    "cause": "Desconhecimento da funcionalidade de Endereços Envio.",
    "solution": "Criar e gerir as moradas de envio na secção de endereços do cliente.",
    "procedure": "1. Abrir a ficha do cliente.\n2. No menu superior, selecionar Cliente → Endereços Envio.\n3. Na janela de endereços, clicar em + Novo.\n4. Preencher os campos da morada de envio (Nome do Destinatário, Morada, Código Postal, Localidade, País, Contacto).\n5. Opcionalmente, definir uma morada de envio predefinida através da seleção de Definir como predefinido.",
    "steps": [
      "Abrir a ficha do cliente.",
      "No menu superior, selecionar Cliente → Endereços Envio.",
      "Na janela de endereços, clicar em + Novo.",
      "Preencher os campos da morada de envio (Nome do Destinatário, Morada, Código Postal, Localidade, País, Contacto).",
      "Opcionalmente, definir uma morada de envio predefinida através da seleção de Definir como predefinido."
    ],
    "validation": "As moradas estão disponíveis para seleção nos documentos de venda e logística e podem ser alteradas consoante a encomenda.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Pretende adicionar um contacto ao Business Central diretamente a partir do Outlook.",
    "diagnosis": "O utilizador recebe um email de um potencial contacto e deseja registá lo sem sair do Outlook.",
    "cause": "Desconhecimento da integração entre Outlook e Business Central através do suplemento.",
    "solution": "Usar o add in do Business Central no Outlook para criar o contacto a partir do email recebido.",
    "procedure": "1. No Outlook, abrir o email do remetente que deseja adicionar como contacto.\n2. No painel direito ou superior, aceder ao suplemento do Business Central (ícone do logótipo).\n3. Selecionar Criar Contacto; o sistema apresenta um formulário pré preenchido com o nome e email do remetente.\n4. Rever e preencher dados adicionais, como telefone ou empresa.\n5. Confirmar a criação; o contacto fica imediatamente associado ao cliente correspondente ou como contacto independente.",
    "steps": [
      "No Outlook, abrir o email do remetente que deseja adicionar como contacto.",
      "No painel direito ou superior, aceder ao suplemento do Business Central (ícone do logótipo).",
      "Selecionar Criar Contacto; o sistema apresenta um formulário pré preenchido com o nome e email do remetente.",
      "Rever e preencher dados adicionais, como telefone ou empresa.",
      "Confirmar a criação; o contacto fica imediatamente associado ao cliente correspondente ou como contacto independente."
    ],
    "validation": "O novo contacto aparece na lista de contactos no Business Central e está relacionado com o cliente correto.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário adicionar contactos diretamente na ficha do cliente.",
    "diagnosis": "A ficha do cliente não possui contactos ou precisa de mais contactos associados.",
    "cause": "Desconhecimento de como aceder à área de contactos na ficha.",
    "solution": "Usar a opção Contacto na ficha de cliente para criar novos contactos.",
    ...
    "steps": [
      "Abrir a ficha do cliente.",
      "No menu, selecionar Base → Contacto.",
      "Se não existir nenhum contacto associado, o sistema pergunta se deseja criar um; responder Sim.",
      "Preencher a ficha do novo contacto com nome, email, telefone e cargo.",
      "Fechar; o contacto fica associado ao cliente.",
      "Para adicionar contactos adicionais, repetir o processo."
    ],
    "validation": "Os contactos estão listados na ficha do cliente e podem ser utilizados em oportunidades e documentos de venda.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Um contacto associado a um cliente precisa de ser atualizado ou removido.",
    "diagnosis": "Os contactos estão registados na ficha do cliente, mas não se sabe como editá los ou eliminá los.",
    "cause": "Desconhecimento da opção de gerir contactos existentes.",
    "solution": "Abrir a lista de contactos do cliente e utilizar as opções de editar ou eliminar.",
    ...
    "steps": [
      "Abrir a ficha do cliente.",
      "Selecionar Base → Contacto para ver a lista de contactos.",
      "Para editar, selecionar o contacto e clicar em Editar; alterar os campos necessários (nome, cargo, email, etc.).",
      "Para eliminar, clicar nos três pontos (menu de contexto) à direita do contacto e escolher Eliminar; confirmar a eliminação.",
      "Atualizar a ficha do cliente para refletir as alterações."
    ],
    "validation": "As alterações estão refletidas na lista de contactos e o contacto eliminado deixa de aparecer.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Um fornecedor novo necessita de ser registado no Business Central.",
    "diagnosis": "O utilizador não conhece o formulário e os campos a preencher.",
    "cause": "Falta de experiência no módulo de fornecedores.",
    "solution": "Criar a ficha de fornecedor a partir da lista de fornecedores, preencher os campos obrigatórios e enviar para aprovação.",
    "procedure": "1. A partir da pesquisa ou menu, aceder a Fornecedores.\n2. Clicar em Novo; a ficha de fornecedor abre com o número gerado automaticamente.\n3. Preencher a secção eInfo Obrigatória com Nome, Endereço, Código Postal, País, Grupo Registo Fornecedor e Grupo Registo VAT Fornecedor.\n4. Adicionar dados de contacto, condições de pagamento, moeda e valores mínimos de encomenda, se aplicável.",
    "steps": [
      "A partir da pesquisa ou menu, aceder a Fornecedores.",
      "Clicar em Novo; a ficha de fornecedor abre com o número gerado automaticamente.",
      "Preencher a secção eInfo Obrigatória com Nome, Endereço, Código Postal, País, Grupo Registo Fornecedor e Grupo Registo VAT Fornecedor.",
      "Adicionar dados de contacto, condições de pagamento, moeda e valores mínimos de encomenda, se aplicável."
    ],
    "validation": "O fornecedor surge na lista de fornecedores com a informação completa e o pedido de aprovação enviado",
    "notes": [
      "Utilize a numeração automática para uniformidade.",
      "Confirme se o fornecedor já existe para evitar duplicados."
    ],
    "rawMarkdown": "## BC-KB-107 — Como crio um novo fornecedor?\n\n**Categoria:** Fornecedores  \n**Disponível para Utilizador:** Sim  \n**Disponível para Agente:** Sim  \n\n**Problema**\nUm fornecedor novo necessita de ser registado no Business Central.\n\n**Diagnóstico**\nO utilizador não conhece o formulário e os campos a preencher.\n\n**Causa provável**\nFalta de experiência no módulo de fornecedores.\n\n**Solução**\nCriar a ficha de fornecedor a partir da lista de fornecedores, preencher os campos obrigatórios e enviar para aprovação.\n\n**Como proceder**\n1. A partir da pesquisa ou menu, aceder a Fornecedores.\n2. Clicar em Novo; a ficha de fornecedor abre com o número gerado automaticamente.\n3. Preencher a secção eInfo Obrigatória com Nome, Endereço, Código Postal, País, Grupo Registo Fornecedor e Grupo Registo VAT Fornecedor.\n4. Adicionar dados de contacto, condições de pagamento, moeda e valores mínimos de encomenda, se aplicável.\n\n**Validação final**\nO fornecedor surge na lista de fornecedores com a informação completa e o pedido de aprovação enviado\n\n**Notas**\n- Utilize a numeração automática para uniformidade.\n- Confirme se o fornecedor já existe para evitar duplicados."
  },
  {
    "id": "bc-kb-108",
    "code": "BC-KB-108",
    "title": "O número de fornecedor é manual ou automático?",
    "category": "Fornecedores",
    "availableForUser": true,
    "availableForAgent": true,
    "tags": [
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador quer saber como é atribuído o número a um novo fornecedor.",
    "diagnosis": "A ficha de fornecedor gera o número automaticamente, mas pode ser configurada para manual.",
    "cause": "Dúvida sobre a configuração de numeração no Business Central.",
    "solution": "Por defeito, o número do fornecedor é atribuído automaticamente pela série de numeração definida. Em casos específicos, é possível atribuir manualmente.",
    "procedure": "1. Ao criar um fornecedor, o campo Nº é preenchido automaticamente com base na série de numeração configurada.\n2. Se a empresa permitir numeração manual, o campo Nº pode ser editado antes de concluir a criação; contudo, esta opção deve ser evitada para manter consistência.\n3. Para alterar a configuração de numeração, aceder a Configuração → Configuração de Compras e verificar a série atribuída a fornecedores.",
    "steps": [
      "Ao criar um fornecedor, o campo Nº é preenchido automaticamente com base na série de numeração configurada.",
      "Se a empresa permitir numeração manual, o campo Nº pode ser editado antes de concluir a criação; contudo, esta opção deve ser evitada para manter consistência.",
      "Para alterar a configuração de numeração, aceder a Configuração → Configuração de Compras e verificar a série atribuída a fornecedores."
    ],
    "validation": "O número do fornecedor é gerado corretamente ou introduzido manualmente conforme a política da empresa.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador precisa de saber quais os campos essenciais antes de enviar um fornecedor para aprovação.",
    "diagnosis": "A ficha de fornecedor contém uma secção de informação obrigatória que deve ser preenchida.",
    "cause": "Falta de conhecimento dos campos críticos (nome, morada, grupos de registo, etc.).",
    "solution": "Consultar a secção eInfo Obrigatória e preencher todos os campos indicados.",
    "procedure": "1. Ao criar a ficha de fornecedor, localizar a secção eInfo Obrigatória.\n2. Preencher o Nome (razão social), Endereço, Código Postal, Localidade e País.\n3. Inserir o Nº de Identificação Fiscal (NIF).\n4. Selecionar o Grupo Registo Fornecedor e Grupo Registo VAT Fornecedor corretos.\n5. Preencher o Método de Envio e a Condição de Pagamento quando aplicável.\n6. Se os campos de aprovação exigirem, introduzir também o valor mínimo de encomenda e moeda base.",
    "steps": [
      "Ao criar a ficha de fornecedor, localizar a secção eInfo Obrigatória.",
      "Preencher o Nome (razão social), Endereço, Código Postal, Localidade e País.",
      "Inserir o Nº de Identificação Fiscal (NIF).",
      "Selecionar o Grupo Registo Fornecedor e Grupo Registo VAT Fornecedor corretos.",
      "Preencher o Método de Envio e a Condição de Pagamento quando aplicável.",
      "Se os campos de aprovação exigirem, introduzir também o valor mínimo de encomenda e moeda base."
    ],
    "validation": "Todos os campos da secção obrigatória estão preenchidos, permitindo o envio do pedido de aprovação.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Após criar o fornecedor, é necessário submetê lo ao workflow de aprovação.",
    "diagnosis": "O utilizador não sabe como iniciar o pedido de aprovação.",
    "cause": "Desconhecimento da funcionalidade Enviar Pedido Aprovação.",
    "solution": "Usar o menu Pedido na ficha do fornecedor para enviar o pedido de aprovação.",
    "procedure": "1. Abrir a ficha do fornecedor criado.\n2. Certificar se de que todos os campos obrigatórios estão preenchidos.\n3. Aceder ao menu Pedido.\n4. Selecionar Enviar Pedido Aprovação; confirmar a ação.\n5. O sistema cria uma solicitação e envia notificação ao aprovador designado.",
    "steps": [
      "Abrir a ficha do fornecedor criado.",
      "Certificar se de que todos os campos obrigatórios estão preenchidos.",
      "Aceder ao menu Pedido.",
      "Selecionar Enviar Pedido Aprovação; confirmar a ação.",
      "O sistema cria uma solicitação e envia notificação ao aprovador designado."
    ],
    "validation": "O pedido de aprovação aparece na lista de solicitações pendentes e o fornecedor fica com estado de workflow \"Em Progresso\".",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Pretende saber se um fornecedor já foi aprovado ou se continua pendente.",
    "diagnosis": "O estado da aprovação não é visível de imediato na lista de fornecedores.",
    "cause": "Desconhecimento das páginas de consulta de aprovação.",
    "solution": "Consultar o estado na ficha de fornecedor ou na página Solicitações para Aprovar.",
    "procedure": "1. Abrir a ficha do fornecedor e procurar a secção Aprovações para ver o estado atual.\n2. Usar a pesquisa e aceder a Solicitações para Aprovar.\n3. Aplicar um filtro por Tipo Documento = Fornecedor e localizar o número do fornecedor.\n4. Verificar a coluna Estado (Pendente, Aprovado, Rejeitado) e Aprovador.\n5. Se necessário, abrir o registo para ver detalhes adicionais.",
    "steps": [
      "Abrir a ficha do fornecedor e procurar a secção Aprovações para ver o estado atual.",
      "Usar a pesquisa e aceder a Solicitações para Aprovar.",
      "Aplicar um filtro por Tipo Documento = Fornecedor e localizar o número do fornecedor.",
      "Verificar a coluna Estado (Pendente, Aprovado, Rejeitado) e Aprovador.",
      "Se necessário, abrir o registo para ver detalhes adicionais."
    ],
    "validation": "O estado da aprovação é conhecido e pode ser acompanhado até à decisão final.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Precisa de identificar rapidamente os fornecedores pendentes de aprovação.",
    "diagnosis": "A lista de fornecedores contém tanto registos aprovados como pendentes, dificultando a gestão.",
    "cause": "Falta de conhecimento sobre filtros de workflow.",
    "solution": "Aplicar um filtro no campo Workflowstatus com o valor Em Progresso na lista de fornecedores.",
    ...
    "steps": [
      "Aceder à lista de Fornecedores.",
      "Clicar em Filtrar e selecionar o campo Workflowstatus.",
      "Definir o valor Em Progresso para listar apenas fornecedores ainda em aprovação.",
      "a vista personalizada se necessário para consultas futuras."
    ],
    "validation": "A lista apresenta apenas fornecedores cujo estado de workflow está em progresso",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Um fornecedor criado está pendente de aprovação e precisa de ser aprovado ou rejeitado.",
    "diagnosis": "O pedido de aprovação encontra se na lista de solicitações pendentes.",
    "cause": "O workflow exige validação por parte de um aprovador designado.",
    "solution": "Aceder à página de solicitações e tomar a decisão após rever a ficha.",
    "procedure": "1. Abrir Solicitações para Aprovar e aplicar o filtro por Tipo Documento = Fornecedor.\n2. Selecionar o pedido pendente.\n3. Clicar em Abrir Registo para analisar os dados do fornecedor (nome, NIF, condições de pagamento, produtos fornecidos).\n4. Se os dados estiverem corretos, voltar à lista e clicar em Aprovar; se houver informações incorretas ou em falta, clicar em Rejeitar e adicionar um comentário com as razões.\n5. O sistema informa o criador do fornecedor sobre a decisão.",
    "steps": [
      "Abrir Solicitações para Aprovar e aplicar o filtro por Tipo Documento = Fornecedor.",
      "Selecionar o pedido pendente.",
      "Clicar em Abrir Registo para analisar os dados do fornecedor (nome, NIF, condições de pagamento, produtos fornecidos).",
      "Se os dados estiverem corretos, voltar à lista e clicar em Aprovar; se houver informações incorretas ou em falta, clicar em Rejeitar e adicionar um comentário com as razões.",
      "O sistema informa o criador do fornecedor sobre a decisão."
    ],
    "validation": "O fornecedor é aprovado e passa a ativo ou é rejeitado e removido do fluxo, conforme a decisão.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Alguns fornecedores necessitam de aprovação específica para materiais de embalagem (Packaging) ou artes gráficas (Artworks).",
    "diagnosis": "Estas aprovações adicionais não fazem parte do workflow padrão de fornecedor e devem ser configuradas individualmente.",
    "cause": "Fornecedores que fornecem produtos com embalagem personalizada ou documentação regulatória exigem verificações extra.",
    "solution": "Configurar indicadores na ficha do fornecedor ou na ficha de produto que sinalizem a necessidade de aprovação de Packaging/Artworks.",
    ...
    "steps": [
      "Abrir a ficha do fornecedor.",
      "Localizar campos como Requer Aprovação Packaging ou Requer Aprovação Artworks (dependendo da customização).",
      "Definir estes campos como Sim quando o fornecedor fornecer produtos que necessitam de aprovação de materiais de embalagem ou de artes finais.",
      "Ao criar encomendas de compra ou produtos associados, o sistema irá solicitar aprovação adicional antes do envio para produção."
    ],
    "validation": "Fornecedores identificados requerem aprovação extra, e o processo de aprovação é ativado automaticamente quando aplicável.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Deseja que certas encomendas de fornecedores sejam aprovadas antes de serem enviadas.",
    "diagnosis": "A aprovação pré encomenda é útil para controlar compras acima de um determinado valor ou tipo de material.",
    "cause": "Necessidade de implementar controlos internos e garantir conformidade com políticas de compras.",
    "solution": "Ativar o workflow de aprovação pré encomenda na ficha do fornecedor ou nas configurações de compras.",
    "procedure": "1. Aceder a Configuração Compras e Pagamentos ou Configuração Workflow via pesquisa.\n2. Criar ou editar um workflow de aprovação para encomendas de compra, definindo condições como valor mínimo ou fornecedor específico.\n3. Associar o workflow à tabela Encomendas de Compra e definir os aprovadores.\n4. Se pretender definir a aprovação por fornecedor, abrir a ficha do fornecedor e ativar o campo Requer Aprovação Pré Encomenda (quando disponível).\n5. Testar o fluxo criando uma encomenda acima do limiar definido para garantir que o pedido de aprovação é gerado.",
    "steps": [
      "Aceder a Configuração Compras e Pagamentos ou Configuração Workflow via pesquisa.",
      "Criar ou editar um workflow de aprovação para encomendas de compra, definindo condições como valor mínimo ou fornecedor específico.",
      "Associar o workflow à tabela Encomendas de Compra e definir os aprovadores.",
      "Se pretender definir a aprovação por fornecedor, abrir a ficha do fornecedor e ativar o campo Requer Aprovação Pré Encomenda (quando disponível).",
      "Testar o fluxo criando uma encomenda acima do limiar definido para garantir que o pedido de aprovação é gerado."
    ],
    "validation": "As encomendas de compra para fornecedores configurados ou valores acima do limiar são bloqueadas até serem aprovadas.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador deseja ver todos os pedidos de aprovação pendentes de decisão.",
    "diagnosis": "Existem pedidos de produto, cliente, fornecedor ou encomenda que aguardam aprovação.",
    "cause": "Falta de conhecimento de onde centralizar as solicitações.",
    "solution": "Usar a página Solicitações para Aprovar para ver e filtrar todos os pedidos pendentes.",
    "procedure": "1. Na pesquisa do Business Central, digitar Solicitações para Aprovar e abrir a página.\n2. A lista mostra todas as solicitações pendentes; utilizar filtros por Tipo Documento (Produto, Cliente, Fornecedor, Encomenda, etc.) ou Responsável.\n3. Analisar cada linha para ver o estado, data de envio e solicitante.\n4. Selecionar uma linha e utilizar as ações disponíveis (Aprovar, Rejeitar, Abrir Registo, Comentários).",
    "steps": [
      "Na pesquisa do Business Central, digitar Solicitações para Aprovar e abrir a página.",
      "A lista mostra todas as solicitações pendentes; utilizar filtros por Tipo Documento (Produto, Cliente, Fornecedor, Encomenda, etc.) ou Responsável.",
      "Analisar cada linha para ver o estado, data de envio e solicitante.",
      "Selecionar uma linha e utilizar as ações disponíveis (Aprovar, Rejeitar, Abrir Registo, Comentários)."
    ],
    "validation": "Todas as solicitações pendentes são visíveis e organizadas, permitindo ao aprovador gerir o seu trabalho.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Um aprovador quer saber que ações pode tomar numa solicitação pendente.",
    "diagnosis": "Cada linha de aprovação apresenta várias opções contextuais.",
    "cause": "Necessidade de clarificar as ações antes de proceder.",
    "solution": "Listar as opções disponíveis: Aprovar, Rejeitar, Abrir Registo e Comentários.",
    "procedure": "1. Abrir Solicitações para Aprovar e localizar a linha pendente.\n2. Observar as ações disponíveis na faixa de opções ou no menu contextual:\no Aprovar: aceita o pedido e finaliza o processo.\no Rejeitar: recusa o pedido; deve ser indicado um comentário com o motivo.\no Abrir Registo: abre a ficha do documento (produto, cliente, fornecedor, encomenda) para revisão.\no Adicionar Comentário: permite escrever observações sem aprovar ou rejeitar.\n1. Escolher a ação apropriada com base na análise.",
    "steps": [
      "Abrir Solicitações para Aprovar e localizar a linha pendente.",
      "Observar as ações disponíveis na faixa de opções ou no menu contextual: o Aprovar: aceita o pedido e finaliza o processo. o Rejeitar: recusa o pedido; deve ser indicado um comentário com o motivo. o Abrir Registo: abre a ficha do documento (produto, cliente, fornecedor, encomenda) para revisão. o Adicionar Comentário: permite escrever observações sem aprovar ou rejeitar.",
      "Escolher a ação apropriada com base na análise."
    ],
    "validation": "O aprovador conhece e utiliza as opções corretamente, conduzindo o pedido ao estado final desejado.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O aprovador quer saber em que situações deve abrir o registo antes de aprovar ou rejeitar.",
    "diagnosis": "Nem sempre é necessário abrir o registo, mas em casos de dúvida é aconselhável.",
    "cause": "Não entendimento da utilidade de rever o registo completo.",
    "solution": "Usar Abrir Registo para verificar dados detalhados antes de tomar uma decisão.",
    "procedure": "1. Na lista de Solicitações para Aprovar, selecionar a linha do pedido.\n2. Clicar em Abrir Registo; a ficha correspondente abre permitindo visualizar todos os campos e detalhes.\n3. Rever informações como dados fiscais, preços, quantidades, datas ou anexos.\n4. Fechar a ficha; com base na informação consultada, decidir Aprovar ou Rejeitar no pedido.",
    "steps": [
      "Na lista de Solicitações para Aprovar, selecionar a linha do pedido.",
      "Clicar em Abrir Registo; a ficha correspondente abre permitindo visualizar todos os campos e detalhes.",
      "Rever informações como dados fiscais, preços, quantidades, datas ou anexos.",
      "Fechar a ficha; com base na informação consultada, decidir Aprovar ou Rejeitar no pedido."
    ],
    "validation": "O aprovador tomou uma decisão informada após analisar o conteúdo completo do registo.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Um novo concurso, ajuste direto ou proposta simples precisa ser registado no sistema.",
    "diagnosis": "O utilizador não iniciou ainda a criação de oportunidades.",
    "cause": "Desconhecimento do menu de oportunidades.",
    "solution": "Criar uma oportunidade na lista de oportunidades.",
    "procedure": "1. A partir da pesquisa, abrir Oportunidades.\n2. Clicar em Novo para criar uma nova oportunidade.\n3. Preencher o formulário em branco; o campo Nº pode ser gerado automaticamente.",
    "steps": [
      "A partir da pesquisa, abrir Oportunidades.",
      "Clicar em Novo para criar uma nova oportunidade.",
      "Preencher o formulário em branco; o campo Nº pode ser gerado automaticamente."
    ],
    "validation": "A oportunidade fica registada e visível na lista de oportunidades",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "A ficha da oportunidade deve ser caracterizada com dados básicos antes de avançar.",
    "diagnosis": "O utilizador não conhece os campos exigidos na tab Geral.",
    "cause": "Falta de formação na criação de oportunidades.",
    "solution": "Preencher os campos principais: Número, Descrição, Contacto, Prioridade, Ciclo de Vendas e Vendedor.",
    "procedure": "1. Na ficha da oportunidade, ir à tab Geral.\n2. Preencher o campo Nº (usar numeração automática se disponível).\n3. Inserir uma Descrição breve do procedimento ou negócio.\n4. Selecionar o Nº Contacto associado (cliente ou potencial cliente).\n5. Definir a Prioridade (Alta, Normal, Baixa).\n6. Selecionar o Cód. Ciclo de Vendas que determina as etapas da oportunidade.\n7. Indicar o Cód. Vendedor responsável pelo acompanhamento.",
    "steps": [
      "Na ficha da oportunidade, ir à tab Geral.",
      "Preencher o campo Nº (usar numeração automática se disponível).",
      "Inserir uma Descrição breve do procedimento ou negócio.",
      "Selecionar o Nº Contacto associado (cliente ou potencial cliente).",
      "Definir a Prioridade (Alta, Normal, Baixa).",
      "Selecionar o Cód. Ciclo de Vendas que determina as etapas da oportunidade.",
      "Indicar o Cód. Vendedor responsável pelo acompanhamento."
    ],
    "validation": "A tab Geral fica completa e a oportunidade pode avançar para as próximas fases",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário associar a oportunidade a uma pessoa de contacto dentro do cliente.",
    "diagnosis": "A ficha de oportunidade não tem um contacto atribuído ou tem um contacto incorreto.",
    "cause": "O utilizador não selecionou o campo Nº Contacto.",
    "solution": "Selecionar o contacto correto a partir da lista de contactos do cliente.",
    "procedure": "1. Na ficha da oportunidade, ir ao campo Nº Contacto.\n2. Clicar na seta de pesquisa para abrir a lista de contactos do cliente (ou de todos os clientes).\n3. Selecionar o contacto adequado (nome, cargo) e confirmar.\n4. O campo é preenchido com o código do contacto e o nome aparece adjacente.",
    "steps": [
      "Na ficha da oportunidade, ir ao campo Nº Contacto.",
      "Clicar na seta de pesquisa para abrir a lista de contactos do cliente (ou de todos os clientes).",
      "Selecionar o contacto adequado (nome, cargo) e confirmar.",
      "O campo é preenchido com o código do contacto e o nome aparece adjacente."
    ],
    "validation": "O contacto associado reflete a pessoa certa para acompanhamento da oportunidade.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário classificar a urgência ou importância de uma oportunidade.",
    "diagnosis": "O campo Prioridade está vazio ou com o valor errado.",
    "cause": "Desconhecimento da lista de prioridades e do seu impacto no ciclo de vendas.",
    "solution": "Selecionar um valor de prioridade (Alta, Normal ou Baixa) na tab Geral.",
    "procedure": "1. Na ficha de oportunidade, localizar o campo Prioridade.\n2. Clicar na seta de seleção e escolher entre Alta, Normal ou Baixa.\n3. A prioridade pode influenciar a ordem de tratamento das oportunidades e alertas no centro de perfil.",
    "steps": [
      "Na ficha de oportunidade, localizar o campo Prioridade.",
      "Clicar na seta de seleção e escolher entre Alta, Normal ou Baixa.",
      "A prioridade pode influenciar a ordem de tratamento das oportunidades e alertas no centro de perfil."
    ],
    "validation": "A oportunidade fica marcada com a prioridade adequada, refletindo a urgência do processo.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Precisa de associar a oportunidade a um ciclo de vendas que define as etapas e tarefas a realizar.",
    "diagnosis": "O campo Cód. Ciclo de Vendas pode estar em branco ou incorreto.",
    "cause": "Desconhecimento dos ciclos de vendas disponíveis e do seu propósito.",
    "solution": "Escolher o código apropriado consoante o tipo de oportunidade (Concursos Públicos, Ajustes Diretos, Propostas Simples, etc.).",
    "procedure": "1. Na ficha de oportunidade, localizar o campo Cód. Ciclo de Vendas.\n2. Clicar na seta para abrir a lista de ciclos disponíveis.\n3. Selecionar o ciclo que melhor se adapta ao tipo de oportunidade; por exemplo, Concursos Públicos tem etapas de preparação de proposta, envio, acompanhamento, etc.\n4. Confirmar; o ciclo define automaticamente as etapas e tarefas associadas.\n5. Prosseguir com o processo de Ativar Primeira Etapa quando estiver pronto.",
    "steps": [
      "Na ficha de oportunidade, localizar o campo Cód. Ciclo de Vendas.",
      "Clicar na seta para abrir a lista de ciclos disponíveis.",
      "Selecionar o ciclo que melhor se adapta ao tipo de oportunidade; por exemplo, Concursos Públicos tem etapas de preparação de proposta, envio, acompanhamento, etc.",
      "Confirmar; o ciclo define automaticamente as etapas e tarefas associadas.",
      "Prosseguir com o processo de Ativar Primeira Etapa quando estiver pronto."
    ],
    "validation": "O ciclo de vendas está selecionado corretamente e orienta o processo de acompanhamento da oportunidade.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário associar documentos relevantes (cadernos de encargos, cadernos de condições, certificados) à oportunidade.",
    "diagnosis": "A ficha de oportunidade permite anexar ficheiros, mas o utilizador não sabe como fazê lo.",
    "cause": "Falta de experiência com a funcionalidade de anexos.",
    "solution": "Utilizar a opção de anexos no menu da oportunidade para carregar ficheiros.",
    "procedure": "1. Abrir a ficha da oportunidade.\n2. No canto superior ou menu, clicar em Anexos (ou ícone de clip).\n3. Selecionar Novo Anexo ou Carregar Ficheiro.\n4. Navegar até ao local do ficheiro (por exemplo, PDF do caderno de encargos) e selecionar Abrir.\n5. O ficheiro fica associado à oportunidade; pode adicionar notas ou uma descrição ao anexo.\n6. Repetir para outros documentos.",
    "steps": [
      "Abrir a ficha da oportunidade.",
      "No canto superior ou menu, clicar em Anexos (ou ícone de clip).",
      "Selecionar Novo Anexo ou Carregar Ficheiro.",
      "Navegar até ao local do ficheiro (por exemplo, PDF do caderno de encargos) e selecionar Abrir.",
      "O ficheiro fica associado à oportunidade; pode adicionar notas ou uma descrição ao anexo.",
      "Repetir para outros documentos."
    ],
    "validation": "Os anexos aparecem listados na ficha da oportunidade e podem ser abertos ou descarregados quando necessário.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador quer saber que documentos são relevantes quando a oportunidade é um concurso público.",
    "diagnosis": "Os concursos exigem documentos específicos para preparação e submissão da proposta.",
    "cause": "Desconhecimento dos requisitos documentais de um concurso.",
    "solution": "Associar os documentos fornecidos pelo cliente e os internos necessários para elaborar a proposta.",
    "procedure": "1. Na fase inicial, anexar o Programa de Concurso e o Caderno de Encargos fornecidos pela entidade adjudicante.\n2. Anexar o Caderno de Condições e eventuais anexos técnicos relativos ao procedimento.\n3. Adicionar documentos internos como Memória Descritiva, Declarações de Responsabilidade ou certificações que acompanhem a proposta.\n4. Garantir que todos os anexos estão atualizados e completos antes de gerar a proposta.",
    "steps": [
      "Na fase inicial, anexar o Programa de Concurso e o Caderno de Encargos fornecidos pela entidade adjudicante.",
      "Anexar o Caderno de Condições e eventuais anexos técnicos relativos ao procedimento.",
      "Adicionar documentos internos como Memória Descritiva, Declarações de Responsabilidade ou certificações que acompanhem a proposta.",
      "Garantir que todos os anexos estão atualizados e completos antes de gerar a proposta."
    ],
    "validation": "Todos os documentos pertinentes estão anexados à oportunidade e servem de base para a elaboração da proposta.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário associar links externos, como páginas web ou pastas partilhadas, à oportunidade.",
    "diagnosis": "O módulo de oportunidades permite criar ligações externas, mas esta funcionalidade não foi utilizada.",
    "cause": "Desconhecimento da opção Ligações na ficha da oportunidade.",
    "solution": "Usar a opção Ligações para adicionar URL ou referências externas.",
    ...
    "steps": [
      "Abrir a ficha da oportunidade.",
      "No menu, selecionar Ligações ou Anexos → Ligações.",
      "Clicar em Nova Ligação.",
      "Introduzir o URL (por exemplo, endereço de uma pasta SharePoint, página do concurso) e uma Descrição."
    ],
    "validation": "As ligações externas ficam acessíveis através da ficha da oportunidade e permitem navegar rapidamente para recursos externos.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "A oportunidade necessita de estar ligada a uma pasta de documentos no SharePoint para colaboração.",
    "diagnosis": "Uma associação incorreta pode causar problemas de acesso ou de organização de ficheiros.",
    "cause": "Falta de boas práticas na criação e associação de pastas.",
    "solution": "Criar pastas específicas por oportunidade e assegurar permissões adequadas antes de associar.",
    "procedure": "1. No SharePoint, criar uma subpasta com o nome ou código da oportunidade numa biblioteca adequada.\n2. Definir as permissões de acesso para a equipa que irá trabalhar na oportunidade.\n3. Na ficha da oportunidade, utilizar a opção Ligações para adicionar o URL da pasta SharePoint recém criada.\n4. Verificar se o link abre corretamente para os utilizadores.\n5. Manter a organização de documentos dentro dessa pasta (subpastas por fase ou tipo de documento).",
    "steps": [
      "No SharePoint, criar uma subpasta com o nome ou código da oportunidade numa biblioteca adequada.",
      "Definir as permissões de acesso para a equipa que irá trabalhar na oportunidade.",
      "Na ficha da oportunidade, utilizar a opção Ligações para adicionar o URL da pasta SharePoint recém criada.",
      "Verificar se o link abre corretamente para os utilizadores.",
      "Manter a organização de documentos dentro dessa pasta (subpastas por fase ou tipo de documento)."
    ],
    "validation": "A pasta está ligada e os utilizadores autorizados conseguem aceder e colaborar nos documentos da oportunidade.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Pretende registar observações e informações que não cabem nos campos estruturados da oportunidade.",
    "diagnosis": "As notas permitem documentar detalhes importantes como chamadas telefónicas, reuniões e decisões internas.",
    "cause": "Não utilização da funcionalidade Notas por desconhecimento.",
    "solution": "Adicionar notas através da opção de comentários ou notas na ficha da oportunidade.",
    ...
    "steps": [
      "Abrir a ficha da oportunidade.",
      "Selecionar Notas ou Comentários (dependendo da versão).",
      "Escrever o texto da nota, mencionando data, autor e assunto (por exemplo, \"Reunião com cliente X\" ou \"Sugestão do gestor\").",
      "Adicionar tantas notas quantas necessárias ao longo do ciclo de vendas."
    ],
    "validation": "As notas ficam visíveis na ficha e servem de histórico para todos os intervenientes.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O cliente define requisitos específicos que devem constar na proposta (por exemplo, país de origem, marca, visibilidade do CDM).",
    "diagnosis": "Estes requisitos devem ser registados na ficha da oportunidade para serem impressos ou considerados na proposta.",
    "cause": "Desconhecimento dos campos disponíveis para requisitos.",
    "solution": "Usar o separador de requisitos na ficha da oportunidade para preencher os campos relevantes.",
    "procedure": "1. Na ficha da oportunidade, identificar que se trata de um concurso ou que há requisitos específicos.\n2. Aceder ao separador Requisitos ou Procedimento, conforme o layout.\n3. Preencher os campos solicitados pelo cliente (por exemplo, País de Origem, Marca, Visibilidade do CDM, Certificados exigidos).\n4. Verificar se há campos opcionais que devem ser incluídos na proposta.",
    "steps": [
      "Na ficha da oportunidade, identificar que se trata de um concurso ou que há requisitos específicos.",
      "Aceder ao separador Requisitos ou Procedimento, conforme o layout.",
      "Preencher os campos solicitados pelo cliente (por exemplo, País de Origem, Marca, Visibilidade do CDM, Certificados exigidos).",
      "Verificar se há campos opcionais que devem ser incluídos na proposta."
    ],
    "validation": "Todos os requisitos estão registados e serão considerados no documento final.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Existe dúvida sobre o momento ideal para registar as informações do procedimento do concurso.",
    "diagnosis": "Os requisitos são determinantes para a proposta e devem ser registados atempadamente.",
    "cause": "Falta de metodologia no preenchimento das fichas de concurso.",
    "solution": "Preencher os requisitos logo que a oportunidade é identificada como concurso e a documentação é recebida.",
    "procedure": "1. Assim que for confirmada a participação num concurso, abrir a ficha da oportunidade.\n2. No separador Requisitos, inserir imediatamente as informações básicas: Número do Procedimento, Título do Procedimento, Data/Hora Limite de Entrega, etc.\n3. Acrescentar outros requisitos à medida que surgirem, garantindo que todos estão registados antes de gerar a proposta.\n4. Atualizar a ficha sempre que houver clarificações ou aditamentos por parte do cliente.",
    "steps": [
      "Assim que for confirmada a participação num concurso, abrir a ficha da oportunidade.",
      "No separador Requisitos, inserir imediatamente as informações básicas: Número do Procedimento, Título do Procedimento, Data/Hora Limite de Entrega, etc.",
      "Acrescentar outros requisitos à medida que surgirem, garantindo que todos estão registados antes de gerar a proposta.",
      "Atualizar a ficha sempre que houver clarificações ou aditamentos por parte do cliente."
    ],
    "validation": "Os requisitos estão completos antes da elaboração da proposta, evitando omissões no documento final.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "A oportunidade diz respeito a um concurso público e requer informação adicional.",
    "diagnosis": "Alguns campos da ficha da oportunidade são específicos para concursos e devem ser preenchidos para que apareçam na proposta.",
    "cause": "Falta de conhecimento sobre os campos específicos de concursos.",
    "solution": "Preencher os campos de procedimento e requisitos na ficha de oportunidade.",
    "procedure": "1. Na ficha da oportunidade, aceder ao separador Requisitos.\n2. Preencher o campo Procedimento com o número do concurso (ex.: número do anúncio no Diário da República).\n3. Preencher o Título do Procedimento com a designação oficial, que será impressa na proposta.\n4. Definir a Data/Hora Limite de Entrega da Proposta conforme o caderno de encargos.\n5. Ativar e preencher outros campos específicos solicitados (País de origem, Marca, Certificações).",
    "steps": [
      "Na ficha da oportunidade, aceder ao separador Requisitos.",
      "Preencher o campo Procedimento com o número do concurso (ex.: número do anúncio no Diário da República).",
      "Preencher o Título do Procedimento com a designação oficial, que será impressa na proposta.",
      "Definir a Data/Hora Limite de Entrega da Proposta conforme o caderno de encargos.",
      "Ativar e preencher outros campos específicos solicitados (País de origem, Marca, Certificações)."
    ],
    "validation": "Todos os campos específicos do concurso estão preenchidos, permitindo a geração de propostas e documentos regulamentares.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário introduzir o número do procedimento (ou concurso) na ficha da oportunidade.",
    "diagnosis": "O documento do concurso indica o número, mas o utilizador não sabe em que campo o colocar.",
    "cause": "Desconhecimento da estrutura da ficha de oportunidade.",
    "solution": "Preencher o campo Procedimento no separador de requisitos com o número oficial do concurso.",
    "procedure": "1. Consultar o anúncio do concurso ou o convite e identificar o número do procedimento (por exemplo, o número do anúncio no Portal Base).\n2. Na ficha da oportunidade, aceder ao separador Requisitos.\n3. Introduzir o número no campo Procedimento.",
    "steps": [
      "Consultar o anúncio do concurso ou o convite e identificar o número do procedimento (por exemplo, o número do anúncio no Portal Base).",
      "Na ficha da oportunidade, aceder ao separador Requisitos.",
      "Introduzir o número no campo Procedimento."
    ],
    "validation": "O número do procedimento está corretamente registado na oportunidade e será utilizado nos documentos oficiais.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O título do concurso deve ser impresso na proposta de venda e deve corresponder ao que consta no caderno de encargos.",
    "diagnosis": "O campo de título pode estar em branco ou incorreto e precisa ser atualizado.",
    "cause": "O utilizador não sabe onde preencher o título do procedimento.",
    "solution": "Usar o campo Título do Procedimento no separador de requisitos da oportunidade.",
    ...
    "steps": [
      "Abrir a ficha da oportunidade.",
      "Aceder ao separador Requisitos.",
      "No campo Título do Procedimento, introduzir o nome oficial do concurso (por exemplo, \"Fornecimento de Medicamentos para Hospital X\").",
      "Quando a proposta de venda for gerada, o título será impresso conforme este campo."
    ],
    "validation": "O título está registado e aparece corretamente na proposta de venda e documentos relacionados.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Ao preparar uma proposta para um concurso público ou ajuste directo, é necessário indicar a data e hora em que o cliente exige a entrega da proposta de venda.",
    "diagnosis": "A ficha de oportunidade contém um separador de requisitos com um campo próprio para a data/hora limite, mas este campo está vazio ou contém informação errada.",
    "cause": "O utilizador não sabe onde inserir a data e hora de entrega ou esqueceu-se de a registar.",
    "solution": "Preencher o campo Data/Hora Limite de Entrega da Proposta no separador de requisitos da oportunidade.",
    "procedure": "1. Abrir a ficha da oportunidade relacionada com o concurso.\n2. Aceder ao separador Requisitos.\n3. Localizar o campo Data/Hora Limite de Entrega da Proposta.\n4. Introduzir a data e hora exacta exigida pelo cliente (por exemplo, 27-05-2026 10:00).",
    "steps": [
      "Abrir a ficha da oportunidade relacionada com o concurso.",
      "Aceder ao separador Requisitos.",
      "Localizar o campo Data/Hora Limite de Entrega da Proposta.",
      "Introduzir a data e hora exacta exigida pelo cliente (por exemplo, 27-05-2026 10:00)."
    ],
    "validation": "A data e hora limite aparecem preenchidas no separador de requisitos e serão impressas no documento de proposta.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Nas oportunidades de concurso existem vários campos específicos (País de origem, marca, CDM, etc.) e o utilizador não sabe se devem ser preenchidos.",
    "diagnosis": "Os campos não foram completados, o que pode levar a propostas incompletas ou rejeitadas.",
    "cause": "Falta de conhecimento sobre a finalidade destes campos e sobre a impressão automática na proposta.",
    "solution": "Utilizar os campos do separador Requisitos para registar informação exigida pelo cliente no concurso.",
    "procedure": "1. Abrir a ficha da oportunidade de concurso.\n2. Ir ao separador Requisitos.\n3. Preencher os campos disponíveis, como País de Origem, Marca, N.º de Lote/CDM, País de Fabrico ou outros solicitados no caderno de encargos.\n4. Se algum campo não for aplicável, deixar em branco ou indicar “Não aplicável”.",
    "steps": [
      "Abrir a ficha da oportunidade de concurso.",
      "Ir ao separador Requisitos.",
      "Preencher os campos disponíveis, como País de Origem, Marca, N.º de Lote/CDM, País de Fabrico ou outros solicitados no caderno de encargos.",
      "Se algum campo não for aplicável, deixar em branco ou indicar “Não aplicável”."
    ],
    "validation": "Os campos de requisitos estão preenchidos e a informação será incluída na proposta de venda.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário seguir um conjunto de etapas na gestão de uma oportunidade, mas o utilizador não sabe como funciona o ciclo de vendas.",
    "diagnosis": "O campo Cód. Ciclo de Vendas está vazio e a oportunidade não gera tarefas ou alertas.",
    "cause": "O utilizador não conhece os ciclos pré-definidos (ex.: Concursos Públicos, Ajustes Directos) e não seleccionou nenhum.",
    "solution": "O ciclo de vendas é uma estrutura com etapas e ações que guiam a oportunidade desde a criação até ao fecho; deve ser seleccionado na ficha para que o sistema gere tarefas automaticamente.",
    ...
    "steps": [
      "Abrir a ficha da oportunidade.",
      "No separador Geral, localizar o campo Cód. Ciclo de Vendas.",
      "Seleccionar o ciclo adequado (por exemplo, CONCURSO) de acordo com o tipo de negócio.",
      "Activar a primeira etapa do ciclo para iniciar o fluxo de tarefas."
    ],
    "validation": "O ciclo de vendas está seleccionado e a oportunidade mostra o estado de etapa em curso, com tarefas geradas.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Após atribuir um ciclo à oportunidade, o utilizador não sabe como iniciar a primeira etapa.",
    "diagnosis": "A oportunidade permanece com estado “Não iniciada” e não são criadas tarefas.",
    "cause": "Falta de acção manual para iniciar o ciclo.",
    "solution": "Utilizar a opção “Ativar Primeira Etapa” para colocar a oportunidade em curso.",
    "procedure": "1. Na ficha da oportunidade com ciclo de vendas atribuído, clicar em Processar.\n2. Seleccionar Ativar Primeira Etapa.\n3. Confirmar a operação; o estado da oportunidade muda para Em curso e são geradas as primeiras tarefas.",
    "steps": [
      "Na ficha da oportunidade com ciclo de vendas atribuído, clicar em Processar.",
      "Seleccionar Ativar Primeira Etapa.",
      "Confirmar a operação; o estado da oportunidade muda para Em curso e são geradas as primeiras tarefas."
    ],
    "validation": "A etapa inicial está activa e as tarefas correspondentes são criadas.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador quer saber quais as consequências de activar o ciclo de vendas.",
    "diagnosis": "Desconhecimento das funcionalidades automáticas associadas ao ciclo.",
    "cause": "Falta de formação sobre a configuração de ciclos e tarefas.",
    "solution": "Activar o ciclo desencadeia a criação de tarefas a efectuar e altera o estado da oportunidade, permitindo o seu acompanhamento.",
    "procedure": "1. Após clicar em Ativar Primeira Etapa, o estado da oportunidade muda para Em curso.\n2. O sistema cria automaticamente uma ou mais Ações a Efetuar atribuídas ao responsável de vendas ou à equipa.\n3. Estas acções aparecem no centro de perfil do utilizador e na ficha da oportunidade.",
    "steps": [
      "Após clicar em Ativar Primeira Etapa, o estado da oportunidade muda para Em curso.",
      "O sistema cria automaticamente uma ou mais Ações a Efetuar atribuídas ao responsável de vendas ou à equipa.",
      "Estas acções aparecem no centro de perfil do utilizador e na ficha da oportunidade."
    ],
    "validation": "O estado da oportunidade é “Em curso”, e as tarefas geradas podem ser vistas nas listas de acções.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Após concluir as tarefas da etapa actual, pretende avançar para a próxima fase do ciclo.",
    "diagnosis": "O campo de estado permanece na etapa actual porque a mudança não foi solicitada.",
    "cause": "O utilizador não sabe como registar a conclusão da etapa ou onde actualizar o ciclo.",
    "solution": "Utilizar a opção de actualizar etapa para avançar no ciclo de vendas.",
    "procedure": "1. Na ficha da oportunidade, garantir que todas as tarefas da etapa actual estão concluídas.\n2. Seleccionar Base → Actualizar (ou opção equivalente) para indicar a conclusão da etapa.\n3. Preencher as informações adicionais solicitadas (por exemplo, data de conclusão, notas).\n4. Confirmar; a etapa seguinte passa a ficar em curso e são criadas novas tarefas.",
    "steps": [
      "Na ficha da oportunidade, garantir que todas as tarefas da etapa actual estão concluídas.",
      "Seleccionar Base → Actualizar (ou opção equivalente) para indicar a conclusão da etapa.",
      "Preencher as informações adicionais solicitadas (por exemplo, data de conclusão, notas).",
      "Confirmar; a etapa seguinte passa a ficar em curso e são criadas novas tarefas."
    ],
    "validation": "O ciclo avança para a nova etapa e as tarefas associadas são geradas.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Necessita de ver a lista de tarefas ou acções associadas a uma oportunidade específica.",
    "diagnosis": "As acções existem mas não são visíveis porque não foram abertas a partir da ficha.",
    "cause": "Desconhecimento da localização do menu Ações a Efetuar.",
    "solution": "Aceder à lista de acções a partir da oportunidade ou do centro de perfil.",
    "procedure": "1. Abra a ficha da oportunidade e clique em Ações a Efetuar (normalmente localizada no topo ou no separador de acções).\n2. É apresentada uma lista com todas as tarefas geradas para a oportunidade, indicando o responsável, data de vencimento e estado.\n3. Como alternativa, aceda ao Centro de Perfil e consulte a secção de Ações Pendentes para ver as acções de todas as oportunidades.",
    "steps": [
      "Abra a ficha da oportunidade e clique em Ações a Efetuar (normalmente localizada no topo ou no separador de acções).",
      "É apresentada uma lista com todas as tarefas geradas para a oportunidade, indicando o responsável, data de vencimento e estado.",
      "Como alternativa, aceda ao Centro de Perfil e consulte a secção de Ações Pendentes para ver as acções de todas as oportunidades."
    ],
    "validation": "A lista de acções mostra as tarefas activas e concluídas da oportunidade.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Quer acompanhar todas as tarefas que lhe estão atribuídas, independentemente da oportunidade.",
    "diagnosis": "O utilizador não usa a área de painel ou vê apenas tarefas por acaso.",
    "cause": "Desconhecimento das funcionalidades do Centro de Perfil.",
    "solution": "Usar o Centro de Perfil para visualizar as suas acções pendentes.",
    "procedure": "1. No menu principal do Business Central, seleccionar Centro de Perfil.\n2. Na secção Ações Pendentes, encontra a lista de todas as tarefas atribuídas ao seu código de vendedor.\n3. Clicar numa acção para abrir e editar, ou marcar como concluída quando apropriado.",
    "steps": [
      "No menu principal do Business Central, seleccionar Centro de Perfil.",
      "Na secção Ações Pendentes, encontra a lista de todas as tarefas atribuídas ao seu código de vendedor.",
      "Clicar numa acção para abrir e editar, ou marcar como concluída quando apropriado."
    ],
    "validation": "O utilizador vê todas as suas acções pendentes num único painel.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Como responsável de equipa, precisa de acompanhar as tarefas atribuídas aos membros da equipa.",
    "diagnosis": "As acções da equipa estão distribuídas e não são facilmente acessíveis num único ecrã.",
    "cause": "O utilizador não está familiarizado com as opções de visão da equipa no centro de perfil ou na lista de acções.",
    "solution": "Visualizar as acções da equipa através das listas partilhadas ou de relatórios.",
    "procedure": "1. No Centro de Perfil, localizar a área Ações da Equipa (por vezes chamada Actividades da Equipa).\n2. Esta secção apresenta todas as tarefas atribuídas aos membros da equipa que gere.\n3. Usar filtros de Responsável para analisar as acções por colaborador.\n4. Para mais detalhe, abrir a ficha da oportunidade respectiva e ver as acções.",
    "steps": [
      "No Centro de Perfil, localizar a área Ações da Equipa (por vezes chamada Actividades da Equipa).",
      "Esta secção apresenta todas as tarefas atribuídas aos membros da equipa que gere.",
      "Usar filtros de Responsável para analisar as acções por colaborador.",
      "Para mais detalhe, abrir a ficha da oportunidade respectiva e ver as acções."
    ],
    "validation": "O responsável consegue ver e monitorizar as acções pendentes dos membros da sua equipa.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Confusão entre as tarefas que o utilizador deve executar e as tarefas delegadas à sua equipa.",
    "diagnosis": "O utilizador não distingue os filtros Minhas e Equipa nas listas de acções.",
    "cause": "Falta de clarificação sobre a atribuição de responsáveis.",
    "solution": "Entender que cada acção possui um campo Código Vendedor; as tarefas “Minhas” são aquelas em que o código coincide com o seu, enquanto as de equipa pertencem a outros membros sob a sua supervisão.",
    "procedure": "1. Na lista de Ações a Efetuar ou no Centro de Perfil, utilizar o filtro Responsável.\n2. Seleccionar Código Vendedor = Meu Utilizador para ver apenas as suas tarefas.\n3. Seleccionar os códigos dos membros da equipa para ver as tarefas atribuídas a cada um.\n4. Alternativamente, usar a secção Minhas Ações vs Ações da Equipa se existir no painel.",
    "steps": [
      "Na lista de Ações a Efetuar ou no Centro de Perfil, utilizar o filtro Responsável.",
      "Seleccionar Código Vendedor = Meu Utilizador para ver apenas as suas tarefas.",
      "Seleccionar os códigos dos membros da equipa para ver as tarefas atribuídas a cada um.",
      "Alternativamente, usar a secção Minhas Ações vs Ações da Equipa se existir no painel."
    ],
    "validation": "As tarefas são filtradas correctamente, distinguindo as que são da sua responsabilidade das da equipa.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Uma organização de vendas pretende criar equipas para agrupar vendedores e gerir oportunidades de forma colaborativa.",
    "diagnosis": "Não existem equipas definidas ou as equipas actuais não reflectem a estrutura da empresa.",
    "cause": "A configuração inicial não incluiu a definição de equipas ou estas precisam de ser ajustadas.",
    "solution": "Criar e editar registos de equipas através da configuração do Business Central.",
    "procedure": "1. Na pesquisa global, escrever Equipas de Vendas (ou similar) e seleccionar a página.\n2. Clicar em Novo para criar uma nova equipa.\n3. Definir um Código e Descrição para a equipa (ex.: EQUIPA_A, “Equipa Hospitalar”).\n4. Configurar um Responsável se aplicável.",
    "steps": [
      "Na pesquisa global, escrever Equipas de Vendas (ou similar) e seleccionar a página.",
      "Clicar em Novo para criar uma nova equipa.",
      "Definir um Código e Descrição para a equipa (ex.: EQUIPA_A, “Equipa Hospitalar”).",
      "Configurar um Responsável se aplicável."
    ],
    "validation": "A equipa fica disponível na lista e pode ser seleccionada em oportunidades e acções.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Precisa de atribuir um ou mais vendedores a uma equipa de vendas já existente.",
    "diagnosis": "A equipa foi criada mas não tem membros associados.",
    "cause": "Esquecimento ou dificuldade em localizar a lista de membros da equipa.",
    "solution": "Adicionar vendedores na página de linhas da equipa.",
    "procedure": "1. Abrir a página Equipas de Vendas e seleccionar a equipa pretendida.\n2. Clicar em Membros (ou Linhas de Equipa).\n3. Na lista, seleccionar Novo e escolher o vendedor a adicionar através do campo Código Vendedor.\n4. Repetir para cada vendedor adicional.",
    "steps": [
      "Abrir a página Equipas de Vendas e seleccionar a equipa pretendida.",
      "Clicar em Membros (ou Linhas de Equipa).",
      "Na lista, seleccionar Novo e escolher o vendedor a adicionar através do campo Código Vendedor.",
      "Repetir para cada vendedor adicional."
    ],
    "validation": "Os vendedores aparecem como membros da equipa seleccionada.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário remover um membro de uma equipa de vendas, por exemplo, por alteração de funções.",
    "diagnosis": "O vendedor continua associado à equipa no sistema.",
    "cause": "A operação de remoção não foi feita.",
    "solution": "Eliminar a linha do membro na página de equipas.",
    "procedure": "1. Aceder à página Equipas de Vendas e abrir a equipa pretendida.\n2. Clicar em Membros para ver a lista actual.\n3. Seleccionar a linha referente ao vendedor a remover e clicar em Eliminar.\n4. Confirmar a remoção.",
    "steps": [
      "Aceder à página Equipas de Vendas e abrir a equipa pretendida.",
      "Clicar em Membros para ver a lista actual.",
      "Seleccionar a linha referente ao vendedor a remover e clicar em Eliminar.",
      "Confirmar a remoção."
    ],
    "validation": "O vendedor deixa de constar na lista de membros da equipa.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Uma acção criada automaticamente pode precisar de correcções, como alterar a data de vencimento ou o objectivo.",
    "diagnosis": "A acção foi criada com valores predefinidos e necessita de ajuste manual.",
    "cause": "Informação adicional chegou após a criação da acção ou houve uma mudança de prioridade.",
    "solution": "Editar a acção directamente na lista.",
    "procedure": "1. Aceder à lista de Ações a Efetuar (via oportunidade ou centro de perfil).\n2. Seleccionar a linha da acção a editar.\n3. Clicar em Abrir Detalhes ou utilizar o menu Linha → Detalhes.\n4. Editar os campos necessários, como Descrição, Data Vencimento, Código Vendedor ou Prioridade.",
    "steps": [
      "Aceder à lista de Ações a Efetuar (via oportunidade ou centro de perfil).",
      "Seleccionar a linha da acção a editar.",
      "Clicar em Abrir Detalhes ou utilizar o menu Linha → Detalhes.",
      "Editar os campos necessários, como Descrição, Data Vencimento, Código Vendedor ou Prioridade."
    ],
    "validation": "Os campos alterados reflectem a nova informação e a acção aparece actualizada.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Uma tarefa atribuída a um vendedor precisa de ser transferida para outro colaborador.",
    "diagnosis": "O campo Código Vendedor da acção está atribuído à pessoa errada.",
    "cause": "Alteração na disponibilidade ou reestruturação das equipas.",
    "solution": "Editar o código de vendedor da acção para o novo responsável.",
    "procedure": "1. Abrir a acção a partir da lista de Ações a Efetuar.\n2. Localizar o campo Código Vendedor ou Responsável.\n3. Seleccionar o novo código (vendedor) a quem pretende atribuir a tarefa.\n4. Informar o novo responsável sobre a tarefa.",
    "steps": [
      "Abrir a acção a partir da lista de Ações a Efetuar.",
      "Localizar o campo Código Vendedor ou Responsável.",
      "Seleccionar o novo código (vendedor) a quem pretende atribuir a tarefa.",
      "Informar o novo responsável sobre a tarefa."
    ],
    "validation": "A acção passa a aparecer na lista do novo responsável e deixa de constar na lista do anterior.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Deseja compreender o impacto da troca do responsável numa tarefa.",
    "diagnosis": "Alterar o código de vendedor é equivalente a reatribuir a tarefa a outro utilizador.",
    "cause": "O utilizador teme perder a informação ou o seguimento da acção.",
    "solution": "Ao reatribuir uma acção, o sistema remove-a da lista do vendedor original e adiciona-a à lista do novo responsável; a acção mantém o seu historial.",
    "procedure": "1. No ecrã de edição da acção, alterar o campo Código Vendedor para o novo responsável.\n2. O novo responsável passa a ver a acção no centro de perfil; o anterior já não tem acesso directo.",
    "steps": [
      "No ecrã de edição da acção, alterar o campo Código Vendedor para o novo responsável.",
      "O novo responsável passa a ver a acção no centro de perfil; o anterior já não tem acesso directo."
    ],
    "validation": "A reatribuição é visível na lista de acções de ambos os vendedores e a acção permanece íntegra.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Uma acção foi criada com estado Por Iniciar e o utilizador já começou a trabalhá-la.",
    "diagnosis": "O estado não reflecte a situação actual e pode provocar confusão no relatório de tarefas.",
    "cause": "O utilizador não actualizou manualmente o estado da acção.",
    "solution": "Definir o estado da acção como Em Curso.",
    "procedure": "1. Aceder à lista de Ações a Efetuar e abrir a acção desejada.\n2. No campo Estado, seleccionar Em Curso.",
    "steps": [
      "Aceder à lista de Ações a Efetuar e abrir a acção desejada.",
      "No campo Estado, seleccionar Em Curso."
    ],
    "validation": "O estado da acção passa a Em Curso e o centro de perfil reflecte a mudança.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Após terminar a actividade correspondente, é necessário encerrar a tarefa no sistema.",
    "diagnosis": "A acção permanece em estado Por Iniciar ou Em Curso, apesar de concluída.",
    "cause": "O utilizador não executou a conclusão na interface.",
    "solution": "Alterar o estado para Concluído e registar a interacção ou nota final.",
    "procedure": "1. Abra a acção através da lista de Ações a Efetuar.\n2. Seleccionar Estado = Concluído.\n3. Preencher, se necessário, um registo de interacção ou comentário com o resultado da tarefa.",
    "steps": [
      "Abra a acção através da lista de Ações a Efetuar.",
      "Seleccionar Estado = Concluído.",
      "Preencher, se necessário, um registo de interacção ou comentário com o resultado da tarefa."
    ],
    "validation": "A acção deixa de aparecer nas listas de pendentes e passa a constar no histórico.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Ao concluir uma acção, o Business Central sugere criar um novo registo de interacção, mas o utilizador apenas quer marcar a tarefa como concluída.",
    "diagnosis": "A funcionalidade de conclusão pode estar configurada para pedir interacções por defeito.",
    "cause": "Pode existir uma regra de interacção automática associada ao tipo de acção.",
    "solution": "Escolher a opção para concluir sem interacção quando disponível.",
    "procedure": "1. Ao clicar para Concluir uma acção, observar se o sistema pede para registar uma nova interacção.\n2. Se surgir o diálogo, seleccionar a opção Concluir sem Interação ou simplesmente fechar a janela de registo.\n3. Verifique se o estado da acção passou a Concluído.",
    "steps": [
      "Ao clicar para Concluir uma acção, observar se o sistema pede para registar uma nova interacção.",
      "Se surgir o diálogo, seleccionar a opção Concluir sem Interação ou simplesmente fechar a janela de registo.",
      "Verifique se o estado da acção passou a Concluído."
    ],
    "validation": "A acção fica concluída sem registo de nova interacção.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Pretende adicionar uma tarefa que não foi gerada automaticamente pelo ciclo de vendas.",
    "diagnosis": "O fluxo da oportunidade não contempla determinada actividade, mas esta continua a ser necessária.",
    "cause": "Nova informação do cliente ou necessidade interna que surge após a geração das tarefas.",
    "solution": "Criar manualmente uma acção e associá-la à oportunidade.",
    "procedure": "1. Na ficha da oportunidade, clicar em Ações a Efetuar ou abrir a lista de acções gerais.\n2. Seleccionar Novo para criar uma nova acção.\n3. Preencher os campos principais: Descrição, Data Vencimento, Código Vendedor (responsável), Prioridade e, se aplicável, Tipo de Tarefa.",
    "steps": [
      "Na ficha da oportunidade, clicar em Ações a Efetuar ou abrir a lista de acções gerais.",
      "Seleccionar Novo para criar uma nova acção.",
      "Preencher os campos principais: Descrição, Data Vencimento, Código Vendedor (responsável), Prioridade e, se aplicável, Tipo de Tarefa."
    ],
    "validation": "A nova acção fica visível na lista associada à oportunidade.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Uma acção criada manualmente deve ser executada por um colega e não por quem a criou.",
    "diagnosis": "O criador aparece como responsável por omissão.",
    "cause": "O campo Código Vendedor foi preenchido com o utilizador corrente.",
    "solution": "Ao criar a acção, definir o responsável correcto ou editá-la posteriormente.",
    "procedure": "1. Ao criar a nova acção (BC-KB-153), definir o Código Vendedor para o colaborador pretendido.\n2. Se já estiver criada, abrir a acção na lista.\n3. Alterar o campo Código Vendedor para o responsável pretendido.",
    "steps": [
      "Ao criar a nova acção (BC-KB-153), definir o Código Vendedor para o colaborador pretendido.",
      "Se já estiver criada, abrir a acção na lista.",
      "Alterar o campo Código Vendedor para o responsável pretendido."
    ],
    "validation": "A acção aparece na lista do colaborador designado.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Precisa de associar o código ou referência do pedido do cliente à oportunidade para facilitar a comunicação.",
    "diagnosis": "O campo de referência do cliente está vazio ou incorrecto na ficha de oportunidade.",
    "cause": "O utilizador não localizou o campo adequado ou esqueceu-se de o preencher.",
    "solution": "Usar o campo Referência do Cliente na ficha da oportunidade.",
    ...
    "steps": [
      "Abrir a ficha da oportunidade.",
      "No separador Geral, localizar o campo Referência do Cliente (também pode aparecer como Nº Pedido Cliente).",
      "Introduzir a referência fornecida pelo cliente."
    ],
    "validation": "O número de pedido do cliente fica associado à oportunidade e será transferido para a proposta.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O cliente enviou uma lista de produtos desejados e deseja consultá-la numa oportunidade ou proposta.",
    "diagnosis": "Os produtos não aparecem porque não foram adicionados ou estão noutra página.",
    "cause": "Os produtos foram registados numa proposta ou num anexo e não na lista de produtos da oportunidade.",
    "solution": "Aceder ao separador Produtos da oportunidade ou abrir a proposta associada.",
    "procedure": "1. Na ficha da oportunidade, seleccionar o separador Produtos (ou eProdutos).\n2. Aqui pode adicionar, editar ou consultar as linhas de produto solicitadas pelo cliente.\n3. Se a lista estiver vazia, clique em Inserir e seleccione os produtos a partir do catálogo.\n4. Alternativamente, abra a Proposta de Venda associada (BC-KB-159) para ver as linhas de produto já compiladas.",
    "steps": [
      "Na ficha da oportunidade, seleccionar o separador Produtos (ou eProdutos).",
      "Aqui pode adicionar, editar ou consultar as linhas de produto solicitadas pelo cliente.",
      "Se a lista estiver vazia, clique em Inserir e seleccione os produtos a partir do catálogo.",
      "Alternativamente, abra a Proposta de Venda associada (BC-KB-159) para ver as linhas de produto já compiladas."
    ],
    "validation": "A lista de produtos solicitados pelo cliente está visível na ficha da oportunidade ou na proposta.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Deseja aplicar filtros de atributos (ex.: fórmula, acondicionamento, embalagem) para sugerir produtos na proposta.",
    "diagnosis": "Os atributos existem nas fichas de produtos, mas não estão a ser considerados na escolha de produtos.",
    "cause": "O utilizador desconhece o módulo de atributos ou não usa as funcionalidades de filtro.",
    "solution": "Utilizar a pesquisa por atributos ao adicionar produtos e apresentar esses atributos na proposta.",
    "procedure": "1. Ao adicionar linhas de produto na oportunidade ou na proposta, utilizar a funcionalidade de filtro de atributos:\n2. Seleccionar Selecionar Produtos ou Adicionar Produtos.\n3. No painel de selecção, aplicar filtros nos campos Atributo e Valor (ex.: Atributo = \"Marca\", Valor = \"Genérico\").\n4. Confirmar a selecção; apenas os produtos que correspondem aos atributos escolhidos serão listados.\n5. Inserir os produtos desejados na proposta.",
    "steps": [
      "Ao adicionar linhas de produto na oportunidade ou na proposta, utilizar a funcionalidade de filtro de atributos:",
      "Seleccionar Selecionar Produtos ou Adicionar Produtos.",
      "No painel de selecção, aplicar filtros nos campos Atributo e Valor (ex.: Atributo = \"Marca\", Valor = \"Genérico\").",
      "Confirmar a selecção; apenas os produtos que correspondem aos atributos escolhidos serão listados.",
      "Inserir os produtos desejados na proposta."
    ],
    "validation": "Os produtos inseridos correspondem aos atributos seleccionados, garantindo aderência às especificações do cliente.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Precisa de analisar dados adicionais para decidir se avança ou não com uma proposta.",
    "diagnosis": "Nem todas as informações relevantes estão visíveis por defeito na ficha de oportunidade.",
    "cause": "O utilizador não explorou os factboxes e relatórios associados à oportunidade.",
    "solution": "Utilizar as FactBoxes e relatórios de apoio existentes na página da oportunidade.",
    "procedure": "1. Na ficha da oportunidade, explorar o painel lateral de FactBoxes. Estes podem incluir:\n2. Último Preço de Venda do cliente para o produto.\n3. Margem Comercial prevista.\n4. Histórico de Interacções e Ações Pendentes.\n5. Montante Total previsto da proposta.\n6. Usar relatórios padrão, como Análise de Oportunidades, para comparar ganhos e perdas por vendedor, região ou produto.\n7. Explorar outras páginas relacionadas, como Histórico de Propostas, para ver propostas anteriores ao mesmo cliente.",
    "steps": [
      "Na ficha da oportunidade, explorar o painel lateral de FactBoxes. Estes podem incluir:",
      "Último Preço de Venda do cliente para o produto.",
      "Margem Comercial prevista.",
      "Histórico de Interacções e Ações Pendentes.",
      "Montante Total previsto da proposta.",
      "Usar relatórios padrão, como Análise de Oportunidades, para comparar ganhos e perdas por vendedor, região ou produto.",
      "Explorar outras páginas relacionadas, como Histórico de Propostas, para ver propostas anteriores ao mesmo cliente."
    ],
    "validation": "O utilizador tem acesso a dados detalhados para tomar uma decisão informada sobre a oportunidade.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário criar rapidamente uma proposta de venda com base nos dados da oportunidade.",
    "diagnosis": "A proposta ainda não foi gerada ou está associada a outra oportunidade.",
    "cause": "O utilizador ainda não clicou na opção de associação ou não sabe onde a encontrar.",
    "solution": "Associar a proposta de venda através da opção Associar Proposta Venda.",
    ...
    "steps": [
      "Abrir a ficha da oportunidade.",
      "Clicar em Processar → Associar Proposta Venda.",
      "O sistema cria uma proposta de venda com as linhas de produtos e condições comerciais da oportunidade.",
      "Rever a proposta e efectuar ajustes se necessário."
    ],
    "validation": "A nova proposta de venda fica associada à oportunidade e visível nos campos de documento.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Uma proposta de venda associada à oportunidade está incorrecta e deve ser substituída.",
    "diagnosis": "O campo Nº Documento de Venda na oportunidade contém o número de uma proposta que se pretende remover.",
    "cause": "Erros nos produtos, preços ou condições da proposta original.",
    "solution": "Remover a associação e criar nova proposta.",
    "procedure": "1. Na ficha da oportunidade, apagar o valor do campo Nº Documento de Venda.\n2. Corrigir os produtos ou condições no separador Produtos ou outros campos.\n3. Voltar a usar Processar → Associar Proposta Venda para gerar uma nova proposta.",
    "steps": [
      "Na ficha da oportunidade, apagar o valor do campo Nº Documento de Venda.",
      "Corrigir os produtos ou condições no separador Produtos ou outros campos.",
      "Voltar a usar Processar → Associar Proposta Venda para gerar uma nova proposta."
    ],
    "validation": "A nova proposta está correcta e associada; a anterior deixou de estar ligada à oportunidade.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Uma proposta de venda foi criada por engano ou não será enviada ao cliente.",
    "diagnosis": "A proposta está listada no sistema e ocupa espaço ou causa confusão.",
    "cause": "Decisão de não enviar ou criação de documento duplicado.",
    "solution": "Eliminar a proposta através da acção de apagar.",
    "procedure": "1. Abrir a proposta de venda a eliminar.\n2. Clicar no ícone Eliminar (representado por um caixote do lixo).\n3. Confirmar a eliminação.",
    "steps": [
      "Abrir a proposta de venda a eliminar.",
      "Clicar no ícone Eliminar (representado por um caixote do lixo).",
      "Confirmar a eliminação."
    ],
    "validation": "A proposta desaparece da lista e deixa de estar associada à oportunidade.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário incluir notas específicas em cada linha de produto de uma proposta para esclarecer condições ou características.",
    "diagnosis": "A proposta de venda não apresenta comentários nas linhas e o utilizador desconhece a funcionalidade.",
    "cause": "O menu de linhas Comentário não foi utilizado.",
    "solution": "Inserir comentários na linha de produto.",
    "procedure": "1. Na proposta de venda, seleccionar a linha de produto em que pretende adicionar o comentário.\n2. Clicar em Linha → Comentário.\n3. Inserir o texto do comentário (ex.: \"Entrega em 48 h\", \"Produto substituto disponível\").\n4. Fechar a janela; o comentário fica associado à linha.",
    "steps": [
      "Na proposta de venda, seleccionar a linha de produto em que pretende adicionar o comentário.",
      "Clicar em Linha → Comentário.",
      "Inserir o texto do comentário (ex.: \"Entrega em 48 h\", \"Produto substituto disponível\").",
      "Fechar a janela; o comentário fica associado à linha."
    ],
    "validation": "Os comentários são impressos na proposta de venda sob a respectiva linha.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Precisa de gerar um documento formal de proposta adaptado a concursos públicos.",
    "diagnosis": "O utilizador não sabe qual o relatório correto a usar.",
    "cause": "Confusão entre opções de impressão (proposta interna, concursos, factura pró-forma).",
    "solution": "Usar a opção de impressão específica para concursos.",
    "procedure": "1. Abrir a proposta de venda associada ao concurso.\n2. Clicar em Imprimir/Enviar.\n3. Seleccionar Imprimir Proposta Concursos (ou nomenclatura similar).\n4. Gerar o documento e imprimir ou descarregar em PDF conforme necessário.",
    "steps": [
      "Abrir a proposta de venda associada ao concurso.",
      "Clicar em Imprimir/Enviar.",
      "Seleccionar Imprimir Proposta Concursos (ou nomenclatura similar).",
      "Gerar o documento e imprimir ou descarregar em PDF conforme necessário."
    ],
    "validation": "O sistema gera um documento formatado para concursos, incluindo os requisitos e campos específicos.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário que o produto seja reaprovisionado automaticamente quando o stock atinge determinados níveis, mas os parâmetros de planeamento não estão definidos.",
    "diagnosis": "A ficha de produto não contém valores de política de reaprovisionamento, ponto de encomenda ou quantidades mínimas/máximas.",
    "cause": "O utilizador nunca configurou o separador Planeamento do produto.",
    "solution": "Preencher os campos de planeamento na ficha de produto para que o MRP (planeador) funcione correctamente.",
    "procedure": "1. Abrir a ficha de produto.\n2. Navegar até ao separador Planeamento.\n3. Definir a Política de Reaprovisionamento:\n4. Fixa (Reorder Point) – cria encomendas quando o stock atinge o ponto de encomenda.\n5. Máximo – repõe até à quantidade máxima.\n6. Nenhum – não gera propostas automáticas.\n7. Preencher Ponto de Encomenda (quantidade mínima de stock).\n8. Definir Qtde. Reposição (quantidade de encomenda padrão).\n9. Indicar Qtde. Múltiplo Encomenda se as encomendas tiverem de ser múltiplos (ver BC-KB-168).\n10. Preencher Qtde. Máxima de Encomenda se pretender limitar o stock.",
    "steps": [
      "Abrir a ficha de produto.",
      "Navegar até ao separador Planeamento.",
      "Definir a Política de Reaprovisionamento:",
      "Fixa (Reorder Point) – cria encomendas quando o stock atinge o ponto de encomenda.",
      "Máximo – repõe até à quantidade máxima.",
      "Nenhum – não gera propostas automáticas.",
      "Preencher Ponto de Encomenda (quantidade mínima de stock).",
      "Definir Qtde. Reposição (quantidade de encomenda padrão).",
      "Indicar Qtde. Múltiplo Encomenda se as encomendas tiverem de ser múltiplos (ver BC-KB-168).",
      "Preencher Qtde. Máxima de Encomenda se pretender limitar o stock."
    ],
    "validation": "O separador de planeamento está preenchido e o planeador gera sugestões correctas.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Um produto tem diferentes parâmetros de planeamento consoante a unidade de armazenamento (U/M) ou localização.",
    "diagnosis": "Os reaprovisionamentos podem estar a ser gerados com valores errados porque a unidade de armazenamento não tem planeamento específico.",
    "cause": "O utilizador desconhece a página de Unidade de Armazenamento do Produto.",
    "solution": "Configurar os parâmetros de planeamento na página da unidade de armazenamento.",
    "procedure": "1. Aceder à ficha do produto.\n2. Na acção Relacionadas → Produto → Unidades de Armazenamento, abrir a página.\n3. Seleccionar ou criar a linha da localização/unidade pretendida.\n4. Preencher os campos de planeamento específicos: Política de Reaprovisionamento, Ponto de Encomenda, Qtde. Reposição, Qtde. Múltiplo Encomenda, etc., conforme necessário para aquela localização.",
    "steps": [
      "Aceder à ficha do produto.",
      "Na acção Relacionadas → Produto → Unidades de Armazenamento, abrir a página.",
      "Seleccionar ou criar a linha da localização/unidade pretendida.",
      "Preencher os campos de planeamento específicos: Política de Reaprovisionamento, Ponto de Encomenda, Qtde. Reposição, Qtde. Múltiplo Encomenda, etc., conforme necessário para aquela localização."
    ],
    "validation": "Cada unidade de armazenamento tem os seus próprios parâmetros de planeamento e o sistema gera sugestões correctas.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Deseja perceber as diferentes opções de política de reaprovisionamento para escolher a mais adequada.",
    "diagnosis": "O utilizador vê várias opções (Nenhum, Fixa, Máximo) e não sabe qual aplicar.",
    "cause": "Falta de conhecimento sobre o impacto de cada política no planeamento.",
    "solution": "Conhecer e seleccionar a política correcta na ficha de produto ou unidade de armazenamento.",
    "procedure": "1. Na ficha de produto, no separador Planeamento, localizar o campo Política de Reaprovisionamento.\n2. As opções usuais são:\n3. Nenhum: o planeador não cria encomendas automaticamente; adequado para produtos de produção sob encomenda.\n4. Fixa (Reorder Point): o sistema gera encomendas quando o stock cai abaixo do Ponto de Encomenda, reabastecendo até à Qtde. Reposição.\n5. Máximo: o planeador reabastece até atingir a Qtde. Máxima de Encomenda sempre que o stock cai abaixo do ponto de encomenda.\n6. Pedido: em algumas versões, pode existir Pedido para aprovisionamento baseado em encomendas de venda específicas.\n7. Seleccionar a política mais apropriada ao ciclo de vida e consumo do produto.",
    "steps": [
      "Na ficha de produto, no separador Planeamento, localizar o campo Política de Reaprovisionamento.",
      "As opções usuais são:",
      "Nenhum: o planeador não cria encomendas automaticamente; adequado para produtos de produção sob encomenda.",
      "Fixa (Reorder Point): o sistema gera encomendas quando o stock cai abaixo do Ponto de Encomenda, reabastecendo até à Qtde. Reposição.",
      "Máximo: o planeador reabastece até atingir a Qtde. Máxima de Encomenda sempre que o stock cai abaixo do ponto de encomenda.",
      "Pedido: em algumas versões, pode existir Pedido para aprovisionamento baseado em encomendas de venda específicas.",
      "Seleccionar a política mais apropriada ao ciclo de vida e consumo do produto."
    ],
    "validation": "A política de aprovisionamento escolhida está configurada e as sugestões de compra comportam-se conforme esperado.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Alguns fornecedores exigem encomendas mínimas; o planeador deve sugerir quantidades conforme esse requisito.",
    "diagnosis": "As propostas de compra estão a ser criadas abaixo da quantidade mínima, gerando rejeições.",
    "cause": "O campo Qtde. Reposição está a zero ou com valor inferior ao mínimo exigido.",
    "solution": "Definir a quantidade mínima de encomenda na ficha de produto ou na unidade de armazenamento.",
    "procedure": "1. Abrir a ficha de produto e ir ao separador Planeamento.\n2. No campo Qtde. Reposição, introduzir a quantidade mínima que deve ser encomendada de uma só vez (por exemplo, 100 unidades).\n3. Se a quantidade mínima variar por fornecedor, configurar também a página Fornecedor do Produto para cada fornecedor (campo Quantidade Mínima).",
    "steps": [
      "Abrir a ficha de produto e ir ao separador Planeamento.",
      "No campo Qtde. Reposição, introduzir a quantidade mínima que deve ser encomendada de uma só vez (por exemplo, 100 unidades).",
      "Se a quantidade mínima variar por fornecedor, configurar também a página Fornecedor do Produto para cada fornecedor (campo Quantidade Mínima)."
    ],
    "validation": "As sugestões de compra obedecem à quantidade mínima definida.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Alguns produtos só podem ser encomendados em múltiplos de uma quantidade fixa (ex.: caixas de 12).",
    "diagnosis": "O planeador gera quantidades que não são múltiplas e as encomendas precisam de ser corrigidas manualmente.",
    "cause": "O campo de múltiplo de encomenda não está definido.",
    "solution": "Preencher o campo Qtde. Múltiplo Encomenda.",
    "procedure": "1. Abrir a ficha de produto → separador Planeamento.\n2. No campo Qtde. Múltiplo Encomenda, introduzir o múltiplo pretendido (por exemplo, 12).\n3. Se necessário, definir valores diferentes por unidade de armazenamento ou fornecedor nas páginas correspondentes.",
    "steps": [
      "Abrir a ficha de produto → separador Planeamento.",
      "No campo Qtde. Múltiplo Encomenda, introduzir o múltiplo pretendido (por exemplo, 12).",
      "Se necessário, definir valores diferentes por unidade de armazenamento ou fornecedor nas páginas correspondentes."
    ],
    "validation": "As sugestões de compra são arredondadas ao múltiplo configurado.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Durante a recepção de mercadoria, as quantidades das linhas de encomenda alteram-se automaticamente, mas pretende impedir essa actualização para manter os valores originais.",
    "diagnosis": "O parâmetro de atualização de linhas está activo por defeito.",
    "cause": "Configuração geral permite actualizar linhas ao lançar a recepção, alterando quantidades e valores.",
    "solution": "Desactivar a actualização automática de linhas na encomenda de compra.",
    "procedure": "1. Abrir a Encomenda de Compra.\n2. Na faixa Processar, procurar a opção Não Actualizar Linhas (ou Lock Lines).\n3. Marcar esta opção para impedir que as linhas sejam actualizadas durante a recepção ou faturação.",
    "steps": [
      "Abrir a Encomenda de Compra.",
      "Na faixa Processar, procurar a opção Não Actualizar Linhas (ou Lock Lines).",
      "Marcar esta opção para impedir que as linhas sejam actualizadas durante a recepção ou faturação."
    ],
    "validation": "Ao receber ou facturar, as quantidades originais não são alteradas.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador precisa de gerar sugestões de compra, mas não encontra a Folha de Requisição.",
    "diagnosis": "A folha de requisição não está seleccionada ou não foi criada para o utilizador.",
    "cause": "Não existe uma folha de requisição associada ao utilizador ou desconhece como aceder.",
    "solution": "Abrir a Folha de Requisição e garantir que existe uma folha específica.",
    "procedure": "1. Na barra de pesquisa, escrever Folhas de Requisição e seleccionar a página.\n2. Verificar o Nome da Folha de Requisição; cada utilizador deve utilizar a sua própria folha.\n3. Se a folha não existir, solicitar a sua criação à equipa de suporte.\n4. Para mudar de folha, utilizar os três pontos e seleccionar outra folha existente.",
    "steps": [
      "Na barra de pesquisa, escrever Folhas de Requisição e seleccionar a página.",
      "Verificar o Nome da Folha de Requisição; cada utilizador deve utilizar a sua própria folha.",
      "Se a folha não existir, solicitar a sua criação à equipa de suporte.",
      "Para mudar de folha, utilizar os três pontos e seleccionar outra folha existente."
    ],
    "validation": "A folha de requisição correcta está aberta e pronta para gerar sugestões.",
    "notes": [
      "Trabalhar numa folha própria evita conflitos com as sugestões de outros utilizadores."
    ],
    "rawMarkdown": "## BC-KB-170 — Como acedo à Folha de Requisição?\n\n**Categoria:** Compras / Planeamento  \n**Disponível para Utilizador:** Sim  \n**Disponível para Agente:** Sim  \n\n**Problema**  \nO utilizador precisa de gerar sugestões de compra, mas não encontra a Folha de Requisição.\n\n**Diagnóstico**  \nA folha de requisição não está seleccionada ou não foi criada para o utilizador.\n\n**Causa provável**  \nNão existe uma folha de requisição associada ao utilizador ou desconhece como aceder.\n\n**Solução**  \nAbrir a Folha de Requisição e garantir que existe uma folha específica.\n\n**Como proceder**  \n1. Na barra de pesquisa, escrever Folhas de Requisição e seleccionar a página.\n2. Verificar o Nome da Folha de Requisição; cada utilizador deve utilizar a sua própria folha.\n3. Se a folha não existir, solicitar a sua criação à equipa de suporte.\n4. Para mudar de folha, utilizar os três pontos e seleccionar outra folha existente.\n\n**Validação final**  \nA folha de requisição correcta está aberta e pronta para gerar sugestões.\n\n**Notas**  \n- Trabalhar numa folha própria evita conflitos com as sugestões de outros utilizadores."
  },
  {
    "id": "bc-kb-171",
    "code": "BC-KB-171",
    "title": "Que parâmetros devo preencher para gerar sugestões de compra?",
    "category": "Compras / Planeamento",
    "availableForUser": true,
    "availableForAgent": true,
    "tags": [
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Ao gerar sugestões de reaprovisionamento na folha de requisição, surgem campos e opções que o utilizador desconhece.",
    "diagnosis": "Os campos de data e previsões não foram configurados, resultando em sugestões incorrectas.",
    "cause": "Desconhecimento das opções de planeamento ao usar a funcionalidade Sugerir Requisição Produtos.",
    "solution": "Preencher os parâmetros de período e de utilização de previsão antes de gerar a sugestão.",
    "procedure": "1. Na folha de requisição, clicar em Processar → Sugerir Requisição Produtos.\n2. Na janela que surge, definir:\n3. Data Inicial e Data Final – intervalo de tempo para o planeamento.\n4. Utilizar Previsão – activar se existir previsão de vendas (BC-KB-181).\n5. Excluir Previsão Anterior a – introduzir uma data para ignorar previsões antigas.\n6. Respeitar Parâmetros Planeamento – marcar para considerar pontos de encomenda, quantidades mínimas/máximas.\n7. Opcionalmente, aplicar filtros como Nº (produto específico) ou Nº Fornecedor.\n8. Confirmar.",
    "steps": [
      "Na folha de requisição, clicar em Processar → Sugerir Requisição Produtos.",
      "Na janela que surge, definir:",
      "Data Inicial e Data Final – intervalo de tempo para o planeamento.",
      "Utilizar Previsão – activar se existir previsão de vendas (BC-KB-181).",
      "Excluir Previsão Anterior a – introduzir uma data para ignorar previsões antigas.",
      "Respeitar Parâmetros Planeamento – marcar para considerar pontos de encomenda, quantidades mínimas/máximas.",
      "Opcionalmente, aplicar filtros como Nº (produto específico) ou Nº Fornecedor.",
      "Confirmar."
    ],
    "validation": "As linhas de sugestão geradas reflectem o período e parâmetros definidos.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Após gerar a sugestão, é necessário ajustar quantidades ou condições antes de criar encomendas de compra.",
    "diagnosis": "As linhas sugeridas podem conter quantidades desajustadas ou fornecedores errados.",
    "cause": "Os parâmetros iniciais de planeamento não incluíram todas as restrições ou existem excepções.",
    "solution": "Rever e editar manualmente as linhas de sugestão.",
    "procedure": "1. Na folha de requisição, analisar cada linha gerada.\n2. Eliminar linhas desnecessárias ou adicionar linhas manualmente.\n3. Verificar e ajustar os campos Nº (produto), Mensagem de Acção (Novo, Alterar Qtde., Reagendar), Código Localização, Quantidade Original e Quantidade.\n4. Seleccionar fornecedores alternativos, se necessário, ajustando o campo Nº Fornecedor (ver BC-KB-174).\n5. Ajustar a Data Vencimento se o planeamento assim o exigir.",
    "steps": [
      "Na folha de requisição, analisar cada linha gerada.",
      "Eliminar linhas desnecessárias ou adicionar linhas manualmente.",
      "Verificar e ajustar os campos Nº (produto), Mensagem de Acção (Novo, Alterar Qtde., Reagendar), Código Localização, Quantidade Original e Quantidade.",
      "Seleccionar fornecedores alternativos, se necessário, ajustando o campo Nº Fornecedor (ver BC-KB-174).",
      "Ajustar a Data Vencimento se o planeamento assim o exigir."
    ],
    "validation": "As linhas de sugestão editadas correspondem às quantidades e fornecedores correctos.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Quer identificar se a sugestão de compra provém de uma encomenda de venda, previsão ou ponto de encomenda.",
    "diagnosis": "Não há clareza sobre a origem da sugestão na folha de requisição.",
    "cause": "O utilizador não utilizou a funcionalidade de rastreio de encomendas.",
    "solution": "Usar a opção Rastreio Encomenda para ver a cadeia de origem.",
    "procedure": "1. Seleccionar a linha de sugestão na folha de requisição.\n2. Clicar em Linha → Rastreio Encomenda.\n3. Analisar a janela que mostra se a sugestão deriva de uma encomenda de venda, previsão de vendas, stock de segurança ou outros factores.\n4. Fechar a janela após a análise.",
    "steps": [
      "Seleccionar a linha de sugestão na folha de requisição.",
      "Clicar em Linha → Rastreio Encomenda.",
      "Analisar a janela que mostra se a sugestão deriva de uma encomenda de venda, previsão de vendas, stock de segurança ou outros factores.",
      "Fechar a janela após a análise."
    ],
    "validation": "A origem da sugestão é claramente identificada e documentada.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Pretende trocar o fornecedor sugerido por outro configurado na ficha de produto.",
    "diagnosis": "Na folha de requisição, a linha apresenta apenas um fornecedor padrão.",
    "cause": "Não foi consultada a lista de fornecedores alternativos associados ao produto.",
    "solution": "Seleccionar o fornecedor alternativo na linha de sugestão.",
    "procedure": "1. Na folha de requisição, posicionar-se na linha desejada.\n2. Clicar no campo Nº Fornecedor e abrir a lista.\n3. Seleccionar um dos fornecedores alternativos configurados para o produto.\n4. Verificar se as restantes condições (quantidade, data) continuam adequadas.",
    "steps": [
      "Na folha de requisição, posicionar-se na linha desejada.",
      "Clicar no campo Nº Fornecedor e abrir a lista.",
      "Seleccionar um dos fornecedores alternativos configurados para o produto.",
      "Verificar se as restantes condições (quantidade, data) continuam adequadas."
    ],
    "validation": "A linha reflecte o fornecedor alternativo escolhido.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Após rever as linhas de sugestão, o utilizador não sabe que ações estão disponíveis para processar as linhas.",
    "diagnosis": "As linhas permanecem no estado “aberto” e não geram encomendas de compra.",
    "cause": "O utilizador não executou as mensagens de acção ou desconhece as opções.",
    "solution": "Utilizar a funcionalidade de Executar Mensagem de Acção para processar as linhas e gerar encomendas.",
    "procedure": "1. Na folha de requisição, depois de editar as linhas, clicar em Processar → Executar Mensagem de Acção.\n2. O sistema executa cada linha conforme a sua Mensagem de Acção:\n3. Novo – cria uma nova encomenda de compra.\n4. Alterar Quantidade – ajusta uma encomenda existente.\n5. Reagendar – altera datas.\n6. Reagendar & Mudar Qtde. – altera datas e quantidades.\n7. Cancelar – elimina a sugestão.\n8. Verificar as encomendas criadas ou actualizadas.",
    "steps": [
      "Na folha de requisição, depois de editar as linhas, clicar em Processar → Executar Mensagem de Acção.",
      "O sistema executa cada linha conforme a sua Mensagem de Acção:",
      "Novo – cria uma nova encomenda de compra.",
      "Alterar Quantidade – ajusta uma encomenda existente.",
      "Reagendar – altera datas.",
      "Reagendar & Mudar Qtde. – altera datas e quantidades.",
      "Cancelar – elimina a sugestão.",
      "Verificar as encomendas criadas ou actualizadas."
    ],
    "validation": "As encomendas são geradas e as linhas de requisição são processadas.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Deseja garantir que uma encomenda de compra atinge um valor mínimo exigido pelo fornecedor.",
    "diagnosis": "Ao libertar a encomenda, surge um aviso de que o valor total está abaixo do mínimo.",
    "cause": "O valor mínimo de compra está definido na ficha do fornecedor e a encomenda não o cumpre.",
    "solution": "Configurar o valor mínimo na ficha do fornecedor e ajustar a encomenda para satisfazer esse mínimo.",
    "procedure": "1. Na ficha do fornecedor, definir o Valor Mínimo de Encomenda (campo que pode chamar-se Valor Mínimo).\n2. Criar ou editar a Encomenda de Compra com as linhas necessárias.\n3. Ao libertar a encomenda, o sistema compara o valor total com o mínimo.\n4. Se o valor for inferior, adicionar produtos ou aumentar quantidades até ultrapassar o mínimo.\n5. Libertar novamente.",
    "steps": [
      "Na ficha do fornecedor, definir o Valor Mínimo de Encomenda (campo que pode chamar-se Valor Mínimo).",
      "Criar ou editar a Encomenda de Compra com as linhas necessárias.",
      "Ao libertar a encomenda, o sistema compara o valor total com o mínimo.",
      "Se o valor for inferior, adicionar produtos ou aumentar quantidades até ultrapassar o mínimo.",
      "Libertar novamente."
    ],
    "validation": "A encomenda cumpre o valor mínimo e o sistema não apresenta alertas.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É preciso saber quando o sistema verifica se a encomenda de compra atinge o valor mínimo.",
    "diagnosis": "O utilizador não tem certeza se a validação ocorre na criação, ao libertar ou ao facturar.",
    "cause": "Falta de clarificação sobre o ponto exacto da verificação.",
    "solution": "Entender que o valor mínimo é validado no momento de libertação da encomenda.",
    "procedure": "1. Criar ou editar a encomenda de compra normalmente.\n2. No momento de clicar em Libertar, o sistema calcula o valor total e verifica se cumpre o Valor Mínimo definido no fornecedor.\n3. Se não cumprir, é apresentado um aviso e a encomenda não é libertada.\n4. Ajustar as linhas conforme necessário e tentar libertar novamente.",
    "steps": [
      "Criar ou editar a encomenda de compra normalmente.",
      "No momento de clicar em Libertar, o sistema calcula o valor total e verifica se cumpre o Valor Mínimo definido no fornecedor.",
      "Se não cumprir, é apresentado um aviso e a encomenda não é libertada.",
      "Ajustar as linhas conforme necessário e tentar libertar novamente."
    ],
    "validation": "O alerta surge apenas no acto de libertação; após corrigir, a encomenda é libertada.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "A empresa fornece produtos a farmácias e pretende registar essas compras (de farmácias para a empresa) de forma correcta no Business Central.",
    "diagnosis": "Não existe um processo documentado específico para compras a farmácias, o que gera dúvidas na criação das encomendas.",
    "cause": "As farmácias são tratadas como clientes e fornecedores simultaneamente, podendo confundir o utilizador sobre o módulo a utilizar.",
    "solution": "Tratar a farmácia como fornecedor quando a empresa lhe compra produtos e utilizar o fluxo normal de encomenda de compra, atribuindo a categoria correcta para rastreio.",
    "procedure": "1. Criar uma ficha de Fornecedor para cada farmácia a quem a empresa compra produtos (se já existir como cliente, adicionar a ficha de fornecedor com código idêntico).\n2. Na ficha do fornecedor, atribuir a categoria Farmácia ou utilizar a dimensão correspondente para segmentação.\n3. Criar uma Encomenda de Compra e seleccionar o fornecedor (farmácia).\n4. Inserir as linhas de produtos a comprar.\n5. Processar a encomenda seguindo o fluxo normal de compras (libertar, receber, registar factura).",
    "steps": [
      "Criar uma ficha de Fornecedor para cada farmácia a quem a empresa compra produtos (se já existir como cliente, adicionar a ficha de fornecedor com código idêntico).",
      "Na ficha do fornecedor, atribuir a categoria Farmácia ou utilizar a dimensão correspondente para segmentação.",
      "Criar uma Encomenda de Compra e seleccionar o fornecedor (farmácia).",
      "Inserir as linhas de produtos a comprar.",
      "Processar a encomenda seguindo o fluxo normal de compras (libertar, receber, registar factura)."
    ],
    "validation": "A compra à farmácia está registada como compra e aparece nos relatórios de fornecedores.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Necessita de saber em que menu iniciar o processo de compra a uma farmácia.",
    "diagnosis": "O utilizador não localiza a opção correcta no interface.",
    "cause": "Os menus de compras contêm várias opções (encomendas, facturas, requisições) e há incerteza sobre a escolha.",
    "solution": "Aceder ao menu Encomendas de Compra e seleccionar a farmácia como fornecedor.",
    "procedure": "1. No menu principal ou no campo de pesquisa, escrever Encomendas de Compra e abrir a página.\n2. Clicar em Novo para criar uma nova encomenda.\n3. Seleccionar a farmácia como fornecedor (ver BC-KB-178).\n4. Inserir as linhas de produtos e seguir o fluxo normal de compra.",
    "steps": [
      "No menu principal ou no campo de pesquisa, escrever Encomendas de Compra e abrir a página.",
      "Clicar em Novo para criar uma nova encomenda.",
      "Seleccionar a farmácia como fornecedor (ver BC-KB-178).",
      "Inserir as linhas de produtos e seguir o fluxo normal de compra."
    ],
    "validation": "Uma nova encomenda de compra à farmácia é criada correctamente.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Pretende consultar a previsão de vendas/consumo para planear compras futuras.",
    "diagnosis": "Não sabe onde encontrar a previsão de necessidades registada no sistema.",
    "cause": "Desconhecimento da página de Previsão de Necessidades (ou equivalente).",
    "solution": "Utilizar a página de previsão para visualizar e gerir dados de previsão.",
    "procedure": "1. No campo de pesquisa, escrever Previsão de Necessidades ou Previsão de Vendas.\n2. Abrir a página correspondente (pode chamar-se Previsão de Demanda ou Previsão de Necessidades).\n3. Seleccionar o Período e a Unidade de Tempo (mensal, semanal, diário) para ver os dados.\n4. Filtrar por Produto, Localização ou Fornecedor conforme necessário.",
    "steps": [
      "No campo de pesquisa, escrever Previsão de Necessidades ou Previsão de Vendas.",
      "Abrir a página correspondente (pode chamar-se Previsão de Demanda ou Previsão de Necessidades).",
      "Seleccionar o Período e a Unidade de Tempo (mensal, semanal, diário) para ver os dados.",
      "Filtrar por Produto, Localização ou Fornecedor conforme necessário."
    ],
    "validation": "A previsão de necessidades é apresentada com valores por período.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário introduzir ou actualizar a previsão de consumo para determinados produtos.",
    "diagnosis": "Os valores de previsão estão em branco ou desactualizados.",
    "cause": "As previsões não foram introduzidas manualmente nem importadas de ficheiros externos.",
    "solution": "Inserir ou editar valores de previsão em cada período na página Previsão de Necessidades.",
    "procedure": "1. Aceder à página Previsão de Necessidades (BC-KB-180).\n2. Seleccionar o produto e período pretendido.\n3. Introduzir a quantidade prevista em cada célula para os períodos futuros (ex.: 100 unidades para Maio 2026).\n4. Repetir para todos os produtos e períodos relevantes.\n5. Alternativamente, utilizar a opção Importar de Excel para carregar previsões a partir de um ficheiro com as colunas de produto, período e quantidade.",
    "steps": [
      "Aceder à página Previsão de Necessidades (BC-KB-180).",
      "Seleccionar o produto e período pretendido.",
      "Introduzir a quantidade prevista em cada célula para os períodos futuros (ex.: 100 unidades para Maio 2026).",
      "Repetir para todos os produtos e períodos relevantes.",
      "Alternativamente, utilizar a opção Importar de Excel para carregar previsões a partir de um ficheiro com as colunas de produto, período e quantidade."
    ],
    "validation": "Os valores de previsão estão registados na base de dados e podem ser utilizados pelo planeador.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Existe um repositório externo (SGNCL) que armazena previsões de necessidades, mas o utilizador não sabe a sua função no processo.",
    "diagnosis": "O planeador ou administrador menciona o SGNCL mas o utilizador não o utiliza directamente.",
    "cause": "O SGNCL é uma base de dados central gerida por outra equipa e não faz parte da interface diária.",
    "solution": "Compreender que o SGNCL é utilizado para centralizar e partilhar previsões de necessidades entre parceiros, sendo carregado e consultado por scripts ou integrações.",
    "procedure": "1. Reconhecer que o Repositório SGNCL não é uma página interactiva no Business Central.\n2. A previsão de necessidades é exportada para o SGNCL por equipas de planeamento ou TI; os dados são depois lidos pelos sistemas centrais de logística.\n3. Se for necessário actualizar o repositório, contactar a equipa responsável ou seguir os procedimentos de exportação definidos internamente.",
    "steps": [
      "Reconhecer que o Repositório SGNCL não é uma página interactiva no Business Central.",
      "A previsão de necessidades é exportada para o SGNCL por equipas de planeamento ou TI; os dados são depois lidos pelos sistemas centrais de logística.",
      "Se for necessário actualizar o repositório, contactar a equipa responsável ou seguir os procedimentos de exportação definidos internamente."
    ],
    "validation": "Os dados de previsão são partilhados com o repositório e utilizados para planear necessidades a nível global.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "A empresa quer registar preços de compra específicos por fornecedor, produto e quantidade mínima.",
    "diagnosis": "Não existe uma lista de preços de compra configurada ou os preços estão a ser inseridos manualmente em cada linha de encomenda.",
    "cause": "Falta de utilização da funcionalidade de listas de preços de compra do Business Central.",
    "solution": "Criar uma lista de preços de compra e inserir linhas com os preços acordados.",
    "procedure": "1. No campo de pesquisa, escrever Listas Preços de Compra (ou Preço Compra).\n2. Clicar em Novo para criar uma nova lista.\n3. Preencher os campos: Descrição, Fornecedor, Moeda (se aplicável), Data Início e Data Fim.\n4. No separador Linhas, inserir cada produto com os campos: Nº Produto, Unidade de Medida, Quantidade Mínima, Preço e, se necessário, Desconto.\n5. Por fim, clicar em Activar para que a lista fique disponível; apenas listas activas são consideradas nas encomendas.",
    "steps": [
      "No campo de pesquisa, escrever Listas Preços de Compra (ou Preço Compra).",
      "Clicar em Novo para criar uma nova lista.",
      "Preencher os campos: Descrição, Fornecedor, Moeda (se aplicável), Data Início e Data Fim.",
      "No separador Linhas, inserir cada produto com os campos: Nº Produto, Unidade de Medida, Quantidade Mínima, Preço e, se necessário, Desconto.",
      "Por fim, clicar em Activar para que a lista fique disponível; apenas listas activas são consideradas nas encomendas."
    ],
    "validation": "A lista de preços de compra está activa e os preços são automaticamente sugeridos nas encomendas.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário actualizar uma lista de preços de compra existente, alterando datas, produtos ou valores.",
    "diagnosis": "A lista de preços está activa ou pendente e contém linhas desactualizadas ou em falta.",
    "cause": "Revisão de contratos com fornecedores ou actualização de custos, exigindo correcções nas listas de preços.",
    "solution": "Abrir a lista de preços de compra, editar cabeçalho e linhas, reactivar se necessário.",
    "procedure": "1. Pesquisar por Listas de Preços de Compra e abrir a lista a editar.\n2. Se a lista estiver activa, seleccionar Acções → Desactivar para permitir alterações.\n3. No cabeçalho, actualizar campos como Descrição, Data Início, Data Fim ou Fornecedor, se aplicável.\n4. No separador Linhas, navegar pelas linhas existentes e alterar os campos Quantidade Mínima, Preço, Desconto ou Unidade de Medida conforme o novo acordo.\n5. Para adicionar novos produtos, inserir uma linha em branco e preencher o Nº Produto e os restantes campos; para remover produtos, seleccionar a linha e clicar em Eliminar Linha.\n6. Verificar se todas as linhas têm preços válidos e que as datas no cabeçalho cobrem o período pretendido.\n7. Activar novamente a lista clicando em Activar; a lista fica disponível para ser usada em encomendas.",
    "steps": [
      "Pesquisar por Listas de Preços de Compra e abrir a lista a editar.",
      "Se a lista estiver activa, seleccionar Acções → Desactivar para permitir alterações.",
      "No cabeçalho, actualizar campos como Descrição, Data Início, Data Fim ou Fornecedor, se aplicável.",
      "No separador Linhas, navegar pelas linhas existentes e alterar os campos Quantidade Mínima, Preço, Desconto ou Unidade de Medida conforme o novo acordo.",
      "Para adicionar novos produtos, inserir uma linha em branco e preencher o Nº Produto e os restantes campos; para remover produtos, seleccionar a linha e clicar em Eliminar Linha.",
      "Verificar se todas as linhas têm preços válidos e que as datas no cabeçalho cobrem o período pretendido.",
      "Activar novamente a lista clicando em Activar; a lista fica disponível para ser usada em encomendas."
    ],
    "validation": "A lista de preços apresenta o estado Activa e as linhas reflectem os valores actualizados.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Após criar ou editar uma lista de preços de compra, é necessário que fique disponível para utilização nas encomendas.",
    "diagnosis": "A lista encontra-se em estado Aberta ou Desactivada, não sendo usada no cálculo automático de preços.",
    "cause": "A lista foi recentemente criada ou alterada e ainda não foi activada.",
    "solution": "Utilizar a acção Activar para mudar o estado da lista para Activa.",
    "procedure": "1. Pesquisar por Listas de Preços de Compra e seleccionar a lista pretendida.\n2. Verificar se o campo Estado está como Aberta ou Desactivada.\n3. Rever as linhas e confirma que todas as informações estão correctas.\n4. Clicar em Activar no separador superior ou em Acções → Activar.\n5. Confirmar a activação quando solicitado; o estado muda para Activa.\n6. Caso surja alguma mensagem de erro, corrigir dados obrigatórios em falta e repetir a activação.",
    "steps": [
      "Pesquisar por Listas de Preços de Compra e seleccionar a lista pretendida.",
      "Verificar se o campo Estado está como Aberta ou Desactivada.",
      "Rever as linhas e confirma que todas as informações estão correctas.",
      "Clicar em Activar no separador superior ou em Acções → Activar.",
      "Confirmar a activação quando solicitado; o estado muda para Activa.",
      "Caso surja alguma mensagem de erro, corrigir dados obrigatórios em falta e repetir a activação."
    ],
    "validation": "O campo Estado da lista apresenta Activa e a lista é considerada na determinação de preços.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Uma lista de preços de compra deixa de ser válida porque expirou ou foi substituída por uma nova lista.",
    "diagnosis": "A lista ainda aparece como Activa e está a ser aplicada em encomendas apesar de estar desactualizada.",
    "cause": "Esquecimento em alterar o estado da lista quando termina o acordo com o fornecedor.",
    "solution": "Desactivar a lista de preços de compra para que deixe de ser considerada e/ou expirar o período de validade.",
    "procedure": "1. Pesquisar por Listas de Preços de Compra e seleccionar a lista a inactivar.\n2. Confirmar que existe uma nova lista activa ou que já não é necessário aplicar a lista actual.\n3. Clicar em Desactivar ou, se o menu diferir, ir a Acções → Desactivar.\n4. Confirmar a desactivação quando solicitado; o estado passa a Desactivada.\n5. Em alternativa, ajustar os campos Data Fim para uma data anterior ao dia actual para que a lista expire automaticamente.",
    "steps": [
      "Pesquisar por Listas de Preços de Compra e seleccionar a lista a inactivar.",
      "Confirmar que existe uma nova lista activa ou que já não é necessário aplicar a lista actual.",
      "Clicar em Desactivar ou, se o menu diferir, ir a Acções → Desactivar.",
      "Confirmar a desactivação quando solicitado; o estado passa a Desactivada.",
      "Em alternativa, ajustar os campos Data Fim para uma data anterior ao dia actual para que a lista expire automaticamente."
    ],
    "validation": "O campo Estado da lista apresenta Desactivada e os preços deixam de ser sugeridos.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Determinado fornecedor tem preços específicos para diferentes contactos ou departamentos e é necessário registá-los.",
    "diagnosis": "Os preços registados na lista de preços são globais ao fornecedor e não distinguem contactos, o que pode originar preços errados nas encomendas.",
    "cause": "Falta de configuração dos campos Contacto Fornecedor nas linhas da lista de preços de compra.",
    "solution": "Preencher o campo Contacto Fornecedor em cada linha da lista de preços para associar o preço ao contacto correcto.",
    "procedure": "1. Abrir a lista de preços de compra que pretende configurar.\n2. Na zona de linhas, personalizar a vista para mostrar a coluna Contacto Fornecedor (utilize Mostrar Mais Colunas se necessário).\n3. Para cada produto, seleccionar ou introduzir o nome ou número do contacto correspondente ao departamento do fornecedor.\n4. Preencher o preço, quantidade mínima e outros campos para esse contacto específico.\n5. Repetir o processo para cada contacto que tenha preços diferentes.",
    "steps": [
      "Abrir a lista de preços de compra que pretende configurar.",
      "Na zona de linhas, personalizar a vista para mostrar a coluna Contacto Fornecedor (utilize Mostrar Mais Colunas se necessário).",
      "Para cada produto, seleccionar ou introduzir o nome ou número do contacto correspondente ao departamento do fornecedor.",
      "Preencher o preço, quantidade mínima e outros campos para esse contacto específico.",
      "Repetir o processo para cada contacto que tenha preços diferentes."
    ],
    "validation": "Ao criar uma encomenda de compra e seleccionar o mesmo contacto do fornecedor, o preço adequado é automaticamente sugerido.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Os produtos podem ser fornecidos por mais do que um fornecedor e é necessário registar fornecedores alternativos com prazos de entrega, quantidades mínimas e preços.",
    "diagnosis": "A ficha do produto apenas contém o fornecedor principal e não estão definidos fornecedores alternativos. O planeamento ou a folha de requisão não sugere alternativas.",
    "cause": "O campo Fornecedores Alternativos não foi preenchido na ficha do produto.",
    "solution": "Configurar fornecedores alternativos na ficha do produto, definindo prazos de entrega, quantidades mínimas e preços unitários.",
    ...
    "steps": [
      "Aceder à ficha do produto.",
      "Ir a Relacionado → Planeamento → Fornecedores Alternativos.",
      "Clicar em Novo para adicionar um fornecedor alternativo.",
      "Preencher os campos Nº Fornecedor, Tempo de Aprovisionamento, Quantidade Mínima, Preço Unitário e outros campos relevantes.",
      "Repetir para todos os fornecedores alternativos aplicáveis."
    ],
    "validation": "Na Folha de Requisição, as sugestões de compra incluem fornecedores alternativos quando o fornecedor principal não está disponível ou quando as condições são mais vantajosas.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário submeter uma encomenda de compra à aprovação de superiores antes de ser enviada ao fornecedor.",
    "diagnosis": "A encomenda está em estado Aberta e contém linhas completas, mas ainda não foi enviada para aprovação.",
    "cause": "O utilizador não iniciou o fluxo de aprovação ou desconhece o procedimento.",
    "solution": "Enviar a encomenda para aprovação através da funcionalidade de workflows de aprovação.",
    "procedure": "1. Aceder à Encomenda de Compra que pretende submeter.\n2. Validar que todos os campos obrigatórios no cabeçalho (Fornecedor, Datas, Localização) e nas linhas (Produto, Quantidade, Preço) estão correctos.\n3. No separador Pedido, seleccionar Enviar Pedido de Aprovação (ou Solicitar Aprovação).\n4. Confirmar o envio quando for apresentado o diálogo.\n5. O estado da encomenda muda para Pendente de Aprovação; a encomenda fica bloqueada para edições até ser aprovada ou rejeitada.",
    "steps": [
      "Aceder à Encomenda de Compra que pretende submeter.",
      "Validar que todos os campos obrigatórios no cabeçalho (Fornecedor, Datas, Localização) e nas linhas (Produto, Quantidade, Preço) estão correctos.",
      "No separador Pedido, seleccionar Enviar Pedido de Aprovação (ou Solicitar Aprovação).",
      "Confirmar o envio quando for apresentado o diálogo.",
      "O estado da encomenda muda para Pendente de Aprovação; a encomenda fica bloqueada para edições até ser aprovada ou rejeitada."
    ],
    "validation": "A encomenda aparece em Solicitações para Aprovar com estado Pendente, indicando que a aprovação está em curso.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Após enviar uma encomenda de compra para aprovação, o utilizador pretende acompanhar o estado e saber se já foi aprovada ou rejeitada.",
    "diagnosis": "Não é claro onde consultar a lista de solicitações pendentes ou o histórico de aprovações.",
    "cause": "Desconhecimento da página Solicitações para Aprovar ou dos filtros necessários.",
    "solution": "Utilizar a página Solicitações para Aprovar ou consultar o campo Estado de Aprovação directamente na encomenda.",
    "procedure": "1. Pesquisar por Solicitações para Aprovar e abrir a página.\n2. Na lista, filtrar pelo campo Tipo de Documento para Encomenda de Compra.\n3. Localizar a encomenda pelo número ou fornecedor e observar a coluna Estado (Pendente, Aprovado, Rejeitado).\n4. Para mais detalhes, abrir o registo e consultar as entradas de workflow.\n5. Em alternativa, abrir a própria encomenda de compra: o cabeçalho exibe o campo Estado de Aprovação com o valor actual.",
    "steps": [
      "Pesquisar por Solicitações para Aprovar e abrir a página.",
      "Na lista, filtrar pelo campo Tipo de Documento para Encomenda de Compra.",
      "Localizar a encomenda pelo número ou fornecedor e observar a coluna Estado (Pendente, Aprovado, Rejeitado).",
      "Para mais detalhes, abrir o registo e consultar as entradas de workflow.",
      "Em alternativa, abrir a própria encomenda de compra: o cabeçalho exibe o campo Estado de Aprovação com o valor actual."
    ],
    "validation": "O utilizador consegue ver se a encomenda está pendente, aprovada ou rejeitada e, no caso de aprovação, consegue prosseguir para o envio ao fornecedor.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Um colaborador com permissões de aprovador precisa aprovar ou rejeitar uma encomenda de compra pendente.",
    "diagnosis": "A encomenda encontra-se em estado Pendente de Aprovação e aguarda a decisão do aprovador.",
    "cause": "As regras de aprovação exigem intervenção manual para valores acima de determinados limites.",
    "solution": "Aceder às solicitações de aprovação, analisar a encomenda e selecionar Aprovar ou Rejeitar.",
    "procedure": "1. Pesquisar por Solicitações para Aprovar e aplicar o filtro para encomendas de compra.\n2. Seleccionar a linha da encomenda que pretende aprovar.\n3. Clicar em Aprovar para autorizar o pedido ou em Rejeitar para devolvê-lo ao requisitante.\n4. Se necessário, adicionar um comentário ou motivo de rejeição.\n5. Após aprovar, o estado muda para Aprovado e a encomenda desbloqueia; o requisitante pode continuar com o processo (envio, recepção, etc.).",
    "steps": [
      "Pesquisar por Solicitações para Aprovar e aplicar o filtro para encomendas de compra.",
      "Seleccionar a linha da encomenda que pretende aprovar.",
      "Clicar em Aprovar para autorizar o pedido ou em Rejeitar para devolvê-lo ao requisitante.",
      "Se necessário, adicionar um comentário ou motivo de rejeição.",
      "Após aprovar, o estado muda para Aprovado e a encomenda desbloqueia; o requisitante pode continuar com o processo (envio, recepção, etc.)."
    ],
    "validation": "A encomenda de compra fica com estado Aprovado e pode ser registada ou enviada ao fornecedor.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Algumas encomendas de compra já foram completamente recebidas e faturadas, mas continuam visíveis como Aberto e constam nos relatórios de compromissos.",
    "diagnosis": "O sistema mantém encomendas abertas até que sejam manualmente encerradas, mesmo quando não existem mais quantidades por receber ou faturar.",
    "cause": "Falta de conhecimento sobre a funcionalidade Fechar Encomenda ou Encerrar.",
    "solution": "Fechar manualmente a encomenda de compra após verificar que todas as quantidades foram recebidas e faturadas.",
    "procedure": "1. Abrir a Encomenda de Compra que pretende encerrar.\n2. Verificar que as colunas Qtd. Recebida e Qtd. Faturada coincidem com a Qtd. Encomendada em todas as linhas.\n3. No separador Processo, clicar em Fechar Encomenda (ou Fechar conforme versão).\n4. Confirmar o fecho; o estado da encomenda muda para Fechada.",
    "steps": [
      "Abrir a Encomenda de Compra que pretende encerrar.",
      "Verificar que as colunas Qtd. Recebida e Qtd. Faturada coincidem com a Qtd. Encomendada em todas as linhas.",
      "No separador Processo, clicar em Fechar Encomenda (ou Fechar conforme versão).",
      "Confirmar o fecho; o estado da encomenda muda para Fechada."
    ],
    "validation": "A encomenda desaparece da lista de abertas e fica marcada como Fechada, não contribuindo para relatórios de compromissos.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Após recepção de uma encomenda de compra, algumas quantidades não foram entregues e é necessário registar o motivo de não fornecimento para análise.",
    "diagnosis": "Existem linhas da encomenda parcialmente recebidas ou com entrega zero e o campo Motivo Não Fornecimento está em branco.",
    "cause": "Falta de registo do motivo por parte do operador ou ausência de parâmetros para recolher a informação.",
    "solution": "Associar um motivo de não fornecimento à linha da encomenda de compra para posterior tratamento e estatísticas.",
    "procedure": "1. Aceder à Encomenda de Compra depois da recepção parcial.\n2. Seleccionar a linha afectada e expandir para ver os detalhes.\n3. Adicionar a coluna Motivo Não Fornecimento à vista, se não estiver visível (utilizar Escolher Colunas).\n4. Escolher o motivo adequado na lista (ex.: Falta de Stock, Produto Descontinuado, Erro de Planeamento).",
    "steps": [
      "Aceder à Encomenda de Compra depois da recepção parcial.",
      "Seleccionar a linha afectada e expandir para ver os detalhes.",
      "Adicionar a coluna Motivo Não Fornecimento à vista, se não estiver visível (utilizar Escolher Colunas).",
      "Escolher o motivo adequado na lista (ex.: Falta de Stock, Produto Descontinuado, Erro de Planeamento)."
    ],
    "validation": "O campo Motivo Não Fornecimento fica preenchido na linha e pode ser utilizado para relatórios e análises de fornecedores.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Antes de registar ou enviar uma encomenda de venda, o utilizador pretende garantir que todos os dados estão correctos e que a encomenda passa nas validações do sistema.",
    "diagnosis": "A encomenda contém linhas de produtos e dados do cliente, mas podem existir campos incompletos ou erros de crédito, preços e disponibilidades.",
    "cause": "Falta de revisão dos campos obrigatórios ou ausência de verificação prévia de crédito e stock.",
    "solution": "Utilizar a funcionalidade de Validar encomendas de venda para identificar e corrigir erros antes de registar.",
    "procedure": "1. Aceder à Encomenda de Venda que pretende validar.\n2. No separador Processo, clicar em Validar (ou Verificar Documento).\n3. O sistema verifica: existência de produto, disponibilidade em stock, restrições de crédito do cliente, preços e descontos, e campos obrigatórios.\n4. Se existirem erros ou avisos, o sistema apresenta mensagens; ler cada mensagem, corrigir os campos indicados e executar novamente a validação.\n5. Quando não existirem mensagens de erro, a encomenda está pronta para registo ou envio.",
    "steps": [
      "Aceder à Encomenda de Venda que pretende validar.",
      "No separador Processo, clicar em Validar (ou Verificar Documento).",
      "O sistema verifica: existência de produto, disponibilidade em stock, restrições de crédito do cliente, preços e descontos, e campos obrigatórios.",
      "Se existirem erros ou avisos, o sistema apresenta mensagens; ler cada mensagem, corrigir os campos indicados e executar novamente a validação.",
      "Quando não existirem mensagens de erro, a encomenda está pronta para registo ou envio."
    ],
    "validation": "A encomenda de venda é validada sem erros e está apta a ser registada ou enviada.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Em determinadas vendas, as quantidades encomendadas não são totalmente fornecidas e é necessário registar o motivo para análise e comunicação ao cliente.",
    "diagnosis": "Existem linhas de encomenda de venda com quantidades por entregar, mas o campo Motivo Não Fornecimento não está preenchido.",
    "cause": "O utilizador não acrescentou o motivo ou desconhece a coluna correspondente nas linhas da encomenda.",
    "solution": "Preencher o campo Motivo Não Fornecimento nas linhas de encomenda de venda afectadas.",
    "procedure": "1. Abrir a Encomenda de Venda com entregas parciais.\n2. Seleccionar a linha onde faltou fornecer o produto.\n3. Personalizar a vista para mostrar a coluna Motivo Não Fornecimento.\n4. Seleccionar o motivo adequado (ex.: Falta de Stock, Produto Descontinuado).\n5. Comunicar o motivo ao cliente através de relatório ou mensagem, se necessário.",
    "steps": [
      "Abrir a Encomenda de Venda com entregas parciais.",
      "Seleccionar a linha onde faltou fornecer o produto.",
      "Personalizar a vista para mostrar a coluna Motivo Não Fornecimento.",
      "Seleccionar o motivo adequado (ex.: Falta de Stock, Produto Descontinuado).",
      "Comunicar o motivo ao cliente através de relatório ou mensagem, se necessário."
    ],
    "validation": "O campo Motivo Não Fornecimento está preenchido nas linhas com falta de entrega.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário emitir uma fatura de pré-pagamento ou faturação antecipada antes da entrega dos produtos, de acordo com o contrato com o cliente.",
    "diagnosis": "Foi criada uma encomenda de venda com percentagem ou montante de pré-pagamento definido, mas ainda não foi emitida a fatura de adiantamento.",
    "cause": "Desconhecimento do processo de emissão da fatura de pré-pagamento no Business Central.",
    "solution": "Utilizar a funcionalidade Faturação Antecipada para gerar a fatura de pré-pagamento baseada numa encomenda.",
    "procedure": "1. Criar ou abrir uma Encomenda de Venda.\n2. No separador Faturação, preencher o campo Percentagem Pré-pagamento ou definir uma linha com Tipo de Linha = Pré-pagamento e o valor pretendido.\n3. Confirmar que o cliente e o produto estão configurados para pré-pagamentos.\n4. No separador Processo, clicar em Fatura Antecipada (ou Fatura de Pré-pagamento).\n5. Seleccionar Imprimir Fatura ou Enviar por Email se necessário.\n6. Registar a fatura; o sistema cria um documento de venda com tipo Fatura de Pré-pagamento.\n7. Após receber o pagamento, registar o recibo de pré-pagamento nos movimentos de clientes.",
    "steps": [
      "Criar ou abrir uma Encomenda de Venda.",
      "No separador Faturação, preencher o campo Percentagem Pré-pagamento ou definir uma linha com Tipo de Linha = Pré-pagamento e o valor pretendido.",
      "Confirmar que o cliente e o produto estão configurados para pré-pagamentos.",
      "No separador Processo, clicar em Fatura Antecipada (ou Fatura de Pré-pagamento).",
      "Seleccionar Imprimir Fatura ou Enviar por Email se necessário.",
      "Registar a fatura; o sistema cria um documento de venda com tipo Fatura de Pré-pagamento.",
      "Após receber o pagamento, registar o recibo de pré-pagamento nos movimentos de clientes."
    ],
    "validation": "A fatura de pré-pagamento aparece no histórico de vendas e o saldo do cliente reflecte o adiantamento recebido.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador necessita saber quanto foi faturado antecipadamente e qual o saldo ainda por faturar na encomenda ou por cliente.",
    "diagnosis": "Existem faturas de pré-pagamento registadas, mas não é claro qual o montante total de adiantamentos por encomenda ou cliente.",
    "cause": "Falta de consulta aos movimentos de pré-pagamento ou desconhecimento do relatório adequado.",
    "solution": "Utilizar a página Movimentos de Pré-pagamento ou relatórios de faturação para analisar o saldo de pré-pagamento.",
    "procedure": "1. Na Encomenda de Venda, seleccionar Relatórios → Pré-pagamentos para ver o detalhe de adiantamentos aplicados e saldo por encomenda.\n2. Em alternativa, pesquisar por Movimentos Clientes e aplicar filtro em Tipo Documento = Fatura de Pré-pagamento.\n3. Consultar os campos Montante Pago e Saldo para cada documento.\n4. Para visão global, utilizar o relatório Pré-pagamentos Pendentes que lista clientes com saldos de pré-pagamento.\n5. Exportar para Excel para análise adicional, se necessário.",
    "steps": [
      "Na Encomenda de Venda, seleccionar Relatórios → Pré-pagamentos para ver o detalhe de adiantamentos aplicados e saldo por encomenda.",
      "Em alternativa, pesquisar por Movimentos Clientes e aplicar filtro em Tipo Documento = Fatura de Pré-pagamento.",
      "Consultar os campos Montante Pago e Saldo para cada documento.",
      "Para visão global, utilizar o relatório Pré-pagamentos Pendentes que lista clientes com saldos de pré-pagamento.",
      "Exportar para Excel para análise adicional, se necessário."
    ],
    "validation": "O utilizador identifica facilmente o valor total adiantado e o saldo por faturar.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Foi emitida uma fatura de pré-pagamento errada ou cancelada e precisa ser anulada para efeitos fiscais e de contabilidade.",
    "diagnosis": "A fatura de pré-pagamento está registada e afecta os saldos de cliente; é necessário revertê-la.",
    "cause": "Erro na emissão do documento de pré-pagamento ou cancelamento do contrato antes da entrega.",
    "solution": "Emitir uma Nota de Crédito de Pré-pagamento para anular a fatura antecipada e reconciliar com o cliente.",
    "procedure": "1. Pesquisar por Movimentos Clientes ou abrir a fatura de pré-pagamento em questão.\n2. Seleccionar Funções → Criar Nota de Crédito Corretiva (ou Anular) sobre a fatura de pré-pagamento.\n3. O sistema cria uma nota de crédito de pré-pagamento com montante igual à fatura.\n4. Registar a nota de crédito.\n5. Aplicar a nota de crédito à fatura de pré-pagamento nos movimentos de cliente para fechar o saldo.\n6. Confirmar que o saldo da fatura e a conta do cliente foram ajustados.",
    "steps": [
      "Pesquisar por Movimentos Clientes ou abrir a fatura de pré-pagamento em questão.",
      "Seleccionar Funções → Criar Nota de Crédito Corretiva (ou Anular) sobre a fatura de pré-pagamento.",
      "O sistema cria uma nota de crédito de pré-pagamento com montante igual à fatura.",
      "Registar a nota de crédito.",
      "Aplicar a nota de crédito à fatura de pré-pagamento nos movimentos de cliente para fechar o saldo.",
      "Confirmar que o saldo da fatura e a conta do cliente foram ajustados."
    ],
    "validation": "A fatura de pré-pagamento deixa de impactar a conta corrente e o saldo do cliente reflecte a anulação.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "A empresa necessita prever vendas futuras para planear produção e inventário.",
    "diagnosis": "Não existe um registo sistemático de previsões ou a funcionalidade não é utilizada.",
    "cause": "Desconhecimento da funcionalidade de Previsão de Vendas ou Previsão de Necessidades no Business Central.",
    "solution": "Utilizar as páginas de previsão de vendas para inserir volumes esperados por período e analisar tendências.",
    "procedure": "1. Pesquisar por Previsão de Vendas e abrir a página.\n2. Definir a dimensão temporal (mensal, trimestral) e, se aplicável, as dimensões analíticas (cliente, produto, localização).\n3. Para cada período, inserir as quantidades previstas de venda para cada produto ou grupo de produtos.\n4. Utilizar a função Cópia Previsão para duplicar previsões de períodos anteriores e ajustar conforme necessário.\n5. Validar as previsões comparando com dados históricos através do relatório de Desvio de Previsão.\n6. Integrar a previsão no planeamento de produção ou aprovisionamento, usando a Folha de Requisição ou MRP.",
    "steps": [
      "Pesquisar por Previsão de Vendas e abrir a página.",
      "Definir a dimensão temporal (mensal, trimestral) e, se aplicável, as dimensões analíticas (cliente, produto, localização).",
      "Para cada período, inserir as quantidades previstas de venda para cada produto ou grupo de produtos.",
      "Utilizar a função Cópia Previsão para duplicar previsões de períodos anteriores e ajustar conforme necessário.",
      "Validar as previsões comparando com dados históricos através do relatório de Desvio de Previsão.",
      "Integrar a previsão no planeamento de produção ou aprovisionamento, usando a Folha de Requisição ou MRP."
    ],
    "validation": "As quantidades previstas ficam registadas e influenciam os cálculos de planeamento para produção e compras.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Foi registada uma fatura de venda com erros (ex.: produto, quantidade, preço) e é necessário corrigi-la sem anular totalmente a transação.",
    "diagnosis": "A fatura de venda já está registada, mas ainda não foi comunicada às autoridades fiscais ou não tem movimentos de pagamento associados.",
    "cause": "Erro no preenchimento inicial ou alterações acordadas com o cliente após a emissão.",
    "solution": "Utilizar a funcionalidade Corrigir Fatura de Venda para gerar automaticamente uma nota de crédito e uma nova fatura correcta.",
    "procedure": "1. Aceder à fatura de venda registada (via Faturas de Venda Registadas).\n2. No separador Processo, clicar em Corrigir ou Criar Nota de Crédito Corretiva.\n3. O sistema cria automaticamente uma nota de crédito para anular a fatura original e uma nova encomenda de venda com os mesmos dados.\n4. Rever a nova encomenda: corrigir campos como produto, quantidade ou preço.\n5. Registar a nova encomenda para gerar a fatura correcta.\n6. Aplicar a nota de crédito à fatura original nos movimentos de clientes para fechar o saldo.",
    "steps": [
      "Aceder à fatura de venda registada (via Faturas de Venda Registadas).",
      "No separador Processo, clicar em Corrigir ou Criar Nota de Crédito Corretiva.",
      "O sistema cria automaticamente uma nota de crédito para anular a fatura original e uma nova encomenda de venda com os mesmos dados.",
      "Rever a nova encomenda: corrigir campos como produto, quantidade ou preço.",
      "Registar a nova encomenda para gerar a fatura correcta.",
      "Aplicar a nota de crédito à fatura original nos movimentos de clientes para fechar o saldo."
    ],
    "validation": "A fatura original fica anulada, a nova fatura reflecte os dados correctos e o saldo do cliente está ajustado.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador pretende saber quando pode utilizar a funcionalidade de correcção em vez de notas de crédito independentes.",
    "diagnosis": "Há dúvidas quanto às restrições legais e de sistema para corrigir faturas registadas.",
    "cause": "Confusão entre correcção imediata (antes da comunicação fiscal) e procedimentos de anulação após comunicação.",
    "solution": "Aplicar a correcção apenas se a fatura não foi comunicada ao SAF-T/AT e não possui pagamentos ou notas de crédito associadas.",
    "procedure": "1. Verificar se a fatura foi comunicada à Autoridade Tributária (consultar o campo Status Comunicação na fatura).\n2. Confirmar se não existem pagamentos registados ou notas de crédito já aplicadas.\n3. Se ambos os requisitos forem satisfeitos, proceder à correcção conforme descrito na FAQ anterior.\n4. Caso contrário, emitir uma nota de crédito separada para anular a fatura e criar uma nova fatura manual.",
    "steps": [
      "Verificar se a fatura foi comunicada à Autoridade Tributária (consultar o campo Status Comunicação na fatura).",
      "Confirmar se não existem pagamentos registados ou notas de crédito já aplicadas.",
      "Se ambos os requisitos forem satisfeitos, proceder à correcção conforme descrito na FAQ anterior.",
      "Caso contrário, emitir uma nota de crédito separada para anular a fatura e criar uma nova fatura manual."
    ],
    "validation": "A correcção é efetuada apenas em faturas elegíveis e respeita as obrigações legais.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Após envio de uma proposta de venda (cotação) a um cliente, a empresa recebe aceitação parcial ou total e precisa converter a proposta numa encomenda.",
    "diagnosis": "A proposta foi criada e enviada a partir de uma oportunidade ou directamente, mas ainda não foi adjudicada.",
    "cause": "O utilizador não sabe como converter a proposta numa encomenda ou adjudicar apenas linhas específicas.",
    "solution": "Utilizar a função Adjudicar Proposta para criar uma encomenda de venda a partir da proposta com as linhas aceites.",
    "procedure": "1. Aceder à Proposta de Venda (lista de propostas).\n2. Seleccionar a proposta pretendida.\n3. No separador Processo, clicar em Converter em Encomenda ou Adjudicar.\n4. Se necessário, seleccionar apenas as linhas a adjudicar (pode marcar/desmarcar linhas).\n5. Confirmar; o sistema cria uma nova encomenda de venda com o cliente e produtos seleccionados.\n6. Revisar a encomenda e completar dados adicionais (datas, local de envio).\n7. Proceder ao registo ou aprovação conforme workflow.",
    "steps": [
      "Aceder à Proposta de Venda (lista de propostas).",
      "Seleccionar a proposta pretendida.",
      "No separador Processo, clicar em Converter em Encomenda ou Adjudicar.",
      "Se necessário, seleccionar apenas as linhas a adjudicar (pode marcar/desmarcar linhas).",
      "Confirmar; o sistema cria uma nova encomenda de venda com o cliente e produtos seleccionados.",
      "Revisar a encomenda e completar dados adicionais (datas, local de envio).",
      "Proceder ao registo ou aprovação conforme workflow."
    ],
    "validation": "Uma encomenda de venda é criada e a proposta original fica registada como Adjudicada ou Fechada.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "A empresa utiliza Encomendas Abertas de Venda para contratos de fornecimento em que o cliente solicita quantidades gradualmente e é necessário gerir entregas parciais.",
    "diagnosis": "É necessário criar uma encomenda aberta, indicar o total contratado e extrair encomendas parciais com base nas necessidades do cliente.",
    "cause": "Os utilizadores não estão familiarizados com o processo de criação e gestão de encomendas abertas.",
    "solution": "Criar uma encomenda aberta de venda e utilizar a funcionalidade Criar Encomenda para gerar encomendas de venda parciais conforme o consumo.",
    "procedure": "1. Pesquisar por Encomendas Abertas de Venda e clicar em Novo.\n2. Preencher o cabeçalho com Cliente, Data de Início, Data de Fim e outras informações.\n3. Na secção Linhas, introduzir os produtos e as quantidades totais contratadas.\n4. Registar a encomenda aberta.\n5. Quando o cliente solicitar uma entrega parcial, abrir a encomenda aberta e seleccionar Criar Encomenda.\n6. Definir as quantidades a enviar e confirmar; o sistema cria uma nova Encomenda de Venda com essas quantidades.\n7. Repetir o processo até esgotar as quantidades contratadas.\n8. Encerrar a encomenda aberta quando todas as quantidades tiverem sido satisfeitas.",
    "steps": [
      "Pesquisar por Encomendas Abertas de Venda e clicar em Novo.",
      "Preencher o cabeçalho com Cliente, Data de Início, Data de Fim e outras informações.",
      "Na secção Linhas, introduzir os produtos e as quantidades totais contratadas.",
      "Registar a encomenda aberta.",
      "Quando o cliente solicitar uma entrega parcial, abrir a encomenda aberta e seleccionar Criar Encomenda.",
      "Definir as quantidades a enviar e confirmar; o sistema cria uma nova Encomenda de Venda com essas quantidades.",
      "Repetir o processo até esgotar as quantidades contratadas.",
      "Encerrar a encomenda aberta quando todas as quantidades tiverem sido satisfeitas."
    ],
    "validation": "As encomendas abertas permitem rastrear o total contratado e criar múltiplas encomendas parciais de forma controlada.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador precisa registar uma nova encomenda de venda para um cliente, incluindo dados de envio, produtos, quantidades e preços.",
    "diagnosis": "Não existe encomenda para o pedido e o utilizador necessita seguir todos os passos para criação.",
    "cause": "Primeira utilização ou processo pontual que requer reforço de procedimentos.",
    "solution": "Criar uma Encomenda de Venda na lista de encomendas, preencher o cabeçalho e as linhas com os detalhes necessários e validar.",
    "procedure": "1. Pesquisar por Encomendas de Venda e clicar em Novo.\n2. Preencher o campo Cliente Nº com o número do cliente; o sistema preenche dados padrão (endereço, condições de pagamento).\n3. Definir a Data de Registo, Data de Envio, Localização e outras datas relevantes.\n4. No separador Linhas, para cada produto: seleccionar Tipo = Produto, indicar Nº Produto, Quantidade e confirmar o preço sugerido.\n5. Se necessário, ajustar preços ou descontos manualmente, respeitando as políticas de margem e desconto máximos.\n6. Adicionar linhas de comentário ou encargos adicionais, se aplicável.\n7. Verificar os campos totais (montante, IVA) e corrigir eventuais mensagens de erro.\n8. a encomenda; se existir workflow, enviar para aprovação ou libertar para processamento logístico.",
    "steps": [
      "Pesquisar por Encomendas de Venda e clicar em Novo.",
      "Preencher o campo Cliente Nº com o número do cliente; o sistema preenche dados padrão (endereço, condições de pagamento).",
      "Definir a Data de Registo, Data de Envio, Localização e outras datas relevantes.",
      "No separador Linhas, para cada produto: seleccionar Tipo = Produto, indicar Nº Produto, Quantidade e confirmar o preço sugerido.",
      "Se necessário, ajustar preços ou descontos manualmente, respeitando as políticas de margem e desconto máximos.",
      "Adicionar linhas de comentário ou encargos adicionais, se aplicável.",
      "Verificar os campos totais (montante, IVA) e corrigir eventuais mensagens de erro.",
      "a encomenda; se existir workflow, enviar para aprovação ou libertar para processamento logístico."
    ],
    "validation": "A encomenda de venda aparece na lista com estado Aberta ou Liberada, pronta para envio ou faturação.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Algumas encomendas de venda são processadas por operadores logísticos externos e requerem aprovação adicional antes do envio.",
    "diagnosis": "O workflow de aprovação para logística externa não foi accionado ou o utilizador desconhece o procedimento.",
    "cause": "Ausência de configuração de fluxos de aprovação para encomendas com Localização de logística externa ou falta de treino.",
    "solution": "Configurar e utilizar o workflow de aprovação específico e enviar a encomenda para aprovação antes de entregar ao operador externo.",
    "procedure": "1. Ao criar a encomenda de venda, seleccionar uma Localização ou Fornecedor de Logística que indique processamento externo.\n2. Preencher a encomenda normalmente.\n3. No separador Pedido, clicar em Enviar Pedido de Aprovação; a encomenda muda para Pendente de Aprovação.\n4. O gestor de logística ou aprovador externo recebe uma notificação e analisa a encomenda.\n5. Após aprovação, a encomenda é marcada como Aprovada e é libertada para o parceiro logístico (via EDI ou exportação).\n6. Acompanhar o estado na página Solicitações para Aprovar e proceder ao envio físico após aprovação.",
    "steps": [
      "Ao criar a encomenda de venda, seleccionar uma Localização ou Fornecedor de Logística que indique processamento externo.",
      "Preencher a encomenda normalmente.",
      "No separador Pedido, clicar em Enviar Pedido de Aprovação; a encomenda muda para Pendente de Aprovação.",
      "O gestor de logística ou aprovador externo recebe uma notificação e analisa a encomenda.",
      "Após aprovação, a encomenda é marcada como Aprovada e é libertada para o parceiro logístico (via EDI ou exportação).",
      "Acompanhar o estado na página Solicitações para Aprovar e proceder ao envio físico após aprovação."
    ],
    "validation": "A encomenda é aprovada e enviada ao operador logístico externo apenas após passar no workflow.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Existem acordos específicos com instituições de solidariedade (lares) para fornecimento de produtos, e a faturação obedece a regras próprias.",
    "diagnosis": "O processo normal de faturação não contempla a diferenciação de itens e preços para lares.",
    "cause": "Falta de utilização do módulo ou da configuração de Tipo de Cliente = Lar e respectivas tabelas de preços.",
    "solution": "Configurar clientes como Lar, utilizar listas de preços específicas e emitir faturas periodicamente segundo as quantidades fornecidas.",
    "procedure": "1. Criar ou editar a ficha do cliente e definir o campo Tipo Cliente para Lar.\n2. Associar ao cliente uma lista de preços específica para lares (com preços e descontos ajustados).\n3. Criar encomendas de venda normalmente, indicando a instituição como cliente.\n4. Na factura, os preços aplicados são automaticamente retirados da lista de preços de lares.\n5. Se existirem contratos de fornecimento periódico, configurar Encomendas Abertas ou Acordos de Serviço para gerar faturas periodicamente.\n6. Registar as faturas de acordo com as regras de pagamento especiais acordadas com cada instituição.",
    "steps": [
      "Criar ou editar a ficha do cliente e definir o campo Tipo Cliente para Lar.",
      "Associar ao cliente uma lista de preços específica para lares (com preços e descontos ajustados).",
      "Criar encomendas de venda normalmente, indicando a instituição como cliente.",
      "Na factura, os preços aplicados são automaticamente retirados da lista de preços de lares.",
      "Se existirem contratos de fornecimento periódico, configurar Encomendas Abertas ou Acordos de Serviço para gerar faturas periodicamente.",
      "Registar as faturas de acordo com as regras de pagamento especiais acordadas com cada instituição."
    ],
    "validation": "As faturas emitidas para lares reflectem os preços e condições específicas acordadas.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "A empresa necessita enviar amostras de produtos a clientes, contabilizando o custo e controlando o stock.",
    "diagnosis": "Não existe um documento dedicado ou método padronizado para registar amostras; as saídas são feitas manualmente, sem rastreabilidade.",
    "cause": "Desconhecimento da funcionalidade de Encomenda de Amostras ou da configuração de Tipo Documento = Amostra.",
    "solution": "Criar uma encomenda de venda específica de amostras, com preços a zero, e registar a saída do stock.",
    ...
    "steps": [
      "Pesquisar por Encomendas de Venda e clicar em Novo.",
      "Seleccionar o Cliente que vai receber a amostra (ou criar um cliente genérico Amostras).",
      "Na linha, seleccionar Tipo = Produto e indicar o Nº Produto.",
      "Introduzir a Quantidade de amostras.",
      "No campo Tipo Documento Saída, seleccionar Amostra; o preço unitário é automaticamente zero.",
      "Registar a encomenda; o stock é diminuído e o custo é registado em conta de marketing ou promoções.",
      "Imprimir ou enviar o documento ao cliente, se necessário."
    ],
    "validation": "O stock é actualizado e a entrega da amostra fica registada com preço zero.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "A empresa oferece produtos a clientes (brindes) e precisa registá-los sem facturar o cliente, mas mantendo a movimentação de stock e registo contabilístico.",
    "diagnosis": "Ainda não existe um procedimento para diferenciar ofertas de vendas normais ou amostras.",
    "cause": "Falta de configuração de tipo de documento Oferta ou de um cliente específico para ofertas.",
    "solution": "Criar uma encomenda de venda de tipo Oferta para registar os produtos oferecidos a custo zero e imputar o valor ao centro de marketing.",
    "procedure": "1. Criar um cliente específico Ofertas ou utilizar o cliente real.\n2. Iniciar uma nova Encomenda de Venda.\n3. No cabeçalho ou nas configurações, definir Tipo Documento Saída = Oferta.\n4. Inserir as linhas de produto e quantidades; o preço unitário é automaticamente zero (pode ser necessário configurar uma lista de preços de ofertas).\n5. Verificar que a conta contabilística da linha corresponde ao centro de custo de marketing.\n6. Registar a encomenda.",
    "steps": [
      "Criar um cliente específico Ofertas ou utilizar o cliente real.",
      "Iniciar uma nova Encomenda de Venda.",
      "No cabeçalho ou nas configurações, definir Tipo Documento Saída = Oferta.",
      "Inserir as linhas de produto e quantidades; o preço unitário é automaticamente zero (pode ser necessário configurar uma lista de preços de ofertas).",
      "Verificar que a conta contabilística da linha corresponde ao centro de custo de marketing.",
      "Registar a encomenda."
    ],
    "validation": "A oferta é registada, o stock é reduzido e o custo é imputado à conta adequada.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Necessidade de emprestar produtos a clientes para demonstração temporária, com controlo de devolução e custo associado.",
    "diagnosis": "O processo não está formalizado e pode levar a perda de inventário ou a ausência de follow-up de devoluções.",
    "cause": "Não utilização de um documento específico de demonstração e de um registro de saída e retorno.",
    "solution": "Criar um documento de Saída de Demonstração que regista a entrega e posterior devolução dos produtos.",
    "procedure": "1. Pesquisar por Demonstrações a Clientes (ou utilizar Documento de Transferência adaptado).\n2. Criar um novo documento indicando o Cliente e a Data de Saída.\n3. Adicionar as linhas de produto a demonstrar e as quantidades.\n4. Registar a saída; o stock é transferido para uma localização temporária de demonstrações.\n5. Na devolução, abrir o mesmo documento e registar a Entrada de Demonstração, indicando as quantidades devolvidas.\n6. Validar que o stock regressa à localização original.",
    "steps": [
      "Pesquisar por Demonstrações a Clientes (ou utilizar Documento de Transferência adaptado).",
      "Criar um novo documento indicando o Cliente e a Data de Saída.",
      "Adicionar as linhas de produto a demonstrar e as quantidades.",
      "Registar a saída; o stock é transferido para uma localização temporária de demonstrações.",
      "Na devolução, abrir o mesmo documento e registar a Entrada de Demonstração, indicando as quantidades devolvidas.",
      "Validar que o stock regressa à localização original."
    ],
    "validation": "As demonstrações são rastreadas e o stock é reposto quando os produtos são devolvidos.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário enviar produtos para feiras ou eventos para demonstração, com controlo de stock e devoluções.",
    "diagnosis": "Não existe um processo formal de registo, levando a inconsistências de inventário após eventos.",
    "cause": "Ausência de documentos de transferência dedicados a eventos e de controlo de inventário temporário.",
    "solution": "Utilizar a funcionalidade de Transferência entre Localizações para eventos e registar a devolução posterior.",
    "procedure": "1. Criar uma Localização específica para cada evento (ex.: EVENTO_FEIRA).\n2. Utilizar uma Ordem de Transferência para mover o stock da localização principal para a localização do evento.\n3. No documento, indicar as linhas dos produtos e quantidades.\n4. Processar a ordem de transferência para registar a saída.\n5. Após o evento, criar outra ordem de transferência inversa para devolver os produtos não consumidos à localização original.\n6. Se alguns produtos forem consumidos ou vendidos, registar como Amostras, Ofertas ou Vendas conforme apropriado.",
    "steps": [
      "Criar uma Localização específica para cada evento (ex.: EVENTO_FEIRA).",
      "Utilizar uma Ordem de Transferência para mover o stock da localização principal para a localização do evento.",
      "No documento, indicar as linhas dos produtos e quantidades.",
      "Processar a ordem de transferência para registar a saída.",
      "Após o evento, criar outra ordem de transferência inversa para devolver os produtos não consumidos à localização original.",
      "Se alguns produtos forem consumidos ou vendidos, registar como Amostras, Ofertas ou Vendas conforme apropriado."
    ],
    "validation": "O stock em eventos é controlado e reconciliado após a devolução.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Alguns produtos são consumidos internamente pela empresa (por exemplo, para testes, formação ou uso interno) e é necessário dar saída de stock de forma controlada.",
    "diagnosis": "O consumo interno não está documentado, podendo gerar discrepâncias de inventário e custos não atribuídos.",
    "cause": "Desconhecimento do documento Consumo Interno ou falta de uso da funcionalidade de diário de produtos.",
    "solution": "Registar consumos internos através de diários de consumo ou encomendas específicas, garantindo a imputação de custos ao centro apropriado.",
    "procedure": "1. Pesquisar por Diário de Consumo Interno (ou Diário de Saídas).\n2. Criar uma nova linha para cada produto consumido.\n3. Indicar a Localização, Nº Produto, Quantidade e, se necessário, a Dimensão ou Centro de Custo que deve suportar o custo.\n4. Verificar que o preço unitário corresponde ao custo do produto (campo Custo Unitário).\n5. Registar o diário para dar baixa no inventário e gerar o movimento contabilístico.\n6. Opcionalmente, imprimir um relatório interno de consumo para aprovação.",
    "steps": [
      "Pesquisar por Diário de Consumo Interno (ou Diário de Saídas).",
      "Criar uma nova linha para cada produto consumido.",
      "Indicar a Localização, Nº Produto, Quantidade e, se necessário, a Dimensão ou Centro de Custo que deve suportar o custo.",
      "Verificar que o preço unitário corresponde ao custo do produto (campo Custo Unitário).",
      "Registar o diário para dar baixa no inventário e gerar o movimento contabilístico.",
      "Opcionalmente, imprimir um relatório interno de consumo para aprovação."
    ],
    "validation": "Os consumos internos são reflectidos no inventário e as contas de despesa são actualizadas.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "As vendas de medicamentos psicotrópicos requerem documentação adicional e registos específicos devido a legislação restritiva.",
    "diagnosis": "É necessário garantir que a transacção cumpre os requisitos legais, incluindo prescrição médica e registo separado.",
    "cause": "Falta de funcionalidades activadas para artigos psicotrópicos e ausência de registo de prescrição ou autorização.",
    "solution": "Configurar os produtos como Psicotrópicos, registar a prescrição do médico e utilizar documentos específicos que reportem às autoridades.",
    "procedure": "1. Na ficha do produto, definir o campo Categoria Terapêutica para Psicotrópico e activar qualquer opção de controlo adicional (ex.: Lote obrigatório).\n2. Ao criar uma encomenda de venda, exigir o campo Nº de Prescrição ou documento legal equivalente.\n3. Inserir as linhas do produto psicotrópico, quantidade e preço conforme regulamentado.\n4. Registar a encomenda e emitir a fatura; o sistema gera um relatório adicional para comunicação às autoridades de saúde.\n5. Arquivar cópia da prescrição e manter registo por período legal obrigatório.",
    "steps": [
      "Na ficha do produto, definir o campo Categoria Terapêutica para Psicotrópico e activar qualquer opção de controlo adicional (ex.: Lote obrigatório).",
      "Ao criar uma encomenda de venda, exigir o campo Nº de Prescrição ou documento legal equivalente.",
      "Inserir as linhas do produto psicotrópico, quantidade e preço conforme regulamentado.",
      "Registar a encomenda e emitir a fatura; o sistema gera um relatório adicional para comunicação às autoridades de saúde.",
      "Arquivar cópia da prescrição e manter registo por período legal obrigatório."
    ],
    "validation": "A venda do psicotrópico é registada com os documentos legais necessários e comunicada às autoridades.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "A exportação de antibióticos para países fora da UE exige um certificado ou declaração confirmando que o produto cumpre normas e que é destinado à exportação.",
    "diagnosis": "Sem uma declaração de antibióticos, a carga pode ser retida na alfândega ou recusada pelas autoridades do país de destino.",
    "cause": "Desconhecimento do formulário a utilizar ou dos campos necessários para a declaração.",
    "solution": "Gerar a declaração de antibióticos através de um modelo oficial e preencher os dados do produto, lote, quantidades e destino.",
    "procedure": "1. Pesquisar pelo relatório Declaração de Antibióticos no Business Central (ou aceder a documentos externos fornecidos pela autoridade sanitária).\n2. Introduzir os dados da exportação: Cliente, País de Destino, Data de Expedição.\n3. Seleccionar as linhas de produtos antibióticos, indicando Nº Lote, Quantidade e Data de Fabrico.\n4. Gerar o relatório/declaração e imprimir.\n5. Validar a declaração com o responsável técnico (farmacêutico) e assinar.\n6. Enviar a declaração juntamente com a documentação de exportação.",
    "steps": [
      "Pesquisar pelo relatório Declaração de Antibióticos no Business Central (ou aceder a documentos externos fornecidos pela autoridade sanitária).",
      "Introduzir os dados da exportação: Cliente, País de Destino, Data de Expedição.",
      "Seleccionar as linhas de produtos antibióticos, indicando Nº Lote, Quantidade e Data de Fabrico.",
      "Gerar o relatório/declaração e imprimir.",
      "Validar a declaração com o responsável técnico (farmacêutico) e assinar.",
      "Enviar a declaração juntamente com a documentação de exportação."
    ],
    "validation": "A declaração de antibióticos é emitida, assinada e entregue às autoridades aduaneiras.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Uma fatura de venda precisa ser anulada por completo devido a erro ou devolução total de produtos.",
    "diagnosis": "A fatura está registada e já foi comunicada; é necessário emitir uma nota de crédito interna para anular a dívida do cliente.",
    "cause": "Erro na fatura, devolução total da mercadoria ou cancelamento do contrato de venda.",
    "solution": "Gerar uma nota de crédito de venda com referência à fatura original e aplicar aos movimentos do cliente.",
    "procedure": "1. Aceder à lista Faturas de Venda Registadas e seleccionar a fatura a anular.\n2. Clicar em Criar Nota de Crédito (ou Anular), confirmando que deseja anular a fatura.\n3. O sistema abre uma nota de crédito com as linhas e montantes da fatura original.\n4. Verificar as linhas, ajustar se necessário (por exemplo, quantidades devolvidas).\n5. Registar a nota de crédito; o sistema emite o documento e actualiza os saldos.\n6. Aplicar a nota de crédito à fatura original nos movimentos de clientes para fechar a dívida.",
    "steps": [
      "Aceder à lista Faturas de Venda Registadas e seleccionar a fatura a anular.",
      "Clicar em Criar Nota de Crédito (ou Anular), confirmando que deseja anular a fatura.",
      "O sistema abre uma nota de crédito com as linhas e montantes da fatura original.",
      "Verificar as linhas, ajustar se necessário (por exemplo, quantidades devolvidas).",
      "Registar a nota de crédito; o sistema emite o documento e actualiza os saldos.",
      "Aplicar a nota de crédito à fatura original nos movimentos de clientes para fechar a dívida."
    ],
    "validation": "A fatura original fica saldada e os relatórios mostram a nota de crédito correspondente.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Uma nota de crédito emitida anteriormente estava errada e precisa ser anulada, emitindo-se uma fatura para restabelecer a venda original.",
    "diagnosis": "O cliente devolveu a mercadoria parcialmente ou foi emitida uma nota de crédito indevida; é necessário restituir a dívida.",
    "cause": "Erro no valor ou na quantidade da nota de crédito ou reversão de um cancelamento.",
    "solution": "Emitir uma nova fatura com os itens correctos e aplicar contra a nota de crédito para anular o seu efeito.",
    "procedure": "1. Abrir a Nota de Crédito de Venda Registada que pretende anular.\n2. Seleccionar Criar Documento de Reversão ou Gerar Fatura Corretiva.\n3. O sistema cria uma nova Encomenda de Venda com as linhas da nota de crédito; ajustar quantidades ou valores para representar a venda correcta.\n4. Registar a encomenda para emitir a fatura.\n5. Aplicar a fatura gerada à nota de crédito nos movimentos de clientes, de forma a anulá-la.\n6. Verificar o saldo do cliente após a operação.",
    "steps": [
      "Abrir a Nota de Crédito de Venda Registada que pretende anular.",
      "Seleccionar Criar Documento de Reversão ou Gerar Fatura Corretiva.",
      "O sistema cria uma nova Encomenda de Venda com as linhas da nota de crédito; ajustar quantidades ou valores para representar a venda correcta.",
      "Registar a encomenda para emitir a fatura.",
      "Aplicar a fatura gerada à nota de crédito nos movimentos de clientes, de forma a anulá-la.",
      "Verificar o saldo do cliente após a operação."
    ],
    "validation": "A nota de crédito é anulada e substituída por uma fatura correcta.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Encomendas de venda que já tiveram todas as quantidades facturadas permanecem em estado Aberta ou Liberada, causando confusão nos relatórios de carteira de encomendas.",
    "diagnosis": "As encomendas não são encerradas automaticamente após a facturação, pelo que permanecem activas até serem fechadas manualmente.",
    "cause": "Desconhecimento da função Fechar Encomenda ou negligência em encerrar processos concluídos.",
    "solution": "Utilizar a função Fechar Encomenda para mudar o estado para Fechada quando todas as quantidades estiverem facturadas.",
    "procedure": "1. Aceder à Encomenda de Venda que pretende encerrar.\n2. Verificar que a coluna Qtd. Faturada coincide com a Qtd. Encomendada em todas as linhas.\n3. No separador Processo, clicar em Fechar Encomenda.\n4. Confirmar o fecho; o estado passa a Fechada.\n5. A encomenda deixa de aparecer nas listas de pendentes.",
    "steps": [
      "Aceder à Encomenda de Venda que pretende encerrar.",
      "Verificar que a coluna Qtd. Faturada coincide com a Qtd. Encomendada em todas as linhas.",
      "No separador Processo, clicar em Fechar Encomenda.",
      "Confirmar o fecho; o estado passa a Fechada.",
      "A encomenda deixa de aparecer nas listas de pendentes."
    ],
    "validation": "A encomenda desaparece da lista de abertas e figura como Fechada.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário gerar encomendas de venda automaticamente para um parceiro comercial (Alliance) com base em informação de consumo ou stocks.",
    "diagnosis": "O processo manual é demorado e suscetível a erros; existe uma integração que permite a criação automática mas não foi configurada.",
    "cause": "Falta de configuração dos parâmetros de integração ou desconhecimento da funcionalidade.",
    "solution": "Configurar a integração com a Alliance e parametrizar a criação automática de encomendas de venda.",
    "procedure": "1. Confirmar que existe um módulo de integração com a Alliance instalado.\n2. Configurar os parâmetros: Código do Cliente Alliance, Frequência de Criação de Encomendas (diária, semanal), Códigos de Produtos elegíveis e Limites de Stock que disparam encomendas.\n3. Activar a opção de Criação Automática de Encomendas na configuração.\n4. A cada período, o sistema verifica o consumo ou stock e gera automaticamente encomendas de venda com base nos parâmetros definidos.\n5. Revisar as encomendas geradas em Encomendas de Venda, validar e, se necessário, ajustar antes de enviar ao cliente.",
    "steps": [
      "Confirmar que existe um módulo de integração com a Alliance instalado.",
      "Configurar os parâmetros: Código do Cliente Alliance, Frequência de Criação de Encomendas (diária, semanal), Códigos de Produtos elegíveis e Limites de Stock que disparam encomendas.",
      "Activar a opção de Criação Automática de Encomendas na configuração.",
      "A cada período, o sistema verifica o consumo ou stock e gera automaticamente encomendas de venda com base nos parâmetros definidos.",
      "Revisar as encomendas geradas em Encomendas de Venda, validar e, se necessário, ajustar antes de enviar ao cliente."
    ],
    "validation": "Encomendas de venda são criadas automaticamente de acordo com os parâmetros de integração.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário garantir que os preços de venda não ficam abaixo de uma margem de lucro mínima por produto ou família.",
    "diagnosis": "Existem propostas e encomendas que podem ser registadas com margens muito baixas, reduzindo a rentabilidade.",
    "cause": "Falta de configuração das regras de margem mínima no modelo comercial.",
    "solution": "Definir margens mínimas por família de produtos ou categoria no Modelo Comercial para que o sistema valide nas encomendas e propostas.",
    "procedure": "1. Aceder à página Modelo Comercial ou Regras de Preços.\n2. Seleccionar a família ou categoria de produto que pretende configurar.\n3. Inserir a Margem Mínima (percentagem) ou valor absoluto por unidade.\n4. Em propostas de venda e encomendas, o sistema calcula a margem obtida comparando o preço de venda com o custo; se a margem calculada for inferior à definida, será apresentada uma mensagem de aviso ou bloqueio.\n5. O utilizador poderá ajustar o preço ou solicitar aprovação excepcional.",
    "steps": [
      "Aceder à página Modelo Comercial ou Regras de Preços.",
      "Seleccionar a família ou categoria de produto que pretende configurar.",
      "Inserir a Margem Mínima (percentagem) ou valor absoluto por unidade.",
      "Em propostas de venda e encomendas, o sistema calcula a margem obtida comparando o preço de venda com o custo; se a margem calculada for inferior à definida, será apresentada uma mensagem de aviso ou bloqueio.",
      "O utilizador poderá ajustar o preço ou solicitar aprovação excepcional."
    ],
    "validation": "As margens mínimas são aplicadas automaticamente e impedem a criação de transacções com margens inferiores.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Controlar o desconto máximo que cada vendedor pode conceder nos produtos, evitando erosão de margem.",
    "diagnosis": "Os utilizadores aplicam descontos superiores ao limite desejado porque não existe regra de sistema que impeça ou avise.",
    "cause": "Não foram definidas regras de Desconto Máximo por família de produtos ou utilizador.",
    "solution": "Configurar descontos máximos no modelo comercial e associar limites a perfis de utilizador ou grupos de produtos.",
    "procedure": "1. Aceder à página Modelo Comercial ou Regras de Desconto.\n2. Definir para cada família de produtos ou produto individual o campo Desconto Máximo em percentagem.\n3. Associar essas regras aos perfis de vendedores ou grupos de clientes, se aplicável.\n4. Em propostas e encomendas, quando o desconto introduzido exceder o limite, o sistema apresenta aviso ou bloqueio, exigindo aprovação.",
    "steps": [
      "Aceder à página Modelo Comercial ou Regras de Desconto.",
      "Definir para cada família de produtos ou produto individual o campo Desconto Máximo em percentagem.",
      "Associar essas regras aos perfis de vendedores ou grupos de clientes, se aplicável.",
      "Em propostas e encomendas, quando o desconto introduzido exceder o limite, o sistema apresenta aviso ou bloqueio, exigindo aprovação."
    ],
    "validation": "Os descontos aplicados nas vendas respeitam os limites configurados e qualquer excedente gera alertas.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Além do desconto máximo, é necessário limitar a Majoração (aumento) de preços de venda em determinadas circunstâncias.",
    "diagnosis": "Em algumas propostas ou listas, os preços foram majorados em percentagens elevadas, tornando-os pouco competitivos.",
    "cause": "Falta de regra de Majoração Máxima no modelo comercial.",
    "solution": "Definir uma majoração máxima por produto ou família, impedindo que a majoração exceda a percentagem estabelecida.",
    "procedure": "1. No Modelo Comercial, localizar a configuração de Majoração Máxima.\n2. Definir, por produto ou grupo, a percentagem máxima de majoração permitida.\n3. Ao majorar um preço (por exemplo, actualizando listas de preços ou definindo preços de venda especiais), o sistema compara com a majoração máxima; se exceder, emite aviso ou bloqueia a alteração.",
    "steps": [
      "No Modelo Comercial, localizar a configuração de Majoração Máxima.",
      "Definir, por produto ou grupo, a percentagem máxima de majoração permitida.",
      "Ao majorar um preço (por exemplo, actualizando listas de preços ou definindo preços de venda especiais), o sistema compara com a majoração máxima; se exceder, emite aviso ou bloqueia a alteração."
    ],
    "validation": "As majorações de preços mantêm-se dentro dos limites definidos.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário actualizar os preços de venda aplicando uma majoração percentual sobre o custo ou preço base, por exemplo devido a aumento de custos de matéria-prima.",
    "diagnosis": "As listas de preços estão desactualizadas e os utilizadores não sabem como aplicar um coeficiente de majoração a múltiplos produtos.",
    "cause": "Desconhecimento da funcionalidade de actualização em lote de preços com base numa percentagem de majoração.",
    "solution": "Utilizar as funções de Majorar Preços nas listas de preços ou no modelo comercial para actualizar os preços de venda.",
    "procedure": "1. Aceder à página Listas de Preços de Venda ou ao Modelo Comercial dependendo do âmbito da majoração.\n2. Seleccionar a lista a actualizar e clicar em Majorar Preços ou Actualizar Preços.\n3. Introduzir a Percentagem de Majoração (por exemplo, 5% = 0,05).\n4. Definir se a majoração se aplica ao preço base, preço actual ou custo (conforme opções).\n5. Executar a operação; o sistema calcula o novo preço para cada linha, respeitando a majoração máxima configurada.\n6. Rever os valores e, se correcto, activar a lista.",
    "steps": [
      "Aceder à página Listas de Preços de Venda ou ao Modelo Comercial dependendo do âmbito da majoração.",
      "Seleccionar a lista a actualizar e clicar em Majorar Preços ou Actualizar Preços.",
      "Introduzir a Percentagem de Majoração (por exemplo, 5% = 0,05).",
      "Definir se a majoração se aplica ao preço base, preço actual ou custo (conforme opções).",
      "Executar a operação; o sistema calcula o novo preço para cada linha, respeitando a majoração máxima configurada.",
      "Rever os valores e, se correcto, activar a lista."
    ],
    "validation": "Os preços de venda são actualizados segundo a percentagem indicada e estão prontos a ser utilizados.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O Modelo Comercial define margens, descontos e majorações; é necessário validar se todas as regras são coerentes e se os preços propostos cumprem as restrições.",
    "diagnosis": "Após alterações no modelo, é importante verificar se nenhuma regra conflita com outra e se os preços estão correctamente calculados.",
    "cause": "Alterações recentes ou falta de validação periódica do modelo comercial.",
    "solution": "Executar a função de Validação do Modelo Comercial para analisar conflitos e inconsistências.",
    "procedure": "1. Aceder à página Modelo Comercial.\n2. Clicar em Validar Modelo ou Verificar Regras.\n3. O sistema executa uma verificação das margens mínimas, descontos máximos e majorações máximas, identificando eventuais conflitos ou valores fora dos limites.\n4. Ler a lista de mensagens e corrigir as regras que provocam erro (por exemplo, desconto máximo superior à margem mínima).\n5. Repetir a validação até não existirem mensagens críticas.",
    "steps": [
      "Aceder à página Modelo Comercial.",
      "Clicar em Validar Modelo ou Verificar Regras.",
      "O sistema executa uma verificação das margens mínimas, descontos máximos e majorações máximas, identificando eventuais conflitos ou valores fora dos limites.",
      "Ler a lista de mensagens e corrigir as regras que provocam erro (por exemplo, desconto máximo superior à margem mínima).",
      "Repetir a validação até não existirem mensagens críticas."
    ],
    "validation": "O modelo comercial passa na verificação sem conflitos e pode ser aplicado.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "A empresa pretende aplicar markups (acréscimos) de preços específicos por produto, família ou canal, de forma automatizada.",
    "diagnosis": "Os preços são calculados apenas com base em margens e custos, sem considerar um markup adicional que reflicta custos indirectos ou políticas comerciais.",
    "cause": "Não existe configuração de Markups nas listas de preços ou no modelo comercial.",
    "solution": "Criar regras de markup no Business Central e associá-las a produtos, grupos ou canais específicos.",
    "procedure": "1. Aceder à página Regras de Markup ou configurar campos correspondentes no Modelo Comercial.\n2. Clicar em Novo para criar uma regra de markup.\n3. Definir o Tipo de Markup (percentual ou valor fixo), o Âmbito (produto individual, família, canal de venda) e a Percentagem ou Valor.\n4. Em listas de preços ou propostas, os markups são automaticamente aplicados aos preços base, além das margens e majorações.\n5. Revisar os preços resultantes para assegurar que respeitam margens mínimas e majorações máximas.",
    "steps": [
      "Aceder à página Regras de Markup ou configurar campos correspondentes no Modelo Comercial.",
      "Clicar em Novo para criar uma regra de markup.",
      "Definir o Tipo de Markup (percentual ou valor fixo), o Âmbito (produto individual, família, canal de venda) e a Percentagem ou Valor.",
      "Em listas de preços ou propostas, os markups são automaticamente aplicados aos preços base, além das margens e majorações.",
      "Revisar os preços resultantes para assegurar que respeitam margens mínimas e majorações máximas."
    ],
    "validation": "Os markups definidos são aplicados aos preços de venda de forma consistente, complementando as outras regras do modelo comercial.",
    "notes": [],
    "rawMarkdown": "## BC-KB-223 — Como configuro markups no Business Central?\n\n**Categoria:** Pricing & Modelo Comercial / Preços  \n**Disponível para Utilizador:** Não  \n**Disponível para Agente:** Sim  \n\n**Problema**  \nA empresa pretende aplicar markups (acréscimos) de preços específicos por produto, família ou canal, de forma automatizada.\n\n**Diagnóstico**  \nOs preços são calculados apenas com base em margens e custos, sem considerar um markup adicional que reflicta custos indirectos ou políticas comerciais.\n\n**Causa provável**  \nNão existe configuração de Markups nas listas de preços ou no modelo comercial.\n\n**Solução**  \nCriar regras de markup no Business Central e associá-las a produtos, grupos ou canais específicos.\n\n**Como proceder**  \n1. Aceder à página Regras de Markup ou configurar campos correspondentes no Modelo Comercial.\n2. Clicar em Novo para criar uma regra de markup.\n3. Definir o Tipo de Markup (percentual ou valor fixo), o Âmbito (produto individual, família, canal de venda) e a Percentagem ou Valor.\n4. Em listas de preços ou propostas, os markups são automaticamente aplicados aos preços base, além das margens e majorações.\n5. Revisar os preços resultantes para assegurar que respeitam margens mínimas e majorações máximas.\n\n**Validação final**  \nOs markups definidos são aplicados aos preços de venda de forma consistente, complementando as outras regras do modelo comercial."
  },
  {
    "id": "bc-kb-224",
    "code": "BC-KB-224",
    "title": "Como verifico o estado de aprovação de um produto?",
    "category": "Produtos / Aprovações",
    "availableForUser": true,
    "availableForAgent": true,
    "tags": [
      "Produtos",
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário verificar o estado de aprovação de um produto, mas o utilizador não sabe onde consultar se o pedido está pendente, quem é o aprovador ou se o pedido de aprovação já foi criado.",
    "diagnosis": "O estado de aprovação do produto pode ser consultado diretamente na ficha do produto, através dos movimentos de aprovação associados.",
    "cause": "O utilizador desconhece onde consultar os movimentos de aprovação do produto ou não tem acesso aos mesmos, por não ser o utilizador que solicitou a aprovação nem um dos aprovadores.",
    "solution": "Aceder à ficha do produto e consultar a opção **Produto → Aprovações** para verificar se existem movimentos de aprovação pendentes e identificar o aprovador responsável.",
    "procedure": "1. Abrir a ficha do produto em questão.\n2. Na ficha do produto, aceder ao menu **Produto → Aprovações**.\n3. Será aberta a página com os movimentos de aprovação do produto.\n4. Verificar se existem linhas de aprovação associadas ao produto.\n5. Caso existam linhas pendentes, confirmar:\n   - o estado da aprovação;\n   - quem é o aprovador;\n   - se o pedido ainda se encontra por tratar.\n6. Se a página estiver vazia, podem existir duas razões:\n   - **O utilizador não tem acesso aos movimentos de aprovação:** por uma questão de privacidade implementada pela Microsoft, apenas o utilizador que solicitou a aprovação e/ou os aprovadores conseguem visualizar os movimentos de aprovação.\n   - **Ninguém solicitou a aprovação do produto:** neste caso, é necessário pedir aprovação do produto.\n7. Se for necessário pedir aprovação, deve ser contactado o gestor de produto ou o utilizador responsável pela criação do produto.\n8. O pedido de aprovação não deve ser criado pelo próprio aprovador.",
    "steps": [
      "Abrir a ficha do produto em questão.",
      "Na ficha do produto, aceder ao menu **Produto → Aprovações**.",
      "Será aberta a página com os movimentos de aprovação do produto.",
      "Verificar se existem linhas de aprovação associadas ao produto.",
      "Caso existam linhas pendentes, confirmar:",
      "o estado da aprovação;",
      "quem é o aprovador;",
      "se o pedido ainda se encontra por tratar.",
      "Se a página estiver vazia, podem existir duas razões:",
      "**O utilizador não tem acesso aos movimentos de aprovação:** por uma questão de privacidade implementada pela Microsoft, apenas o utilizador que solicitou a aprovação e/ou os aprovadores conseguem visualizar os movimentos de aprovação.",
      "**Ninguém solicitou a aprovação do produto:** neste caso, é necessário pedir aprovação do produto.",
      "Se for necessário pedir aprovação, deve ser contactado o gestor de produto ou o utilizador responsável pela criação do produto.",
      "O pedido de aprovação não deve ser criado pelo próprio aprovador."
    ],
    "validation": "A validação está concluída quando é possível confirmar uma das seguintes situações:\n\n1. Existem movimentos de aprovação e foi identificado o estado do pedido.\n2. Existem linhas pendentes e foi identificado o aprovador responsável.\n3. A página está vazia porque o utilizador não tem acesso aos movimentos.\n4. A página está vazia porque o pedido de aprovação ainda não foi solicitado.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador precisa de acompanhar os pedidos de envio de mercadoria, distinguindo pedidos libertos para armazém, pedidos futuros e pedidos ainda em preparação pela área.",
    "diagnosis": "A informação dos pedidos pendentes está centralizada numa área própria que resume encomendas, amostras, ofertas, demonstrações, consumos internos e outras transferências logísticas.",
    "cause": "Desconhecimento da nova área de consulta e dos indicadores disponíveis para análise dos pedidos pendentes.",
    "solution": "Aceder à área eArmazéns/eEnvios Pendentes e utilizar os indicadores de cabeçalho e detalhe para acompanhar o estado dos pedidos de envio.",
    "procedure": "1. Aceder ao Business Central com um perfil autorizado, como Diretor Área, Comercial, Apoio ao Cliente ou Logística.\n2. No menu, abrir a opção eArmazéns/eEnvios Pendentes.\n3. No cabeçalho, analisar os indicadores disponíveis.\n4. Validar os pedidos libertos para envio com data até hoje.\n5. Validar os pedidos libertos para envio com data a partir de amanhã.\n6. Validar os pedidos em preparação pela área, ainda não libertos.\n7. No indicador de pedidos até hoje, confirmar se existem pedidos já em preparação no armazém, em recolha ou recolhidos.\n8. No detalhe, analisar o documento, cliente, estado, data de envio, armazém, produto, quantidades requisitadas, enviadas e pendentes.\n9. Validar também o inventário disponível na localização indicada e o inventário total do produto.\n10. Usar a informação para priorizar desbloqueios, libertações ou contactos com a logística.",
    "steps": [
      "Aceder ao Business Central com um perfil autorizado, como Diretor Área, Comercial, Apoio ao Cliente ou Logística.",
      "No menu, abrir a opção eArmazéns/eEnvios Pendentes.",
      "No cabeçalho, analisar os indicadores disponíveis.",
      "Validar os pedidos libertos para envio com data até hoje.",
      "Validar os pedidos libertos para envio com data a partir de amanhã.",
      "Validar os pedidos em preparação pela área, ainda não libertos.",
      "No indicador de pedidos até hoje, confirmar se existem pedidos já em preparação no armazém, em recolha ou recolhidos.",
      "No detalhe, analisar o documento, cliente, estado, data de envio, armazém, produto, quantidades requisitadas, enviadas e pendentes.",
      "Validar também o inventário disponível na localização indicada e o inventário total do produto.",
      "Usar a informação para priorizar desbloqueios, libertações ou contactos com a logística."
    ],
    "validation": "1. O utilizador consegue consultar os pedidos pendentes numa única área.\n2. Os pedidos estão agrupados por estado e data de envio.\n3. É possível distinguir pedidos libertos, futuros, em preparação e já em recolha/armazém.\n4. A informação permite acompanhar quantidades pendentes e inventário disponível.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Ao rececionar produto Touch Care no armazém, é necessário ler um DataMatrix com standard específico para recolher automaticamente GTIN e números de série.",
    "diagnosis": "A aplicação de mobilidade de armazéns foi atualizada para reconhecer um novo tipo de DataMatrix associado ao produto Touch Care.",
    "cause": "O DataMatrix do produto Touch Care seguia um standard específico que não era interpretado corretamente pela aplicação antes da alteração.",
    "solution": "Utilizar a aplicação de mobilidade atualizada para efetuar a leitura do DataMatrix durante a entrada, garantindo recolha automática de GTIN e números de série.",
    "procedure": "1. Na receção do produto Touch Care, iniciar o processo normal de entrada na aplicação de mobilidade.\n2. Quando for solicitado o código, ler o DataMatrix do produto/equipamento.\n3. Confirmar que o sistema recolhe automaticamente o GTIN.\n4. Confirmar que os números de série são também recolhidos automaticamente.\n5. Prosseguir com a entrada do produto em armazém.\n6. Validar que a informação de rastreabilidade fica associada ao movimento de entrada.\n7. Em movimentos posteriores de saída ou movimentação interna, confirmar que os equipamentos mantêm rastreabilidade.",
    "steps": [
      "Na receção do produto Touch Care, iniciar o processo normal de entrada na aplicação de mobilidade.",
      "Quando for solicitado o código, ler o DataMatrix do produto/equipamento.",
      "Confirmar que o sistema recolhe automaticamente o GTIN.",
      "Confirmar que os números de série são também recolhidos automaticamente.",
      "Prosseguir com a entrada do produto em armazém.",
      "Validar que a informação de rastreabilidade fica associada ao movimento de entrada.",
      "Em movimentos posteriores de saída ou movimentação interna, confirmar que os equipamentos mantêm rastreabilidade."
    ],
    "validation": "1. O DataMatrix é lido sem erro.\n2. O GTIN e os números de série ficam preenchidos automaticamente.\n3. A rastreabilidade fica garantida na entrada, saída e movimentação interna.",
    "notes": [
      "* A alteração foi motivada pela receção do produto Touch Care no armazém Sta Isabel.",
      "* Fonte: Comunicação TIC i9 de 28/05/2024."
    ],
    "rawMarkdown": "## BC-KB-227 — Ler DataMatrix Touch Care na aplicação de Mobilidade\n\n**Categoria:** Mobilidade / Rastreabilidade  \n**Disponível para Utilizador:** Sim  \n**Disponível para Agente:** Sim\n\n**Problema**  \nAo rececionar produto Touch Care no armazém, é necessário ler um DataMatrix com standard específico para recolher automaticamente GTIN e números de série.\n\n**Diagnóstico**  \nA aplicação de mobilidade de armazéns foi atualizada para reconhecer um novo tipo de DataMatrix associado ao produto Touch Care.\n\n**Causa provável**  \nO DataMatrix do produto Touch Care seguia um standard específico que não era interpretado corretamente pela aplicação antes da alteração.\n\n**Solução**  \nUtilizar a aplicação de mobilidade atualizada para efetuar a leitura do DataMatrix durante a entrada, garantindo recolha automática de GTIN e números de série.\n\n**Como proceder**\n1. Na receção do produto Touch Care, iniciar o processo normal de entrada na aplicação de mobilidade.\n2. Quando for solicitado o código, ler o DataMatrix do produto/equipamento.\n3. Confirmar que o sistema recolhe automaticamente o GTIN.\n4. Confirmar que os números de série são também recolhidos automaticamente.\n5. Prosseguir com a entrada do produto em armazém.\n6. Validar que a informação de rastreabilidade fica associada ao movimento de entrada.\n7. Em movimentos posteriores de saída ou movimentação interna, confirmar que os equipamentos mantêm rastreabilidade.\n\n**Validação final**  \n1. O DataMatrix é lido sem erro.\n2. O GTIN e os números de série ficam preenchidos automaticamente.\n3. A rastreabilidade fica garantida na entrada, saída e movimentação interna.\n\n**Notas**  \n* A alteração foi motivada pela receção do produto Touch Care no armazém Sta Isabel.\n* Fonte: Comunicação TIC i9 de 28/05/2024."
  },
  {
    "id": "bc-kb-228",
    "code": "BC-KB-228",
    "title": "Garantir custo específico da compra na venda em Envios Diretos",
    "category": "Compras / Vendas / Envios Diretos",
    "availableForUser": true,
    "availableForAgent": true,
    "tags": [
      "Compras",
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário garantir que o custo específico de uma compra fica associado à venda quando a mercadoria é enviada diretamente pelo fornecedor ao cliente.",
    "diagnosis": "A funcionalidade de Envios Diretos permite ligar o processo de compra ao processo de venda quando a mercadoria não passa pela logística interna.",
    "cause": "Sem ligação entre compra e venda, pode não ficar assegurado que o custo real da compra é refletido corretamente no processo de venda.",
    "solution": "Utilizar o processo de Envio Direto para associar a encomenda de venda à encomenda de compra e garantir o custo específico, a receção, o envio automático e o rastreio.",
    "procedure": "1. Confirmar que a mercadoria será enviada diretamente pelo fornecedor ao cliente, sem passagem pela logística interna.\n2. Criar ou validar a encomenda de venda com as linhas pretendidas.\n3. Marcar as linhas aplicáveis como envio direto, conforme o processo interno definido.\n4. Gerar ou associar a encomenda de compra correspondente ao fornecedor.\n5. Confirmar que a linha de venda fica ligada à linha de compra.\n6. Registar a receção da compra quando o fornecedor confirmar o envio/entrega.\n7. Confirmar que o sistema gera automaticamente o envio da mercadoria na venda, quando aplicável.\n8. Validar que o rastreio é atribuído automaticamente e que o custo da compra fica refletido na venda.",
    "steps": [
      "Confirmar que a mercadoria será enviada diretamente pelo fornecedor ao cliente, sem passagem pela logística interna.",
      "Criar ou validar a encomenda de venda com as linhas pretendidas.",
      "Marcar as linhas aplicáveis como envio direto, conforme o processo interno definido.",
      "Gerar ou associar a encomenda de compra correspondente ao fornecedor.",
      "Confirmar que a linha de venda fica ligada à linha de compra.",
      "Registar a receção da compra quando o fornecedor confirmar o envio/entrega.",
      "Confirmar que o sistema gera automaticamente o envio da mercadoria na venda, quando aplicável.",
      "Validar que o rastreio é atribuído automaticamente e que o custo da compra fica refletido na venda."
    ],
    "validation": "1. A venda está associada à compra correspondente.\n2. O custo específico da compra é usado no processo de venda.\n3. A receção da compra desencadeia o comportamento esperado no envio da venda.\n4. O rastreio fica associado ao processo.",
    "notes": [
      "* Aplicável quando existe envio direto fornecedor-cliente.",
      "* Fonte: Comunicação TIC i9 de 04/06/2024."
    ],
    "rawMarkdown": "## BC-KB-228 — Garantir custo específico da compra na venda em Envios Diretos\n\n**Categoria:** Compras / Vendas / Envios Diretos  \n**Disponível para Utilizador:** Sim  \n**Disponível para Agente:** Sim\n\n**Problema**  \nÉ necessário garantir que o custo específico de uma compra fica associado à venda quando a mercadoria é enviada diretamente pelo fornecedor ao cliente.\n\n**Diagnóstico**  \nA funcionalidade de Envios Diretos permite ligar o processo de compra ao processo de venda quando a mercadoria não passa pela logística interna.\n\n**Causa provável**  \nSem ligação entre compra e venda, pode não ficar assegurado que o custo real da compra é refletido corretamente no processo de venda.\n\n**Solução**  \nUtilizar o processo de Envio Direto para associar a encomenda de venda à encomenda de compra e garantir o custo específico, a receção, o envio automático e o rastreio.\n\n**Como proceder**\n1. Confirmar que a mercadoria será enviada diretamente pelo fornecedor ao cliente, sem passagem pela logística interna.\n2. Criar ou validar a encomenda de venda com as linhas pretendidas.\n3. Marcar as linhas aplicáveis como envio direto, conforme o processo interno definido.\n4. Gerar ou associar a encomenda de compra correspondente ao fornecedor.\n5. Confirmar que a linha de venda fica ligada à linha de compra.\n6. Registar a receção da compra quando o fornecedor confirmar o envio/entrega.\n7. Confirmar que o sistema gera automaticamente o envio da mercadoria na venda, quando aplicável.\n8. Validar que o rastreio é atribuído automaticamente e que o custo da compra fica refletido na venda.\n\n**Validação final**  \n1. A venda está associada à compra correspondente.\n2. O custo específico da compra é usado no processo de venda.\n3. A receção da compra desencadeia o comportamento esperado no envio da venda.\n4. O rastreio fica associado ao processo.\n\n**Notas**  \n* Aplicável quando existe envio direto fornecedor-cliente.\n* Fonte: Comunicação TIC i9 de 04/06/2024."
  },
  {
    "id": "bc-kb-229",
    "code": "BC-KB-229",
    "title": "Enviar para aprovação documentos de Demonstrações e Ofertas a Clientes",
    "category": "Aprovações / Vendas",
    "availableForUser": true,
    "availableForAgent": true,
    "tags": [
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Documentos de demonstrações e ofertas a clientes necessitam de aprovação antes de avançarem no processo.",
    "diagnosis": "Foram disponibilizados workflows de aprovação para documentos de Demonstrações e Ofertas a Clientes.",
    "cause": "Necessidade de controlo formal sobre documentos que originam movimentos sem venda direta ou com impacto comercial/logístico.",
    "solution": "No documento, utilizar a opção de pedido de aprovação para enviar o documento ao aprovador designado.",
    "procedure": "1. Abrir o documento de Demonstração ou Oferta a Cliente.\n2. Validar se as linhas, cliente, quantidades e demais informação estão corretas.\n3. No topo do documento, selecionar Base.\n4. Selecionar Request Approval.\n5. Clicar em Send Approval Request.\n6. Confirmar o envio do pedido, se o sistema apresentar mensagem de confirmação.\n7. Aguardar a decisão do aprovador designado.\n8. Após aprovação, prosseguir com o processo normal do documento.",
    "steps": [
      "Abrir o documento de Demonstração ou Oferta a Cliente.",
      "Validar se as linhas, cliente, quantidades e demais informação estão corretas.",
      "No topo do documento, selecionar Base.",
      "Selecionar Request Approval.",
      "Clicar em Send Approval Request.",
      "Confirmar o envio do pedido, se o sistema apresentar mensagem de confirmação.",
      "Aguardar a decisão do aprovador designado.",
      "Após aprovação, prosseguir com o processo normal do documento."
    ],
    "validation": "1. O pedido de aprovação é criado no Business Central.\n2. O documento fica pendente de aprovação.\n3. O aprovador definido recebe a solicitação.\n4. Após aprovação, o documento pode avançar conforme o processo.",
    "notes": [
      "* Na comunicação original, o aprovador designado era o Diretor de cada Área de Negócio.",
      "* Fonte: Comunicação TIC i9 de 04/06/2024."
    ],
    "rawMarkdown": "## BC-KB-229 — Enviar para aprovação documentos de Demonstrações e Ofertas a Clientes\n\n**Categoria:** Aprovações / Vendas  \n**Disponível para Utilizador:** Sim  \n**Disponível para Agente:** Sim\n\n**Problema**  \nDocumentos de demonstrações e ofertas a clientes necessitam de aprovação antes de avançarem no processo.\n\n**Diagnóstico**  \nForam disponibilizados workflows de aprovação para documentos de Demonstrações e Ofertas a Clientes.\n\n**Causa provável**  \nNecessidade de controlo formal sobre documentos que originam movimentos sem venda direta ou com impacto comercial/logístico.\n\n**Solução**  \nNo documento, utilizar a opção de pedido de aprovação para enviar o documento ao aprovador designado.\n\n**Como proceder**\n1. Abrir o documento de Demonstração ou Oferta a Cliente.\n2. Validar se as linhas, cliente, quantidades e demais informação estão corretas.\n3. No topo do documento, selecionar Base.\n4. Selecionar Request Approval.\n5. Clicar em Send Approval Request.\n6. Confirmar o envio do pedido, se o sistema apresentar mensagem de confirmação.\n7. Aguardar a decisão do aprovador designado.\n8. Após aprovação, prosseguir com o processo normal do documento.\n\n**Validação final**  \n1. O pedido de aprovação é criado no Business Central.\n2. O documento fica pendente de aprovação.\n3. O aprovador definido recebe a solicitação.\n4. Após aprovação, o documento pode avançar conforme o processo.\n\n**Notas**  \n* Na comunicação original, o aprovador designado era o Diretor de cada Área de Negócio.\n* Fonte: Comunicação TIC i9 de 04/06/2024."
  },
  {
    "id": "bc-kb-230",
    "code": "BC-KB-230",
    "title": "Justificar ajustes de stock",
    "category": "Stock / Ajustes",
    "availableForUser": true,
    "availableForAgent": true,
    "tags": [
      "Stock",
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Ao efetuar ajustes de stock, é necessário registar uma justificação para garantir rastreabilidade e controlo do motivo do ajuste.",
    "diagnosis": "Foi disponibilizado um desenvolvimento para suportar a justificação dos ajustes de stock em Business Central.",
    "cause": "Os ajustes de stock sem justificação dificultam a auditoria, a análise posterior e a identificação da causa da correção.",
    "solution": "Sempre que for efetuado um ajuste de stock, preencher a justificação solicitada pelo sistema antes de concluir o registo.",
    "procedure": "1. Identificar o ajuste de stock a realizar.\n2. Aceder ao documento, diário ou funcionalidade de ajuste aplicável.\n3. Preencher a referência, localização, quantidade e demais informação operacional necessária.\n4. Preencher o campo de justificação do ajuste, quando disponibilizado/solicitado pelo sistema.\n5. Usar uma descrição objetiva, indicando o motivo do ajuste.\n6. Validar se a justificação está coerente com o tipo de movimento.\n7. Registar o ajuste apenas depois de a informação estar completa.\n8. Em caso de dúvida sobre a justificação adequada, validar com a equipa responsável antes de registar.",
    "steps": [
      "Identificar o ajuste de stock a realizar.",
      "Aceder ao documento, diário ou funcionalidade de ajuste aplicável.",
      "Preencher a referência, localização, quantidade e demais informação operacional necessária.",
      "Preencher o campo de justificação do ajuste, quando disponibilizado/solicitado pelo sistema.",
      "Usar uma descrição objetiva, indicando o motivo do ajuste.",
      "Validar se a justificação está coerente com o tipo de movimento.",
      "Registar o ajuste apenas depois de a informação estar completa.",
      "Em caso de dúvida sobre a justificação adequada, validar com a equipa responsável antes de registar."
    ],
    "validation": "1. O ajuste de stock fica registado com justificação associada.\n2. A informação permite compreender o motivo do movimento.\n3. O registo fica mais rastreável para análise posterior ou auditoria.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário gerar pedidos para a Logista Pharma com template atualizado, garantindo informação correta de localidade/cidade e limite máximo de linhas.",
    "diagnosis": "O template de criação de pedidos da Logista foi alterado para rever a informação de localidade e cidade e limitar o número de linhas do pedido a 40.",
    "cause": "O template anterior podia não apresentar corretamente localidade/cidade ou ultrapassar o limite de linhas aceite no processo.",
    "solution": "Usar o template atualizado gerado pelo Business Central e validar que cada pedido respeita o máximo de 40 linhas.",
    "procedure": "1. Aceder à funcionalidade de geração de pedidos/template Logista Pharma.\n2. Gerar o template Excel atualizado.\n3. Validar se a informação de localidade e cidade está corretamente preenchida.\n4. Confirmar o número de linhas do pedido.\n5. Se o pedido tiver mais de 40 linhas, dividir ou tratar conforme o procedimento logístico definido.\n6. Enviar o template apenas depois de validar os dados principais do pedido.\n7. Guardar evidência do template enviado, se aplicável.",
    "steps": [
      "Aceder à funcionalidade de geração de pedidos/template Logista Pharma.",
      "Gerar o template Excel atualizado.",
      "Validar se a informação de localidade e cidade está corretamente preenchida.",
      "Confirmar o número de linhas do pedido.",
      "Se o pedido tiver mais de 40 linhas, dividir ou tratar conforme o procedimento logístico definido.",
      "Enviar o template apenas depois de validar os dados principais do pedido.",
      "Guardar evidência do template enviado, se aplicável."
    ],
    "validation": "1. O template contém localidade e cidade corretamente preenchidas.\n2. O pedido não ultrapassa 40 linhas.\n3. O ficheiro fica pronto para envio à Logista Pharma.",
    "notes": [
      "* Alteração com efeitos a partir de 25/06/2024.",
      "* Fonte: Comunicação TIC i9 de 24/06/2024."
    ],
    "rawMarkdown": "## BC-KB-231 — Gerar Template Logista Pharma com localidade, cidade e limite de linhas\n\n**Categoria:** Logística Externa / Logista Pharma  \n**Disponível para Utilizador:** Não  \n**Disponível para Agente:** Sim\n\n**Problema**  \nÉ necessário gerar pedidos para a Logista Pharma com template atualizado, garantindo informação correta de localidade/cidade e limite máximo de linhas.\n\n**Diagnóstico**  \nO template de criação de pedidos da Logista foi alterado para rever a informação de localidade e cidade e limitar o número de linhas do pedido a 40.\n\n**Causa provável**  \nO template anterior podia não apresentar corretamente localidade/cidade ou ultrapassar o limite de linhas aceite no processo.\n\n**Solução**  \nUsar o template atualizado gerado pelo Business Central e validar que cada pedido respeita o máximo de 40 linhas.\n\n**Como proceder**\n1. Aceder à funcionalidade de geração de pedidos/template Logista Pharma.\n2. Gerar o template Excel atualizado.\n3. Validar se a informação de localidade e cidade está corretamente preenchida.\n4. Confirmar o número de linhas do pedido.\n5. Se o pedido tiver mais de 40 linhas, dividir ou tratar conforme o procedimento logístico definido.\n6. Enviar o template apenas depois de validar os dados principais do pedido.\n7. Guardar evidência do template enviado, se aplicável.\n\n**Validação final**  \n1. O template contém localidade e cidade corretamente preenchidas.\n2. O pedido não ultrapassa 40 linhas.\n3. O ficheiro fica pronto para envio à Logista Pharma.\n\n**Notas**  \n* Alteração com efeitos a partir de 25/06/2024.\n* Fonte: Comunicação TIC i9 de 24/06/2024."
  },
  {
    "id": "bc-kb-232",
    "code": "BC-KB-232",
    "title": "Usar produtos não aprovados em Propostas e ENCAV e criar fichas de produto de forma massiva",
    "category": "Produtos / Oportunidades / Encomendas Abertas",
    "availableForUser": true,
    "availableForAgent": true,
    "tags": [
      "Produtos",
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "A área de resposta a concursos precisa de utilizar produtos ainda não aprovados em propostas e encomendas abertas de venda, bem como criar fichas de produto de forma massiva.",
    "diagnosis": "Os produtos passam a poder ser criados desbloqueados para utilização limitada em propostas de venda, resposta a concursos e ENCAV, ficando disponíveis para todos os documentos apenas após conclusão do ciclo de aprovação.",
    "cause": "O ciclo de aprovação de produtos pode não estar concluído no momento em que é necessário preparar propostas ou documentos de concurso.",
    "solution": "Criar ou importar fichas de produto conforme o processo massivo e utilizar os produtos em propostas/ENCAV apenas dentro do âmbito permitido até à aprovação final.",
    "procedure": "1. Criar a ficha do produto ou carregar as fichas de forma massiva, conforme procedimento disponível.\n2. Confirmar que o produto fica desbloqueado para utilização limitada.\n3. Utilizar o produto apenas em áreas permitidas: resposta a concursos, propostas de venda e encomendas abertas de venda.\n4. Não utilizar o produto em outros documentos operacionais enquanto o ciclo de aprovação não estiver concluído.\n5. Completar a informação obrigatória da ficha de produto.\n6. Enviar o produto para aprovação, seguindo o processo normal.\n7. Após aprovação, confirmar que o produto fica disponível para utilização em todos os documentos aplicáveis.",
    "steps": [
      "Criar a ficha do produto ou carregar as fichas de forma massiva, conforme procedimento disponível.",
      "Confirmar que o produto fica desbloqueado para utilização limitada.",
      "Utilizar o produto apenas em áreas permitidas: resposta a concursos, propostas de venda e encomendas abertas de venda.",
      "Não utilizar o produto em outros documentos operacionais enquanto o ciclo de aprovação não estiver concluído.",
      "Completar a informação obrigatória da ficha de produto.",
      "Enviar o produto para aprovação, seguindo o processo normal.",
      "Após aprovação, confirmar que o produto fica disponível para utilização em todos os documentos aplicáveis."
    ],
    "validation": "1. O produto pode ser usado em propostas e ENCAV antes da aprovação final.\n2. O produto não é usado indevidamente em documentos fora do âmbito permitido.\n3. Após aprovação, o produto fica disponível de forma completa.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Nos procedimentos concursais, é necessário registar o prazo limite para submissão de esclarecimentos sobre erros e omissões.",
    "diagnosis": "Foi adicionada na ficha da oportunidade uma informação específica para Data/Hora Limite de submissão de Erros e Omissões.",
    "cause": "A ausência desta data na oportunidade reduz visibilidade e pode provocar falhas no acompanhamento dos prazos de concurso.",
    "solution": "Preencher o campo de Data/Hora Limite para submissão de Erros e Omissões na ficha da oportunidade sempre que aplicável.",
    "procedure": "1. Abrir a ficha da Oportunidade associada ao concurso.\n2. Confirmar se o procedimento tem prazo definido para submissão de erros e omissões.\n3. Localizar o campo de Data/Hora Limite para submissão de Erros e Omissões.\n4. Preencher a data e hora conforme indicado nos documentos oficiais do concurso.\n5. Guardar a ficha da oportunidade.\n6. Confirmar que a informação fica visível para os utilizadores intervenientes no processo.\n7. Atualizar a data/hora caso exista esclarecimento, prorrogação ou alteração oficial do prazo.",
    "steps": [
      "Abrir a ficha da Oportunidade associada ao concurso.",
      "Confirmar se o procedimento tem prazo definido para submissão de erros e omissões.",
      "Localizar o campo de Data/Hora Limite para submissão de Erros e Omissões.",
      "Preencher a data e hora conforme indicado nos documentos oficiais do concurso.",
      "Guardar a ficha da oportunidade.",
      "Confirmar que a informação fica visível para os utilizadores intervenientes no processo.",
      "Atualizar a data/hora caso exista esclarecimento, prorrogação ou alteração oficial do prazo."
    ],
    "validation": "1. A oportunidade apresenta a Data/Hora Limite de Erros e Omissões preenchida.\n2. Os intervenientes conseguem consultar o prazo na ficha.\n3. O risco de falha de prazo é reduzido.",
    "notes": [
      "* Campo criado na sequência de auditoria à área de resposta a concursos.",
      "* Fonte: Comunicação TIC i9 de 30/07/2024."
    ],
    "rawMarkdown": "## BC-KB-234 — Registar Data/Hora Limite para submissão de Erros e Omissões na Oportunidade\n\n**Categoria:** Oportunidades / Concursos  \n**Disponível para Utilizador:** Sim  \n**Disponível para Agente:** Sim\n\n**Problema**  \nNos procedimentos concursais, é necessário registar o prazo limite para submissão de esclarecimentos sobre erros e omissões.\n\n**Diagnóstico**  \nFoi adicionada na ficha da oportunidade uma informação específica para Data/Hora Limite de submissão de Erros e Omissões.\n\n**Causa provável**  \nA ausência desta data na oportunidade reduz visibilidade e pode provocar falhas no acompanhamento dos prazos de concurso.\n\n**Solução**  \nPreencher o campo de Data/Hora Limite para submissão de Erros e Omissões na ficha da oportunidade sempre que aplicável.\n\n**Como proceder**\n1. Abrir a ficha da Oportunidade associada ao concurso.\n2. Confirmar se o procedimento tem prazo definido para submissão de erros e omissões.\n3. Localizar o campo de Data/Hora Limite para submissão de Erros e Omissões.\n4. Preencher a data e hora conforme indicado nos documentos oficiais do concurso.\n5. Guardar a ficha da oportunidade.\n6. Confirmar que a informação fica visível para os utilizadores intervenientes no processo.\n7. Atualizar a data/hora caso exista esclarecimento, prorrogação ou alteração oficial do prazo.\n\n**Validação final**  \n1. A oportunidade apresenta a Data/Hora Limite de Erros e Omissões preenchida.\n2. Os intervenientes conseguem consultar o prazo na ficha.\n3. O risco de falha de prazo é reduzido.\n\n**Notas**  \n* Campo criado na sequência de auditoria à área de resposta a concursos.\n* Fonte: Comunicação TIC i9 de 30/07/2024."
  },
  {
    "id": "bc-kb-235",
    "code": "BC-KB-235",
    "title": "Consultar Nº de PO do cliente nas etiquetas de faturação da Mobilidade",
    "category": "Mobilidade / Etiquetas / Faturação",
    "availableForUser": true,
    "availableForAgent": true,
    "tags": [
      "Mobilidade",
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Alguns clientes não recebem fatura a acompanhar a mercadoria e precisam de ter a sua referência interna visível nos volumes expedidos.",
    "diagnosis": "Foi adicionada à etiqueta de faturação a indicação do número da(s) PO(s) do cliente.",
    "cause": "Com a conversão para fatura eletrónica, a mercadoria pode seguir sem fatura física, tornando necessário reforçar a identificação do pedido do cliente na etiqueta.",
    "solution": "Usar as etiquetas de faturação geradas pela Mobilidade, que passam a incluir o Nº da(s) PO(s) do cliente.",
    "procedure": "1. Preparar o envio/faturação através do processo normal de mobilidade.\n2. Gerar a etiqueta de faturação associada ao volume.\n3. Confirmar que a etiqueta apresenta o Nº da(s) PO(s) do cliente, quando a informação exista no documento.\n4. Validar se a etiqueta acompanha corretamente os volumes expedidos.\n5. Em caso de ausência da PO na etiqueta, confirmar se o documento de origem tem a referência do cliente preenchida.\n6. Se a referência estiver em falta ou incorreta, corrigir o documento conforme permissões/processo interno antes de nova impressão.",
    "steps": [
      "Preparar o envio/faturação através do processo normal de mobilidade.",
      "Gerar a etiqueta de faturação associada ao volume.",
      "Confirmar que a etiqueta apresenta o Nº da(s) PO(s) do cliente, quando a informação exista no documento.",
      "Validar se a etiqueta acompanha corretamente os volumes expedidos.",
      "Em caso de ausência da PO na etiqueta, confirmar se o documento de origem tem a referência do cliente preenchida.",
      "Se a referência estiver em falta ou incorreta, corrigir o documento conforme permissões/processo interno antes de nova impressão."
    ],
    "validation": "1. A etiqueta apresenta o Nº da(s) PO(s) do cliente.\n2. O cliente consegue identificar a sua referência interna nos volumes.\n3. O processo suporta clientes sem fatura física a acompanhar mercadoria.",
    "notes": [
      "* Alteração criada para apoiar o processo de fatura eletrónica.",
      "* Fonte: Comunicação TIC i9 de 30/07/2024."
    ],
    "rawMarkdown": "## BC-KB-235 — Consultar Nº de PO do cliente nas etiquetas de faturação da Mobilidade\n\n**Categoria:** Mobilidade / Etiquetas / Faturação  \n**Disponível para Utilizador:** Sim  \n**Disponível para Agente:** Sim\n\n**Problema**  \nAlguns clientes não recebem fatura a acompanhar a mercadoria e precisam de ter a sua referência interna visível nos volumes expedidos.\n\n**Diagnóstico**  \nFoi adicionada à etiqueta de faturação a indicação do número da(s) PO(s) do cliente.\n\n**Causa provável**  \nCom a conversão para fatura eletrónica, a mercadoria pode seguir sem fatura física, tornando necessário reforçar a identificação do pedido do cliente na etiqueta.\n\n**Solução**  \nUsar as etiquetas de faturação geradas pela Mobilidade, que passam a incluir o Nº da(s) PO(s) do cliente.\n\n**Como proceder**\n1. Preparar o envio/faturação através do processo normal de mobilidade.\n2. Gerar a etiqueta de faturação associada ao volume.\n3. Confirmar que a etiqueta apresenta o Nº da(s) PO(s) do cliente, quando a informação exista no documento.\n4. Validar se a etiqueta acompanha corretamente os volumes expedidos.\n5. Em caso de ausência da PO na etiqueta, confirmar se o documento de origem tem a referência do cliente preenchida.\n6. Se a referência estiver em falta ou incorreta, corrigir o documento conforme permissões/processo interno antes de nova impressão.\n\n**Validação final**  \n1. A etiqueta apresenta o Nº da(s) PO(s) do cliente.\n2. O cliente consegue identificar a sua referência interna nos volumes.\n3. O processo suporta clientes sem fatura física a acompanhar mercadoria.\n\n**Notas**  \n* Alteração criada para apoiar o processo de fatura eletrónica.\n* Fonte: Comunicação TIC i9 de 30/07/2024."
  },
  {
    "id": "bc-kb-236",
    "code": "BC-KB-236",
    "title": "Interpretar indicadores de Encomendas de Venda Lançadas Não Enviadas no Centro de Perfil",
    "category": "Centro de Perfil / Vendas / Envios",
    "availableForUser": true,
    "availableForAgent": true,
    "tags": [
      "Centro de Perfil",
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador precisa de interpretar os indicadores de encomendas de venda lançadas que ainda não foram enviadas.",
    "diagnosis": "Os indicadores foram revistos e estão disponíveis em diferentes Centros de Perfil, com filtros ajustados ao perfil do utilizador.",
    "cause": "Sem interpretação correta dos indicadores, pode existir dificuldade em priorizar encomendas pendentes, parcialmente enviadas ou atrasadas.",
    "solution": "Consultar os indicadores no Centro de Perfil e interpretar cada métrica: Prontas para Envio, Parcialmente Enviado, Atrasadas e Média Dias Atraso.",
    "procedure": "1. Aceder ao Business Central com o Centro de Perfil aplicável.\n2. Localizar os indicadores de Encomendas de Venda Lançadas Não Enviadas.\n3. Interpretar Prontas para Envio como o número de encomendas de venda pendentes de envio.\n4. Interpretar Parcialmente Enviado como o número de encomendas de venda parcialmente enviadas.\n5. Interpretar Atrasadas como o número de encomendas atrasadas dentro das pendentes de envio.\n6. Interpretar Média Dias Atraso como a média da soma do atraso de todas as linhas pendentes.\n7. Clicar no indicador, quando aplicável, para abrir a lista filtrada e analisar detalhe.\n8. Priorizar ações com base nas encomendas atrasadas e parcialmente enviadas.",
    "steps": [
      "Aceder ao Business Central com o Centro de Perfil aplicável.",
      "Localizar os indicadores de Encomendas de Venda Lançadas Não Enviadas.",
      "Interpretar Prontas para Envio como o número de encomendas de venda pendentes de envio.",
      "Interpretar Parcialmente Enviado como o número de encomendas de venda parcialmente enviadas.",
      "Interpretar Atrasadas como o número de encomendas atrasadas dentro das pendentes de envio.",
      "Interpretar Média Dias Atraso como a média da soma do atraso de todas as linhas pendentes.",
      "Clicar no indicador, quando aplicável, para abrir a lista filtrada e analisar detalhe.",
      "Priorizar ações com base nas encomendas atrasadas e parcialmente enviadas."
    ],
    "validation": "1. O utilizador compreende o significado de cada indicador.\n2. A lista filtrada permite analisar as encomendas por estado.\n3. As encomendas atrasadas são identificadas para tratamento.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador precisa de cancelar ou alterar uma encomenda de venda que já tem pedido de envio efetuado ao armazém.",
    "diagnosis": "O Business Central passou a permitir cancelamento automático do pedido ao armazém em determinadas situações, e foi criada a ação eCancelar pedido ao Armazém para permitir alterações.",
    "cause": "Antes da melhoria, existia um alerta impeditivo e era necessário contactar a logística para cancelar manualmente o pedido de envio.",
    "solution": "Usar o cancelamento automático ou a ação eCancelar pedido ao Armazém, respeitando a regra de que encomendas em aviamento continuam a exigir contacto com a logística.",
    "procedure": "1. Identificar a encomenda de venda pendente que necessita de cancelamento ou alteração.\n2. Confirmar se a encomenda está parcialmente enviada ou ainda nada enviada.\n3. Caso pretenda cancelar a encomenda, executar a remoção/cancelamento conforme o processo normal.\n4. Se existir pedido ao armazém e a encomenda não estiver em aviamento, o sistema cancela automaticamente o pedido ao armazém.\n5. Se a encomenda estiver em aviamento, não prosseguir apenas pelo sistema; contactar a logística.\n6. Caso pretenda alterar a encomenda, abrir a encomenda e selecionar a ação eCancelar pedido ao Armazém.\n7. Confirmar que o pedido ao armazém foi cancelado.\n8. Reabrir a encomenda.\n9. Efetuar as alterações necessárias.\n10. Submeter novamente a encomenda para aprovação, quando aplicável.",
    "steps": [
      "Identificar a encomenda de venda pendente que necessita de cancelamento ou alteração.",
      "Confirmar se a encomenda está parcialmente enviada ou ainda nada enviada.",
      "Caso pretenda cancelar a encomenda, executar a remoção/cancelamento conforme o processo normal.",
      "Se existir pedido ao armazém e a encomenda não estiver em aviamento, o sistema cancela automaticamente o pedido ao armazém.",
      "Se a encomenda estiver em aviamento, não prosseguir apenas pelo sistema; contactar a logística.",
      "Caso pretenda alterar a encomenda, abrir a encomenda e selecionar a ação eCancelar pedido ao Armazém.",
      "Confirmar que o pedido ao armazém foi cancelado.",
      "Reabrir a encomenda.",
      "Efetuar as alterações necessárias.",
      "Submeter novamente a encomenda para aprovação, quando aplicável."
    ],
    "validation": "1. O pedido ao armazém é cancelado automaticamente quando permitido.\n2. A encomenda pode ser alterada após reabertura.\n3. Encomendas em aviamento não são canceladas automaticamente e são tratadas com a logística.\n4. A encomenda alterada volta a seguir o processo correto de aprovação/libertação.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário impedir que notas de crédito de venda liquidem indevidamente faturas de débito direto.",
    "diagnosis": "Foram incluídas restrições na emissão e liquidação de notas de crédito referentes a faturas de DDireto.",
    "cause": "Ao copiar uma fatura de DDireto para nota de crédito, a liquidação podia ser inicializada automaticamente, gerando risco de liquidação incorreta.",
    "solution": "Permitir a cópia da fatura para aproveitar informação, mas impedir o registo ou liquidação quando se mantém liquidação associada a fatura de DDireto.",
    "procedure": "1. Criar a nota de crédito, se necessário, através de cópia da fatura original.\n2. Confirmar se a fatura copiada é de Débito Direto.\n3. Validar se a nota de crédito ficou com liquidação inicializada automaticamente.\n4. Se existir liquidação associada à fatura de DDireto, remover/regularizar a liquidação conforme procedimento financeiro antes de registar.\n5. Tentar registar a nota de crédito apenas depois de validar que não existe liquidação indevida.\n6. Na liquidação manual, não tentar liquidar faturas de DDireto com nota de crédito.\n7. Se o sistema apresentar alerta impeditivo, rever a liquidação antes de prosseguir.",
    "steps": [
      "Criar a nota de crédito, se necessário, através de cópia da fatura original.",
      "Confirmar se a fatura copiada é de Débito Direto.",
      "Validar se a nota de crédito ficou com liquidação inicializada automaticamente.",
      "Se existir liquidação associada à fatura de DDireto, remover/regularizar a liquidação conforme procedimento financeiro antes de registar.",
      "Tentar registar a nota de crédito apenas depois de validar que não existe liquidação indevida.",
      "Na liquidação manual, não tentar liquidar faturas de DDireto com nota de crédito.",
      "Se o sistema apresentar alerta impeditivo, rever a liquidação antes de prosseguir."
    ],
    "validation": "1. O sistema impede o registo de notas de crédito com liquidação indevida de fatura DDireto.\n2. O sistema impede a liquidação de fatura DDireto por nota de crédito.\n3. A área financeira mantém controlo sobre este tipo de regularização.",
    "notes": [
    ...
    "rawMarkdown": "## BC-KB-238 — Restrições em Notas de Crédito de Venda para faturas de Débito Direto\n\n**Categoria:** Financeiro / Notas de Crédito / Débito Direto  \n**Disponível para Utilizador:** Não  \n**Disponível para Agente:** Sim\n\n**Problema**  \nÉ necessário impedir que notas de crédito de venda liquidem indevidamente faturas de débito direto.\n\n**Diagnóstico**  \nForam incluídas restrições na emissão e liquidação de notas de crédito referentes a faturas de DDireto.\n\n**Causa provável**  \nAo copiar uma fatura de DDireto para nota de crédito, a liquidação podia ser inicializada automaticamente, gerando risco de liquidação incorreta.\n\n**Solução**  \nPermitir a cópia da fatura para aproveitar informação, mas impedir o registo ou liquidação quando se mantém liquidação associada a fatura de DDireto.\n\n**Como proceder**\n1. Criar a nota de crédito, se necessário, através de cópia da fatura original.\n2. Confirmar se a fatura copiada é de Débito Direto.\n3. Validar se a nota de crédito ficou com liquidação inicializada automaticamente.\n4. Se existir liquidação associada à fatura de DDireto, remover/regularizar a liquidação conforme procedimento financeiro antes de registar.\n5. Tentar registar a nota de crédito apenas depois de validar que não existe liquidação indevida.\n6. Na liquidação manual, não tentar liquidar faturas de DDireto com nota de crédito.\n7. Se o sistema apresentar alerta impeditivo, rever a liquidação antes de prosseguir.\n\n**Validação final**  \n1. O sistema impede o registo de notas de crédito com liquidação indevida de fatura DDireto.\n2. O sistema impede a liquidação de fatura DDireto por nota de crédito.\n3. A área financeira mantém controlo sobre este tipo de regularização.\n\n**Notas**  \n* A cópia da fatura continua disponível para reutilizar informação; a restrição incide sobre a liquidação/registo indevido.\n* Fonte: Comunicação TIC i9, comunicação financeira sem data explícita no ficheiro."
  },
  {
    "id": "bc-kb-239",
    "code": "BC-KB-239",
    "title": "Validar layout de Propostas de Venda Concurso com lotes e quantidades",
    "category": "Oportunidades / Propostas de Venda Concurso",
    "availableForUser": true,
    "availableForAgent": true,
    "tags": [
      "Oportunidades",
      "Propostas de Venda Concurso",
      "BC"
    ],
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Na impressão de Propostas de Venda Concurso, é necessário garantir uma apresentação clara da informação de lotes e quantidades propostas.",
    "diagnosis": "Foram atualizados dois pontos no layout: remoção da repetição do lote quando existe mais do que uma posição por lote e alteração da apresentação da quantidade proposta.",
    "cause": "A repetição de informação de lote e a apresentação anterior das quantidades dificultavam a leitura por parte do cliente.",
    "solution": "Gerar a Proposta de Venda Concurso com o layout atualizado e validar a apresentação de lotes e quantidades antes de envio ao cliente.",
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário suportar as contagens de inventário através do novo módulo disponibilizado no Business Central e na aplicação de mobilidade de armazéns.",
    "diagnosis": "Foi disponibilizado um novo módulo de inventário no Microsoft Business Central e na aplicação de mobilidade de armazéns.",
    "cause": "As contagens de inventário requerem suporte estruturado para organização, recolha e validação de contagens.",
    "solution": "Utilizar o módulo de inventário no Business Central em conjunto com a mobilidade para execução das contagens.",
    "procedure": "1. Aceder ao módulo de inventário no Business Central.\n2. Validar o inventário/contagem a executar, conforme planeamento definido.\n3. Confirmar as localizações, produtos ou áreas incluídas na contagem.\n4. Utilizar a aplicação de mobilidade de armazéns para apoiar a recolha física, quando aplicável.\n5. Registar as contagens conforme o processo definido para o inventário.\n6. Validar diferenças entre stock esperado e contado.\n7. Encaminhar diferenças para validação antes de registar ajustes finais.\n8. Concluir o processo de inventário após validação das contagens.",
    "steps": [
      "Aceder ao módulo de inventário no Business Central.",
      "Validar o inventário/contagem a executar, conforme planeamento definido.",
      "Confirmar as localizações, produtos ou áreas incluídas na contagem.",
      "Utilizar a aplicação de mobilidade de armazéns para apoiar a recolha física, quando aplicável.",
      "Registar as contagens conforme o processo definido para o inventário.",
      "Validar diferenças entre stock esperado e contado.",
      "Encaminhar diferenças para validação antes de registar ajustes finais.",
      "Concluir o processo de inventário após validação das contagens."
    ],
    "validation": "1. As contagens são suportadas no Business Central e/ou mobilidade.\n2. As diferenças de inventário são identificadas.\n3. O processo fica preparado para suportar a atividade anual de contagem.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário identificar o gestor comercial responsável pelo acompanhamento de uma oportunidade.",
    "diagnosis": "Foi disponibilizado um campo no cabeçalho da oportunidade para caracterizar o Gestor Comercial de acompanhamento, ficando também disponível na lista de oportunidades.",
    "cause": "Sem esta informação, a responsabilidade de acompanhamento comercial podia não ficar clara para os intervenientes.",
    "solution": "Preencher o Gestor Comercial de acompanhamento no cabeçalho da oportunidade e usar a lista de oportunidades para consulta/controlo.",
    ...
    "steps": [
      "Abrir a ficha da Oportunidade.",
      "No cabeçalho, localizar o campo relativo ao Gestor Comercial de acompanhamento.",
      "Selecionar o gestor comercial responsável.",
      "Guardar a oportunidade.",
      "Voltar à lista de Oportunidades.",
      "Confirmar que a informação do gestor comercial está visível na lista.",
      "Usar esta informação para filtrar, acompanhar ou distribuir oportunidades."
    ],
    "validation": "1. A ficha da oportunidade tem o Gestor Comercial de acompanhamento preenchido.\n2. A lista de oportunidades mostra esta informação.\n3. Os intervenientes conseguem identificar o responsável pelo acompanhamento.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Foi registada uma fatura de venda com o Nº Documento Externo incorreto, normalmente associado ao número de pedido do cliente.",
    "diagnosis": "Está disponível no cabeçalho da Fatura de Venda Registada a possibilidade de editar o Nº Documento Externo através da opção Atualizar Documento.",
    "cause": "Antes desta funcionalidade, a correção deste campo podia exigir emissão de nota de crédito e nova fatura.",
    "solution": "Solicitar a correção à área financeira autorizada e atualizar o documento através da função Atualizar Documento.",
    "procedure": "1. Aceder à Fatura de Venda Registada afetada.\n2. Confirmar que o erro está apenas no campo Nº Documento Externo.\n3. Validar qual é o número correto do pedido/documento externo do cliente.\n4. No separador Base, selecionar Atualizar Documento.\n5. Atualizar o campo Nº Documento Externo com o valor correto.\n6. Confirmar a alteração.\n7. Validar se o valor atualizado fica visível no cabeçalho da fatura.",
    "steps": [
      "Aceder à Fatura de Venda Registada afetada.",
      "Confirmar que o erro está apenas no campo Nº Documento Externo.",
      "Validar qual é o número correto do pedido/documento externo do cliente.",
      "No separador Base, selecionar Atualizar Documento.",
      "Atualizar o campo Nº Documento Externo com o valor correto.",
      "Confirmar a alteração.",
      "Validar se o valor atualizado fica visível no cabeçalho da fatura."
    ],
    "validation": "1. O Nº Documento Externo fica corrigido na fatura registada.\n2. Não é necessário emitir nota de crédito apenas para esta retificação.\n3. A correção é efetuada por utilizadores com permissão adequada.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário distinguir clientes públicos e privados no Business Central de forma rápida e consistente.",
    "diagnosis": "A informação foi atualizada com apoio do Departamento Financeiro e passou a estar disponível na ficha do cliente, no separador Faturação, através do Grupo de Registo Cliente.",
    "cause": "A identificação manual ou pouco visível de clientes públicos/privados dificultava a análise e o tratamento operacional/comercial.",
    "solution": "Consultar o Grupo de Registo Cliente na ficha do cliente para identificar se o cliente está classificado como público ou privado.",
    "procedure": "1. Aceder à lista de Clientes.\n2. Pesquisar e abrir a ficha do cliente pretendido.\n3. Ir ao separador Faturação.\n4. Localizar o campo Grupo de Registo Cliente.\n5. Confirmar se o cliente está classificado como CC-PRIVADOS ou CC-PUBLICOS.\n6. Usar esta informação no tratamento financeiro, comercial ou operacional aplicável.\n7. Caso a classificação pareça incorreta, encaminhar para validação da área financeira.",
    "steps": [
      "Aceder à lista de Clientes.",
      "Pesquisar e abrir a ficha do cliente pretendido.",
      "Ir ao separador Faturação.",
      "Localizar o campo Grupo de Registo Cliente.",
      "Confirmar se o cliente está classificado como CC-PRIVADOS ou CC-PUBLICOS.",
      "Usar esta informação no tratamento financeiro, comercial ou operacional aplicável.",
      "Caso a classificação pareça incorreta, encaminhar para validação da área financeira."
    ],
    "validation": "1. O cliente apresenta classificação pública ou privada na ficha.\n2. A informação é consultável diretamente no Business Central.\n3. A classificação está alinhada com os critérios definidos pelo Departamento Financeiro.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Na análise concorrencial, é necessário complementar o motivo de exclusão do concurso com uma descrição mais detalhada.",
    "diagnosis": "Foi adicionada a possibilidade de preencher uma descrição do motivo de exclusão, como complemento aos motivos pré-definidos.",
    "cause": "Os motivos de exclusão pré-definidos agregam a informação, mas podem não ser suficientes para explicar o contexto específico de cada concurso.",
    "solution": "Selecionar o motivo de exclusão pré-definido e preencher a descrição complementar com a informação relevante.",
    "procedure": "1. Abrir a oportunidade ou área de análise concorrencial associada ao concurso.\n2. Identificar a linha/registo onde é necessário indicar exclusão.\n3. Selecionar o motivo de exclusão pré-definido aplicável.\n4. Preencher o campo de descrição do motivo de exclusão com detalhe objetivo.\n5. Garantir que a descrição complementa o motivo selecionado, sem substituir a categorização.\n6. Guardar a informação.\n7. Usar esta descrição em análises futuras de perdas/exclusões.",
    "steps": [
      "Abrir a oportunidade ou área de análise concorrencial associada ao concurso.",
      "Identificar a linha/registo onde é necessário indicar exclusão.",
      "Selecionar o motivo de exclusão pré-definido aplicável.",
      "Preencher o campo de descrição do motivo de exclusão com detalhe objetivo.",
      "Garantir que a descrição complementa o motivo selecionado, sem substituir a categorização.",
      "Guardar a informação.",
      "Usar esta descrição em análises futuras de perdas/exclusões."
    ],
    "validation": "1. O motivo de exclusão está selecionado.\n2. A descrição complementar está preenchida.\n3. A análise concorrencial contém detalhe suficiente para interpretação posterior.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Nos procedimentos concursais, é necessário dar visibilidade ao preço base do procedimento diretamente na ficha da oportunidade.",
    "diagnosis": "Foi adicionado no cabeçalho da oportunidade um campo para identificação do Preço Base do Procedimento.",
    "cause": "A ausência desta informação no cabeçalho da oportunidade dificultava a análise rápida do enquadramento financeiro do concurso.",
    "solution": "Preencher o campo Preço Base do Procedimento na ficha da oportunidade sempre que essa informação exista nos documentos do concurso.",
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Em concursos de medicamentos, pode ser necessário indicar ou imprimir os atributos AIM e CHNM na proposta.",
    "diagnosis": "Foram adicionados à oportunidade os atributos AIM e CHNM, permitindo identificar se o cliente solicita esta informação e garantindo impressão quando os atributos estão preenchidos na ficha do produto.",
    "cause": "O crescimento da resposta a concursos de medicamentos aumentou a necessidade de gerir estes atributos de forma estruturada.",
    "solution": "Na oportunidade, indicar se AIM e/ou CHNM são requeridos e garantir que os produtos têm esses atributos preenchidos na ficha de produto.",
    ...
    "steps": [
      "Abrir a ficha da Oportunidade associada ao concurso.",
      "Confirmar nos documentos do cliente se é solicitado AIM e/ou CHNM.",
      "Na oportunidade, preencher ou ativar a indicação correspondente ao pedido destes atributos.",
      "Validar os produtos incluídos na oportunidade/proposta.",
      "Abrir a ficha dos produtos, se necessário, e confirmar se os atributos AIM e CHNM estão devidamente preenchidos.",
      "Gerar a proposta de venda de concurso.",
      "Confirmar se os atributos são impressos quando aplicáveis e preenchidos."
    ],
    "validation": "1. A oportunidade identifica corretamente o pedido de AIM e/ou CHNM.\n2. Os produtos têm os atributos preenchidos na ficha.\n3. A proposta imprime os atributos quando aplicável.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário comunicar trimestralmente ao Infarmed os medicamentos exportados, incluindo quantidades e país de destino.",
    "diagnosis": "Foi criada uma área específica para DTQAR no Business Central, com acesso por email automático no início de cada trimestre ou via eDTQAR > eInfarmed Medicamentos Exportados.",
    "cause": "A Deliberação n.º 233/2025 do Infarmed exige comunicação trimestral até ao dia 15 do mês seguinte ao final de cada trimestre.",
    "solution": "Aceder à área eInfarmed Medicamentos Exportados e usar a opção Exportar Template Infarmed para obter o Excel de suporte à validação, tratamento e comunicação.",
    "procedure": "1. Aguardar o email automático enviado no início de cada novo trimestre para os elementos da DTQAR ou aceder diretamente ao Business Central.\n2. No Business Central, navegar para eDTQAR > eInfarmed Medicamentos Exportados.\n3. Validar o período trimestral a comunicar.\n4. Executar a opção Exportar Template Infarmed.\n5. Descarregar o ficheiro Excel gerado.\n6. Validar as quantidades e países de destino constantes no ficheiro.\n7. Efetuar o tratamento necessário antes da submissão ao Infarmed.\n8. Garantir que a comunicação é efetuada até ao dia 15 do mês seguinte ao final do trimestre.",
    "steps": [
      "Aguardar o email automático enviado no início de cada novo trimestre para os elementos da DTQAR ou aceder diretamente ao Business Central.",
      "No Business Central, navegar para eDTQAR > eInfarmed Medicamentos Exportados.",
      "Validar o período trimestral a comunicar.",
      "Executar a opção Exportar Template Infarmed.",
      "Descarregar o ficheiro Excel gerado.",
      "Validar as quantidades e países de destino constantes no ficheiro.",
      "Efetuar o tratamento necessário antes da submissão ao Infarmed.",
      "Garantir que a comunicação é efetuada até ao dia 15 do mês seguinte ao final do trimestre."
    ],
    "validation": "1. O ficheiro Excel é exportado com os dados de medicamentos exportados.\n2. As quantidades e países de destino são validados pela DTQAR.\n3. A comunicação ao Infarmed é preparada dentro do prazo regulamentar.",
    "notes": [
      "* Prazos de referência: 15 de janeiro, 15 de abril, 15 de julho e 15 de outubro.",
      "* Fonte: Comunicação TIC i9 de 08/04/2025."
    ],
    "rawMarkdown": "## BC-KB-248 — Exportar Comunicação Trimestral de Medicamentos Exportados ao Infarmed\n\n**Categoria:** DTQAR / Infarmed / Exportação  \n**Disponível para Utilizador:** Não  \n**Disponível para Agente:** Sim\n\n**Problema**  \nÉ necessário comunicar trimestralmente ao Infarmed os medicamentos exportados, incluindo quantidades e país de destino.\n\n**Diagnóstico**  \nFoi criada uma área específica para DTQAR no Business Central, com acesso por email automático no início de cada trimestre ou via eDTQAR > eInfarmed Medicamentos Exportados.\n\n**Causa provável**  \nA Deliberação n.º 233/2025 do Infarmed exige comunicação trimestral até ao dia 15 do mês seguinte ao final de cada trimestre.\n\n**Solução**  \nAceder à área eInfarmed Medicamentos Exportados e usar a opção Exportar Template Infarmed para obter o Excel de suporte à validação, tratamento e comunicação.\n\n**Como proceder**\n1. Aguardar o email automático enviado no início de cada novo trimestre para os elementos da DTQAR ou aceder diretamente ao Business Central.\n2. No Business Central, navegar para eDTQAR > eInfarmed Medicamentos Exportados.\n3. Validar o período trimestral a comunicar.\n4. Executar a opção Exportar Template Infarmed.\n5. Descarregar o ficheiro Excel gerado.\n6. Validar as quantidades e países de destino constantes no ficheiro.\n7. Efetuar o tratamento necessário antes da submissão ao Infarmed.\n8. Garantir que a comunicação é efetuada até ao dia 15 do mês seguinte ao final do trimestre.\n\n**Validação final**  \n1. O ficheiro Excel é exportado com os dados de medicamentos exportados.\n2. As quantidades e países de destino são validados pela DTQAR.\n3. A comunicação ao Infarmed é preparada dentro do prazo regulamentar.\n\n**Notas**  \n* Prazos de referência: 15 de janeiro, 15 de abril, 15 de julho e 15 de outubro.\n* Fonte: Comunicação TIC i9 de 08/04/2025."
  },
  {
    "id": "bc-kb-249",
    "code": "BC-KB-249",
    "title": "Configurar cliente para envio de mercadoria apenas com Guia de Remessa",
    "category": "Clientes / Expedição / Faturação",
    "availableForUser": true,
    "availableForAgent": true,
    "tags": [
      "Clientes",
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Alguns clientes não devem receber a fatura de venda a acompanhar a mercadoria, devendo o envio seguir apenas com Guia de Transporte/Remessa.",
    "diagnosis": "Foi estendida à ficha de cliente uma funcionalidade já existente em encomendas de venda, permitindo indicar que os envios para esse cliente devem seguir apenas com guia.",
    "cause": "Necessidade de impedir que a fatura acompanhe fisicamente a mercadoria em clientes específicos.",
    "solution": "Na ficha do cliente, ativar a opção que indica envio apenas com Guia de Transporte/Remessa, garantindo que a fatura será enviada posteriormente conforme o método definido para o cliente.",
    ...
    "steps": [
      "Abrir a ficha do cliente pretendido.",
      "Localizar a opção relacionada com envio apenas com Guia de Transporte/Remessa.",
      "Ativar a opção para o cliente, quando aplicável.",
      "Confirmar o método de envio posterior da fatura definido para esse cliente.",
      "Guardar a ficha do cliente.",
      "Criar ou processar uma encomenda de venda para esse cliente.",
      "Validar que a mercadoria segue acompanhada apenas pela guia.",
      "Confirmar que a fatura não acompanha fisicamente a mercadoria e é enviada posteriormente pelo método definido."
    ],
    "validation": "1. O cliente está configurado para envio apenas com guia.\n2. Os envios do cliente deixam de incluir fatura física com a mercadoria.\n3. A fatura continua a ser enviada posteriormente conforme o método definido.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário aplicar portes de forma automática e consistente, considerando regras comerciais, segmentos de cliente, concursos, código postal e valor mínimo da encomenda.",
    "diagnosis": "A nova política de atribuição de portes passou a estar centralizada no Modelo Comercial ePricing, com avaliação sequencial de condições.",
    "cause": "A aplicação manual ou pouco estruturada de portes pode gerar inconsistências, omissões ou aplicação indevida em clientes/segmentos excluídos.",
    "solution": "Configurar e validar as regras no Modelo Comercial ePricing, permitindo que o sistema aplique ou recalcule portes automaticamente ao validar o modelo comercial ou submeter a encomenda para aprovação.",
    "procedure": "1. Validar se a aplicação global de portes está ativa ou inativa no Modelo Comercial ePricing.\n2. Confirmar se existem exclusões por segmento de cliente, como farmácias ou concursos.\n3. Confirmar se encomendas provenientes de Procedimentos Concursais estão excluídas, quando aplicável.\n4. Validar as regras por código postal e valor mínimo de encomenda.\n5. Criar ou rever a encomenda de venda.\n6. Validar o modelo comercial ou submeter a encomenda para aprovação.\n7. Confirmar se os portes são aplicados automaticamente quando as regras assim o determinam.\n8. Se houver alterações posteriores à encomenda, confirmar se o sistema recalcula os portes.\n9. Validar se o produto de portes aplicado respeita a nomenclatura e dimensões da encomenda.",
    "steps": [
      "Validar se a aplicação global de portes está ativa ou inativa no Modelo Comercial ePricing.",
      "Confirmar se existem exclusões por segmento de cliente, como farmácias ou concursos.",
      "Confirmar se encomendas provenientes de Procedimentos Concursais estão excluídas, quando aplicável.",
      "Validar as regras por código postal e valor mínimo de encomenda.",
      "Criar ou rever a encomenda de venda.",
      "Validar o modelo comercial ou submeter a encomenda para aprovação.",
      "Confirmar se os portes são aplicados automaticamente quando as regras assim o determinam.",
      "Se houver alterações posteriores à encomenda, confirmar se o sistema recalcula os portes.",
      "Validar se o produto de portes aplicado respeita a nomenclatura e dimensões da encomenda."
    ],
    "validation": "1. Os portes são aplicados automaticamente apenas quando as regras determinam.\n2. As exclusões por segmento ou procedimento concursal são respeitadas.\n3. Alterações posteriores recalculam os portes.\n4. O produto de portes aplicado está correto.",
    "notes": [
      "* A política tem efeitos a partir de 1 de setembro, segundo a comunicação original.",
      "* Fonte: Comunicação TIC i9 de 08/08/2025."
    ],
    "rawMarkdown": "## BC-KB-250 — Aplicação automática de portes no Modelo Comercial ePricing\n\n**Categoria:** Pricing / Portes / Modelo Comercial  \n**Disponível para Utilizador:** Sim  \n**Disponível para Agente:** Sim\n\n**Problema**  \nÉ necessário aplicar portes de forma automática e consistente, considerando regras comerciais, segmentos de cliente, concursos, código postal e valor mínimo da encomenda.\n\n**Diagnóstico**  \nA nova política de atribuição de portes passou a estar centralizada no Modelo Comercial ePricing, com avaliação sequencial de condições.\n\n**Causa provável**  \nA aplicação manual ou pouco estruturada de portes pode gerar inconsistências, omissões ou aplicação indevida em clientes/segmentos excluídos.\n\n**Solução**  \nConfigurar e validar as regras no Modelo Comercial ePricing, permitindo que o sistema aplique ou recalcule portes automaticamente ao validar o modelo comercial ou submeter a encomenda para aprovação.\n\n**Como proceder**\n1. Validar se a aplicação global de portes está ativa ou inativa no Modelo Comercial ePricing.\n2. Confirmar se existem exclusões por segmento de cliente, como farmácias ou concursos.\n3. Confirmar se encomendas provenientes de Procedimentos Concursais estão excluídas, quando aplicável.\n4. Validar as regras por código postal e valor mínimo de encomenda.\n5. Criar ou rever a encomenda de venda.\n6. Validar o modelo comercial ou submeter a encomenda para aprovação.\n7. Confirmar se os portes são aplicados automaticamente quando as regras assim o determinam.\n8. Se houver alterações posteriores à encomenda, confirmar se o sistema recalcula os portes.\n9. Validar se o produto de portes aplicado respeita a nomenclatura e dimensões da encomenda.\n\n**Validação final**  \n1. Os portes são aplicados automaticamente apenas quando as regras determinam.\n2. As exclusões por segmento ou procedimento concursal são respeitadas.\n3. Alterações posteriores recalculam os portes.\n4. O produto de portes aplicado está correto.\n\n**Notas**  \n* A política tem efeitos a partir de 1 de setembro, segundo a comunicação original.\n* Fonte: Comunicação TIC i9 de 08/08/2025."
  },
  {
    "id": "bc-kb-251",
    "code": "BC-KB-251",
    "title": "Monitorizar Garantias Bancárias, Cauções, Contratos Escritos e Tribunal de Contas na Oportunidade",
    "category": "Oportunidades / Concursos Públicos / Garantias",
    "availableForUser": true,
    "availableForAgent": true,
    "tags": [
      "Oportunidades",
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário centralizar no Business Central a gestão de garantias bancárias, cauções, contratos escritos e submissões ao Tribunal de Contas associadas a oportunidades.",
    "diagnosis": "Foram criados novos campos no cabeçalho da Oportunidade para monitorizar garantias/cauções e formalidades legais associadas ao processo concursal.",
    "cause": "O controlo manual em Excel aumenta o risco de perda de prazos, custos desnecessários e baixa rastreabilidade legal/financeira.",
    "solution": "Preencher os campos de garantias, cauções, contratos escritos, Tribunal de Contas e valor contratual diretamente na ficha da Oportunidade.",
    ...
    "steps": [
      "Abrir a ficha da Oportunidade associada ao concurso.",
      "Validar se o procedimento exige garantia bancária ou caução.",
      "Preencher os campos relativos à existência de garantia/caução.",
      "Preencher as datas de início e término da garantia/caução.",
      "Validar se o procedimento implica contrato escrito.",
      "Validar se existe submissão ao Tribunal de Contas.",
      "Preencher o valor contratual associado, quando aplicável.",
      "Guardar a oportunidade.",
      "Usar estes campos para monitorizar prazos, custos, formalidades e planeamento antes da execução/faturação."
    ],
    "validation": "1. A oportunidade contém informação de garantias/cauções quando aplicável.\n2. As datas de início e fim estão registadas.\n3. Contrato escrito, Tribunal de Contas e valor contratual estão identificados.\n4. O controlo fica centralizado no Business Central.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Ao aceder ao Business Central, pode ser apresentada uma mensagem de seleção de ambiente, causando dúvida sobre qual opção escolher.",
    "diagnosis": "Para a Quilaban, os utilizadores devem selecionar sempre a primeira opção: Production.",
    "cause": "A seleção de ambiente incorreto pode levar o utilizador para um ambiente que não corresponde ao ambiente normal de trabalho.",
    "solution": "Quando surgir a seleção de ambiente, escolher sempre Production para acesso à Quilaban e não selecionar ProductionAO.",
    "procedure": "1. Aceder ao Business Central pelo link habitual.\n2. Caso surja a mensagem de seleção de ambiente, não avançar sem validar a opção.\n3. Selecionar a primeira opção: Production.\n4. Não selecionar ProductionAO para acesso à Quilaban.\n5. Aguardar o carregamento do Business Central.\n6. Confirmar que a empresa e o ambiente apresentados correspondem ao ambiente correto de trabalho.\n7. Em caso de acesso incorreto, terminar a sessão ou voltar atrás e repetir a seleção.",
    "steps": [
      "Aceder ao Business Central pelo link habitual.",
      "Caso surja a mensagem de seleção de ambiente, não avançar sem validar a opção.",
      "Selecionar a primeira opção: Production.",
      "Não selecionar ProductionAO para acesso à Quilaban.",
      "Aguardar o carregamento do Business Central.",
      "Confirmar que a empresa e o ambiente apresentados correspondem ao ambiente correto de trabalho.",
      "Em caso de acesso incorreto, terminar a sessão ou voltar atrás e repetir a seleção."
    ],
    "validation": "1. O utilizador entra no ambiente Production.\n2. A empresa/ambiente de trabalho está correto.\n3. O risco de operação em ambiente errado é eliminado.",
    "notes": [
      "* Artigo complementar ao artigo geral de acesso ao Business Central.",
      "* Fonte: Comunicação TIC i9 de 22/12/2025."
    ],
    "rawMarkdown": "## BC-KB-252 — Selecionar o ambiente correto no acesso ao Business Central\n\n**Categoria:** Acesso / Business Central / Ambientes  \n**Disponível para Utilizador:** Sim  \n**Disponível para Agente:** Sim\n\n**Problema**  \nAo aceder ao Business Central, pode ser apresentada uma mensagem de seleção de ambiente, causando dúvida sobre qual opção escolher.\n\n**Diagnóstico**  \nPara a Quilaban, os utilizadores devem selecionar sempre a primeira opção: Production.\n\n**Causa provável**  \nA seleção de ambiente incorreto pode levar o utilizador para um ambiente que não corresponde ao ambiente normal de trabalho.\n\n**Solução**  \nQuando surgir a seleção de ambiente, escolher sempre Production para acesso à Quilaban e não selecionar ProductionAO.\n\n**Como proceder**\n1. Aceder ao Business Central pelo link habitual.\n2. Caso surja a mensagem de seleção de ambiente, não avançar sem validar a opção.\n3. Selecionar a primeira opção: Production.\n4. Não selecionar ProductionAO para acesso à Quilaban.\n5. Aguardar o carregamento do Business Central.\n6. Confirmar que a empresa e o ambiente apresentados correspondem ao ambiente correto de trabalho.\n7. Em caso de acesso incorreto, terminar a sessão ou voltar atrás e repetir a seleção.\n\n**Validação final**  \n1. O utilizador entra no ambiente Production.\n2. A empresa/ambiente de trabalho está correto.\n3. O risco de operação em ambiente errado é eliminado.\n\n**Notas**  \n* Artigo complementar ao artigo geral de acesso ao Business Central.\n* Fonte: Comunicação TIC i9 de 22/12/2025."
  },
  {
    "id": "bc-kb-253",
    "code": "BC-KB-253",
    "title": "Rever encomenda de venda antes de solicitar Nota de Crédito de Retificação",
    "category": "Vendas / Devoluções / Notas de Crédito",
    "availableForUser": true,
    "availableForAgent": true,
    "tags": [
      "Vendas",
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Ao emitir nota de crédito associada a devolução, pode ocorrer duplicação de envio e faturação se a encomenda de venda original continuar ativa/liberta.",
    "diagnosis": "Quando é registada uma devolução com crédito, o Business Central repõe automaticamente a quantidade na encomenda de venda original. Se a encomenda estiver liberta, a logística poderá gerar novo envio automaticamente.",
    "cause": "A encomenda original não foi revista antes da solicitação do crédito, mantendo quantidades prontas para novo envio.",
    "solution": "Antes de solicitar crédito à logística, rever a encomenda de venda original e ajustar/remover linhas conforme a intenção real do cliente.",
    "procedure": "1. Antes de solicitar o crédito à logística, identificar a encomenda de venda de origem.\n2. Confirmar se a encomenda existe e se está ativa/liberta.\n3. Validar o motivo do crédito e a intenção do cliente.\n4. Se o cliente não pretende receber o produto, remover as linhas da encomenda que deram origem ao crédito.\n5. Se o cliente pretende produto com validade diferente, remover as linhas que originam crédito e criar/ajustar novas linhas com lote/validade correto.\n6. Se o cliente pretende envio noutra data, remover as linhas que originam crédito e criar/ajustar novas linhas com a nova data de envio.\n7. Confirmar que a encomenda fica correta e sem quantidades indevidas prontas para envio.\n8. Só depois solicitar o crédito à logística.",
    "steps": [
      "Antes de solicitar o crédito à logística, identificar a encomenda de venda de origem.",
      "Confirmar se a encomenda existe e se está ativa/liberta.",
      "Validar o motivo do crédito e a intenção do cliente.",
      "Se o cliente não pretende receber o produto, remover as linhas da encomenda que deram origem ao crédito.",
      "Se o cliente pretende produto com validade diferente, remover as linhas que originam crédito e criar/ajustar novas linhas com lote/validade correto.",
      "Se o cliente pretende envio noutra data, remover as linhas que originam crédito e criar/ajustar novas linhas com a nova data de envio.",
      "Confirmar que a encomenda fica correta e sem quantidades indevidas prontas para envio.",
      "Só depois solicitar o crédito à logística."
    ],
    "validation": "1. A encomenda original foi revista antes da solicitação do crédito.\n2. Não existem linhas indevidas prontas para novo envio.\n3. O crédito não origina duplicação de envio/faturação.\n4. O processo fica alinhado com a intenção real do cliente.",
    "notes": [
      "* Procedimento com efeito imediato na comunicação original.",
      "* Fonte: Comunicação TIC i9 de 15/04."
    ],
    "rawMarkdown": "## BC-KB-253 — Rever encomenda de venda antes de solicitar Nota de Crédito de Retificação\n\n**Categoria:** Vendas / Devoluções / Notas de Crédito  \n**Disponível para Utilizador:** Sim  \n**Disponível para Agente:** Sim\n\n**Problema**  \nAo emitir nota de crédito associada a devolução, pode ocorrer duplicação de envio e faturação se a encomenda de venda original continuar ativa/liberta.\n\n**Diagnóstico**  \nQuando é registada uma devolução com crédito, o Business Central repõe automaticamente a quantidade na encomenda de venda original. Se a encomenda estiver liberta, a logística poderá gerar novo envio automaticamente.\n\n**Causa provável**  \nA encomenda original não foi revista antes da solicitação do crédito, mantendo quantidades prontas para novo envio.\n\n**Solução**  \nAntes de solicitar crédito à logística, rever a encomenda de venda original e ajustar/remover linhas conforme a intenção real do cliente.\n\n**Como proceder**\n1. Antes de solicitar o crédito à logística, identificar a encomenda de venda de origem.\n2. Confirmar se a encomenda existe e se está ativa/liberta.\n3. Validar o motivo do crédito e a intenção do cliente.\n4. Se o cliente não pretende receber o produto, remover as linhas da encomenda que deram origem ao crédito.\n5. Se o cliente pretende produto com validade diferente, remover as linhas que originam crédito e criar/ajustar novas linhas com lote/validade correto.\n6. Se o cliente pretende envio noutra data, remover as linhas que originam crédito e criar/ajustar novas linhas com a nova data de envio.\n7. Confirmar que a encomenda fica correta e sem quantidades indevidas prontas para envio.\n8. Só depois solicitar o crédito à logística.\n\n**Validação final**  \n1. A encomenda original foi revista antes da solicitação do crédito.\n2. Não existem linhas indevidas prontas para novo envio.\n3. O crédito não origina duplicação de envio/faturação.\n4. O processo fica alinhado com a intenção real do cliente.\n\n**Notas**  \n* Procedimento com efeito imediato na comunicação original.\n* Fonte: Comunicação TIC i9 de 15/04."
  },
  {
    "id": "bc-kb-254",
    "code": "BC-KB-254",
    "title": "Exportar Comunicação Mensal LNP - Lista de Notificação Prévia",
    "category": "DTQAR / Infarmed / SIEXP / LNP",
    "availableForUser": false,
    "availableForAgent": true,
    "tags": [
      "DTQAR",
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Durante a criação ou validação de encomendas de compra, é necessário identificar se algum produto está associado a uma Tabela de Psicotrópicos.",
    "diagnosis": "Nas linhas da encomenda de compra passou a estar disponível a coluna Produto-Cód. Tabela Psicotrópico, apresentando valores como TAB IV quando aplicável.",
    "cause": "Em compras a fornecedores armazenistas, os produtos podem ser inseridos manualmente em plataformas externas e a encomenda pode não ser impressa, aumentando o risco de compra indevida de psicotrópicos a fornecedores sem certificados necessários.",
    "solution": "Verificar a coluna Produto-Cód. Tabela Psicotrópico nas linhas da encomenda de compra e analisar com atenção qualquer linha preenchida antes de avançar com o fornecedor.",
    "procedure": "1. Abrir ou criar a Encomenda de Compra.\n2. Nas linhas do documento, localizar a coluna Produto-Cód. Tabela Psicotrópico.\n3. Validar cada linha da encomenda.\n4. Confirmar se alguma linha tem o campo preenchido, por exemplo TAB IV.\n5. Quando o campo estiver preenchido, analisar a compra com atenção antes de avançar.\n6. Validar se o fornecedor garante os certificados necessários para venda/fornecimento do produto.\n7. Em caso de dúvida, não avançar com a compra sem validação da área responsável.\n8. Após validação, prosseguir com o processo normal de compra.",
    "steps": [
      "Abrir ou criar a Encomenda de Compra.",
      "Nas linhas do documento, localizar a coluna Produto-Cód. Tabela Psicotrópico.",
      "Validar cada linha da encomenda.",
      "Confirmar se alguma linha tem o campo preenchido, por exemplo TAB IV.",
      "Quando o campo estiver preenchido, analisar a compra com atenção antes de avançar.",
      "Validar se o fornecedor garante os certificados necessários para venda/fornecimento do produto.",
      "Em caso de dúvida, não avançar com a compra sem validação da área responsável.",
      "Após validação, prosseguir com o processo normal de compra."
    ],
    "validation": "1. As linhas com produtos psicotrópicos são identificadas antes do avanço da compra.\n2. O comprador consegue sinalizar risco operacional e de incumprimento.\n3. A encomenda só avança após análise adequada quando o campo está preenchido.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "Em propostas de venda a concurso para processos internacionais, pode ser necessário apresentar o Código Pautal para apoiar processos de licenciamento de importação nos países de destino.",
    "diagnosis": "Foi criado na ficha da oportunidade o seletor Requer Cód. Pautal. Quando ativado, o Código Pautal associado ao produto é apresentado na impressão da Proposta de Venda a Concurso.",
    "cause": "A ausência do Código Pautal na proposta obrigava a tratamento manual ou pedidos adicionais de informação, criando risco de inconsistência e atraso.",
    "solution": "Na ficha da oportunidade, ativar o seletor Requer Cód. Pautal quando aplicável e confirmar que os produtos têm Código Pautal preenchido na respetiva ficha.",
    "procedure": "1. Aceder à ficha da Oportunidade associada à Proposta de Venda a Concurso.\n2. Validar se o processo requer apresentação do Código Pautal.\n3. Validar a informação da oportunidade e dos produtos associados.\n4. Ativar o seletor Requer Cód. Pautal, quando aplicável.\n5. Confirmar se os produtos têm Código Pautal preenchido na ficha do produto.\n6. Gerar ou imprimir a Proposta de Venda a Concurso.\n7. Confirmar que o Código Pautal é apresentado abaixo da respetiva linha de produto.\n8. Se o código não aparecer, validar se o produto tem Código Pautal preenchido.",
    "steps": [
      "Aceder à ficha da Oportunidade associada à Proposta de Venda a Concurso.",
      "Validar se o processo requer apresentação do Código Pautal.",
      "Validar a informação da oportunidade e dos produtos associados.",
      "Ativar o seletor Requer Cód. Pautal, quando aplicável.",
      "Confirmar se os produtos têm Código Pautal preenchido na ficha do produto.",
      "Gerar ou imprimir a Proposta de Venda a Concurso.",
      "Confirmar que o Código Pautal é apresentado abaixo da respetiva linha de produto.",
      "Se o código não aparecer, validar se o produto tem Código Pautal preenchido."
    ],
    "validation": "1. O seletor Requer Cód. Pautal está ativo quando necessário.\n2. A proposta apresenta o Código Pautal abaixo da linha do produto.\n3. O código apresentado corresponde ao preenchido na ficha do produto.\n4. A proposta fica preparada para apoiar processos internacionais de importação.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "É necessário configurar o acesso de um cliente ao Portal Cliente Quilaban através do Business Central.",
    "diagnosis": "O cliente só receberá o email de configuração do Portal Cliente depois de a respetiva ficha de cliente estar corretamente configurada no Business Central.\n\nPara isso, é necessário ativar o acesso no separador **ePortal de cliente** e indicar o email do cliente que deverá receber o convite/configuração de acesso.",
    "cause": "O cliente ainda não recebeu o email de configuração ou não consegue aceder ao Portal Cliente porque:\n\n* o campo **Acesso ao portal de cliente** ainda não foi ativado;\n* o email do cliente não foi preenchido;\n* o email preenchido está incorreto;\n* a alteração ainda não foi processada pelo envio automático noturno;\n* o utilizador que está a tratar o pedido não tem permissão para editar a ficha do cliente.",
    "solution": "Editar a ficha do cliente no Business Central, aceder ao separador **ePortal de cliente**, ativar o campo **Acesso ao portal de cliente** e preencher o email do cliente que deverá receber o acesso.",
    ...
    "steps": [
      "No Business Central, pesquisar por **Clientes**.",
      "Abrir a lista de clientes.",
      "Procurar o cliente que se pretende ativar para acesso ao Portal Cliente.",
      "Abrir a respetiva **Ficha de Cliente**.",
      "Na ficha do cliente, clicar em **Editar**.",
      "Confirmar que tem permissões para alterar a ficha do cliente.",
      "Caso não tenha permissões para editar a ficha, solicitar a alteração ao **Departamento Financeiro**.",
      "Na ficha do cliente, aceder ao separador **ePortal de cliente**.",
      "Ativar o botão/campo **Acesso ao portal de cliente**.",
      "Confirmar que o campo ficou ativo.",
      "Ainda no separador **ePortal de cliente**, preencher o campo **Email**.",
      "Indicar o email do cliente ao qual se pretende dar acesso ao Portal Cliente.",
      "Confirmar cuidadosamente que o email está correto.",
      "Gravar/fechar a ficha do cliente.",
      "Após a edição da ficha do cliente, o email de configuração não é enviado de imediato.",
      "O envio do email de configuração é efetuado durante a noite seguinte à alteração da ficha.",
      "O cliente só deverá receber o email na caixa de correio no dia seguinte à edição."
    ],
    "validation": "A configuração está correta quando:\n\n1. A ficha do cliente foi editada com sucesso.\n2. O campo **Acesso ao portal de cliente** está ativo.\n3. O campo **Email** está preenchido no separador **ePortal de cliente**.\n4. O email preenchido corresponde ao email do cliente que deverá aceder ao portal.\n5. A alteração foi gravada.\n6. O cliente recebe o email de configuração no dia seguinte.\n7. O cliente consegue seguir o processo de adesão/acesso ao Portal Cliente.",
    "notes": [
  ...
  },
  {
    ...
    "updatedAt": "2026-06-11",
    "readTime": "3-6 min",
    "problem": "O utilizador pretende adaptar uma página do Business Central ao seu trabalho diário, mas não sabe como adicionar, mover ou ocultar campos.",
    "diagnosis": "As páginas do Business Central podem apresentar informação que não é relevante para todos os utilizadores ou, em alternativa, podem ter campos úteis que estão disponíveis mas não visíveis por defeito.",
    "cause": "A página está a ser utilizada com a configuração standard ou com uma disposição que não está ajustada às necessidades do utilizador.",
    "solution": "Utilizar a funcionalidade de personalização do Business Central para ajustar a página, permitindo adicionar campos disponíveis, mudar campos de posição ou ocultar informação que não seja necessária. Esta personalização ajuda a tornar o trabalho mais simples, rápido e eficaz.",
    "procedure": "### 1. Abrir a página que pretende personalizar\n1. Aceder ao Business Central.\n2. Abrir a página onde pretende efetuar a personalização.\n3. Confirmar que está na página correta antes de iniciar a alteração.\n\n### 2. Ativar o modo de personalização\n1. Clicar na roda dentada no canto superior direito do ecrã.\n2. Selecionar a opção **Personalizar**.\n3. O Business Central passa a apresentar a barra/opções de personalização da página.\n\n### 3. Mostrar as opções adicionais, se necessário\n1. Se apenas aparecerem as opções **Concluído** e **Mais**, clicar em **Mais**.\n2. Validar se passa a estar disponível a opção **+ Campo**.\n3. Se a opção **+ Campo** já estiver visível, avançar diretamente para o passo seguinte.\n\n### 4. Adicionar campos à página\n1. Clicar em **+ Campo** no canto superior esquerdo.\n2. Será aberta a lista de campos disponíveis para essa página.\n3. Localizar o campo que pretende adicionar.\n4. Clicar no campo com o botão esquerdo do rato, manter pressionado e arrastar para a posição pretendida na página.\n5. Soltar o botão do rato quando o campo estiver no local desejado.\n6. Confirmar visualmente se o campo ficou na posição correta.\n7. Repetir o processo para todos os campos que pretende adicionar.\n\n### 5. Reorganizar campos existentes\n1. Selecionar o campo que pretende mover.\n2. Clicar com o botão esquerdo do rato, manter pressionado e arrastar para a nova posição.\n3. Soltar o campo no local pretendido.\n4. Confirmar se a nova posição facilita a leitura e utilização da página.\n\n### 6. Ocultar campos que não são necessários\n1. No modo de personalização, selecionar o campo que pretende ocultar.\n2. Utilizar a opção disponível para ocultar/remover da vista.\n3. Confirmar que o campo deixa de aparecer na página.\n4. Repetir para outros campos que não sejam úteis para o trabalho diário.\n\n### 7. Concluir a personalização\n1. Depois de adicionar, mover ou ocultar os campos necessários, clicar em **Concluído**.\n2. Confirmar que a página fica apresentada com a nova organização.\n3. Atualizar ou voltar a abrir a página, se necessário, para validar que a personalização ficou gravada.",
    "steps": [
      "Aceder ao Business Central.",
      "Abrir a página onde pretende efetuar a personalização.",
      "Confirmar que está na página correta antes de iniciar a alteração.",
      "Clicar na roda dentada no canto superior direito do ecrã.",
      "Selecionar a opção **Personalizar**.",
      "O Business Central passa a apresentar a barra/opções de personalização da página.",
      "Se apenas aparecerem as opções **Concluído** e **Mais**, clicar em **Mais**.",
      "Validar se passa a estar disponível a opção **+ Campo**.",
      "Se a opção **+ Campo** já estiver visível, avançar diretamente para o passo seguinte.",
      "Clicar em **+ Campo** no canto superior esquerdo.",
      "Será aberta a lista de campos disponíveis para essa página.",
      "Localizar o campo que pretende adicionar.",
      "Clicar no campo com o botão esquerdo do rato, manter pressionado e arrastar para a posição pretendida na página.",
      "Soltar o botão do rato quando o campo estiver no local desejado.",
      "Confirmar visualmente se o campo ficou na posição correta.",
      "Repetir o processo para todos os campos que pretende adicionar.",
      "Selecionar o campo que pretende mover.",
      "Clicar com o botão esquerdo do rato, manter pressionado e arrastar para a nova posição.",
      "Soltar o campo no local pretendido.",
      "Confirmar se a nova posição facilita a leitura e utilização da página.",
      "No modo de personalização, selecionar o campo que pretende ocultar.",
      "Utilizar a opção disponível para ocultar/remover da vista.",
      "Confirmar que o campo deixa de aparecer na página.",
      "Repetir para outros campos que não sejam úteis para o trabalho diário.",
      "Depois de adicionar, mover ou ocultar os campos necessários, clicar em **Concluído**.",
      "Confirmar que a página fica apresentada com a nova organização.",
      "Atualizar ou voltar a abrir a página, se necessário, para validar que a personalização ficou gravada."
    ],
    "validation": "A personalização está correta quando:\n1. Os campos adicionados ficam visíveis na página.\n2. Os campos reorganizados aparecem na posição pretendida.\n3. Os campos ocultados deixam de aparecer.\n4. A página fica mais ajustada ao trabalho diário do utilizador.\n5. A configuração permanece disponível após sair e voltar a entrar na página.",
    "notes": [
