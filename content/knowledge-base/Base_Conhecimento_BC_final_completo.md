...
## BC-KB-272 — Como configurar a delegação de aprovações no Portal Continia?
**Categoria:** Continia / Aprovações / Delegação  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim

**Problema**  
O aprovador vai estar ausente e pretende que os pedidos de aprovação do Continia sejam encaminhados automaticamente para outro utilizador durante esse período.

**Diagnóstico**  
O Portal de Aprovações do Continia permite configurar uma delegação temporária através da funcionalidade **Fora de Escritório**.

Esta funcionalidade deve ser usada quando o aprovador estiver ausente e quiser que os pedidos de aprovação sejam reencaminhados automaticamente para um utilizador substituto.

**Causa provável**  
A necessidade surge normalmente em situações de ausência temporária, como férias, doença, deslocação ou outro período em que o aprovador não consiga tratar os pedidos de aprovação.

Se a delegação não estiver configurada, os pedidos poderão continuar atribuídos ao aprovador original e ficar pendentes até serem tratados.

**Solução**  
Configurar o período de ausência no Portal de Aprovações do Continia, indicando a data de início, a data de fim e o utilizador substituto que irá receber os pedidos de aprovação durante esse período.
...
1. Aceder ao **Portal de Aprovações do Continia**.
2. Iniciar sessão com o utilizador habitual.

### 2. Abrir as configurações

1. No canto superior direito do ecrã, clicar na **roldana de configurações**.
2. Será aberta a página de configurações do utilizador.

### 3. Localizar a área Fora de Escritório

1. No topo da página de configurações, localizar a informação de **Fora de Escritório**.
2. Confirmar que está na área correta para configuração da delegação de aprovações.

### 4. Preencher o período de ausência

1. Indicar a **data de início da ausência**.
2. Indicar a **data de fim da ausência**.
3. Confirmar que o período indicado corresponde ao intervalo em que os pedidos devem ser delegados.

### 5. Selecionar o utilizador substituto

1. Selecionar o utilizador que irá receber os pedidos de aprovação durante o período indicado.
2. Confirmar que o utilizador substituto selecionado está correto.
3. Gravar a configuração.

### 6. Confirmar funcionamento da delegação

A partir do momento em que a configuração fica gravada, todos os pedidos de aprovação que entrem dentro do período indicado passam automaticamente para o substituto definido.

O pedido mantém a indicação de que se trata de uma **aprovação delegada**, permitindo identificar que foi encaminhado devido à ausência do aprovador original.

**Validação final**  
A configuração está correta quando:

1. A data de início da ausência está preenchida.
2. A data de fim da ausência está preenchida.
3. O utilizador substituto está selecionado.
4. A configuração foi gravada.
5. Os pedidos de aprovação que entram dentro do período definido passam para o substituto.
6. O pedido mantém a indicação de aprovação delegada.

**Notas**

- A funcionalidade **Fora de Escritório** serve apenas para delegar aprovações durante um período de ausência.
- Apenas utilizadores previamente configurados no Portal Continia podem ser indicados como substitutos.
- Se o utilizador pretendido não aparecer disponível na lista, deve ser solicitado apoio à equipa de suporte através do email: suporteit@quilaban.pt.
...
## BC-KB-274 — Aceder à aplicação de Mobilidade e retomar uma atividade em curso
...
## BC-KB-275 — Interpretar indicadores, selecionar armazém e consultar mensagens na Mobilidade
...
## BC-KB-276 — Receber mercadoria na Mobilidade através da atividade E1: Receber
...
## BC-KB-277 — Selecionar documento, guia, paletes e volumes na receção de mercadoria
**Categoria:** Mobilidade / Entrada / Receção  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-278 — Reimprimir etiqueta de receção ou identificar manualmente a palete
...
## BC-KB-279 — Receção já em aberto para o mesmo fornecedor e documento
**Categoria:** Mobilidade / Entrada / Receção  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-280 — Iniciar conferência de mercadoria na entrada através da atividade E2: Conferir
...
## BC-KB-281 — Priorizar armazéns durante a conferência de entrada
**Categoria:** Mobilidade / Entrada / Conferência  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-282 — Registar produto, lote, validade e quantidade na conferência de entrada
**Categoria:** Mobilidade / Entrada / Conferência  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-283 — Interpretar a distribuição de quantidades por armazém na conferência
**Categoria:** Mobilidade / Entrada / Conferência  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-284 — Fechar palete na conferência e gerar documento de arrumação
**Categoria:** Mobilidade / Entrada / Conferência  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-285 — Terminar conferência de entrada e validar paletes fechadas
**Categoria:** Mobilidade / Entrada / Conferência  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-286 — Reservar produto por excesso de quantidade ou validade não comportada
**Categoria:** Mobilidade / Entrada / Conferência  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-287 — Tratar produtos sujeitos a verificação NMVS na conferência de entrada
...
## BC-KB-288 — Tratar armazéns que não requerem arrumação na conferência de entrada
**Categoria:** Mobilidade / Entrada / Conferência  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-289 — Arrumar mercadoria na entrada através da atividade E3: Arrumar
...
## BC-KB-290 — Validar fatura/marca antes de arrumar mercadoria PRAXIS
...
## BC-KB-291 — Resolver erro de arrumação inexistente ou falta de acesso ao armazém
**Categoria:** Mobilidade / Entrada / Arrumação  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-292 — Preparar envios na Mobilidade através da atividade S1: Preparar Envios
...
## BC-KB-293 — Compreender os critérios de criação automática de envios e recolhas
**Categoria:** Mobilidade / Saída / Preparação de Envios  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-294 — Iniciar uma recolha na Mobilidade e interpretar os indicadores
...
## BC-KB-295 — Adicionar banheira a uma recolha
**Categoria:** Mobilidade / Saída / Recolha  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-296 — Recolher produto, lote e quantidade para a banheira indicada
**Categoria:** Mobilidade / Saída / Recolha  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-297 — Registar produto não encontrado durante uma recolha
**Categoria:** Mobilidade / Saída / Recolha  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-298 — Colocar banheira na zona de conferência e terminar recolha
**Categoria:** Mobilidade / Saída / Recolha  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-299 — Resolver casos particulares da recolha: reatribuição, banheira não liberta e recolha manual PRAXIS
**Categoria:** Mobilidade / Saída / Recolha  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-300 — Conferir banheira na expedição através da atividade S2A: Conferência
...
## BC-KB-301 — Resolver diferenças ou produto extra na conferência da banheira
**Categoria:** Mobilidade / Saída / Conferência de Expedição  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-302 — Faturar envio na Mobilidade através da atividade S3: Enviar e Faturar
...
## BC-KB-303 — Resolver bloqueios na faturação da Mobilidade: motivo de não satisfação, PRAXIS e fatura não emitida
**Categoria:** Mobilidade / Saída / Faturação  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim
...
## BC-KB-308 — Como imprimir uma Packing List em PDF?
**Categoria:** Logística / Packing List  
**Disponível para Utilizador:** Sim  
**Disponível para Agente:** Sim  

**Problema**  
É necessário imprimir ou exportar uma **Packing List** em PDF, incluindo informação útil para envio ao transportador, como quantidades, pesos e dimensões.

**Diagnóstico**  
O utilizador pode assumir que é necessário exportar a informação para Excel para depois gerar um PDF, mas a **Packing List** pode ser impressa diretamente a partir do próprio documento no Business Central.

**Causa provável**  
Desconhecimento da opção **Imprimir Packing List** disponível diretamente no documento da Packing List.

**Solução**  
Utilizar a opção **Imprimir Packing List** a partir da própria Packing List e, na janela de impressão/pré-visualização, imprimir ou guardar o documento como PDF.

**Como proceder**

### 1. Abrir a Packing List

1. Aceder à Packing List pretendida.
2. Confirmar que está no documento correto.
3. Validar se a informação necessária para transporte está registada no documento.

### 2. Aceder à opção de impressão

1. No topo da página, selecionar **Mais opções**.
2. Clicar em **Imprimir Packing List**.
3. Aguardar a abertura da pré-visualização do documento.

### 3. Confirmar a pré-visualização

1. Rever a Packing List apresentada.
2. Confirmar se constam os dados necessários, como:
   - produtos;
   - quantidades;
   - pesos;
   - dimensões;
   - informação relevante para transporte.

### 4. Imprimir ou guardar como PDF

1. Na janela de impressão, selecionar a impressora pretendida.
2. Para guardar em PDF, escolher a opção de impressão em PDF, por exemplo:
   - **Microsoft Print to PDF**;
   - **Guardar como PDF**;
   - ou opção equivalente disponível no browser/sistema.
3. Confirmar a impressão ou gravação do ficheiro.
4. Guardar o PDF na localização pretendida.

**Validação final**  
O processo está correto quando:

1. A Packing List é aberta no Business Central.
2. A opção **Imprimir Packing List** é executada.
3. O documento é apresentado em pré-visualização.
4. A informação de quantidades, pesos e dimensões aparece no documento, quando registada.
5. O documento é impresso ou guardado como PDF com sucesso.

**Notas**

- A Packing List pode ser impressa diretamente a partir do documento, sem necessidade de exportação prévia para Excel.
- A opção **Imprimir Packing List** encontra-se disponível diretamente na Packing List.
